(()=>{var it=Object.defineProperty,ot=Object.defineProperties;var st=Object.getOwnPropertyDescriptors;var De=Object.getOwnPropertySymbols;var rt=Object.prototype.hasOwnProperty,nt=Object.prototype.propertyIsEnumerable;var ce=(a,e,o)=>e in a?it(a,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):a[e]=o,c=(a,e)=>{for(var o in e||(e={}))rt.call(e,o)&&ce(a,o,e[o]);if(De)for(var o of De(e))nt.call(e,o)&&ce(a,o,e[o]);return a},y=(a,e)=>ot(a,st(e));var m=(a,e,o)=>ce(a,typeof e!="symbol"?e+"":e,o);var L=(a,e,o)=>new Promise((i,t)=>{var s=l=>{try{n(o.next(l))}catch(h){t(h)}},r=l=>{try{n(o.throw(l))}catch(h){t(h)}},n=l=>l.done?i(l.value):Promise.resolve(l.value).then(s,r);n((o=o.apply(a,e)).next())});var we={cirrus:{label:"Cirrus",alias:"Mare's tail",abbr:"Ci",level:"high",form:"filament",opacity:.15},cirrostratus:{label:"Cirrostratus",alias:"Veil cloud",abbr:"Cs",level:"high",form:"stratiform",opacity:.45},cirrocumulus:{label:"Cirrocumulus",alias:"Mackerel sky",abbr:"Cc",level:"high",form:"granular",opacity:.25},altostratus:{label:"Altostratus",alias:"Grey veil",abbr:"As",level:"mid",form:"stratiform",opacity:.9},altocumulus:{label:"Altocumulus",alias:"Sheep cloud",abbr:"Ac",level:"mid",form:"granular",opacity:.45},nimbostratus:{label:"Nimbostratus",alias:"Rain cloud",abbr:"Ns",level:"mid",form:"stratiform",opacity:1},stratus:{label:"Stratus",alias:"Fog cloud",abbr:"St",level:"low",form:"stratiform",opacity:.95},stratocumulus:{label:"Stratocumulus",alias:"Roll cloud",abbr:"Sc",level:"low",form:"granular",opacity:.75},cumulus:{label:"Cumulus",alias:"Cotton cloud",abbr:"Cu",level:"low",form:"convective",opacity:.4},cumulonimbus:{label:"Cumulonimbus",alias:"Thunderhead",abbr:"Cb",level:"low",form:"convective",opacity:.28}},be=Object.keys(we),F=a=>a<0?0:a>1?1:a;function k(a,e,o){let i=F((a-e)/(o-e));return i*i*(3-2*i)}function lt(a){let e=F(a);return{anvil:k(e,.68,1),velum:k(e,.22,.5)*(1-k(e,.68,.95))}}var Q={cirrus:0,cirrostratus:0,cirrocumulus:0,altostratus:0,altocumulus:0,nimbostratus:0,stratus:0,stratocumulus:0,cumulus:0,cumulonimbus:0};function ht(a){var o;if(a==null)return c({},Q);if(typeof a=="string")return y(c({},Q),{[a]:1});if(Array.isArray(a)){let i=c({},Q);for(let t of a)i[t]=1;return i}let e=c({},Q);for(let i of be)e[i]=F((o=a[i])!=null?o:0);return e}function dt(a,e,o,i){let t=F(a),s=F(e),r=1-s,n=1-k(t,.28,.72),l=1-k(t,.45,.85),h=t>=.15&&t<.52,u=t>=.52&&t<.85,d=t>=.85,v=s>.05;return{cirrus:k(t,.05,.55)*.42*n,cirrostratus:k(t,.1,.55)*.25*n,cirrocumulus:k(t,.14,.45)*(h?.22:.14)*n*r,altostratus:k(t,.45,.82)*(v?.85:.55)*(1-k(t,.82,.98))*r,altocumulus:k(t,.22,.55)*(h?.35:u?.62:.45)*(1-k(t,.72,.95))*r,nimbostratus:s*k(t,.55,.88),stratus:d?k(t,.65,.95)*.85*(1-s*.4):i>.1?i*.45:0,stratocumulus:k(t,.28,.78)*(h?.38:u?.82:.85)*(1-s*.6)*r,cumulus:k(t,.08,.48)*(h?.42:.28)*l*r,cumulonimbus:F(o)*k(t,.12,.45)}}function ut(a){let e=1;for(let o of be)e*=1-a[o]*we[o].opacity;return F(1-e)}var ct={tau:2.2,windBase:.006,windGust:.22,evoBase:.07,evoGust:.09,windPerHour:.25,evoPerHour:.06},ft=Math.PI*2;function Oe(a){return{filter:y(c({},a.filter),{tint:[a.filter.tint[0],a.filter.tint[1],a.filter.tint[2]]}),tone:c({},a.tone),polarizer:c({},a.polarizer),celestial:y(c({},a.celestial),{radiant:a.celestial.radiant?[a.celestial.radiant[0],a.celestial.radiant[1]]:null}),clouds:c({},a.clouds),features:c({},a.features)}}function fe(a,e,o,i){let t=i/2,s=(e-a+i*1.5)%i-t;return(a+s*o+i)%i}var mt=class{constructor(a,e={}){m(this,"current");m(this,"windOff",41.7);m(this,"evoOff",7.3);m(this,"opts");this.current=c(c({},a),Oe(a)),this.opts=c(c({},ct),e)}get wind(){return this.windOff}get evolution(){return this.evoOff}jump(a){Object.assign(this.current,a,Oe(a))}step(a,e){let o=this.opts,i=this.current,t=1-Math.exp(-e/o.tau),s=i.timeOfDay;i.timeOfDay=fe(i.timeOfDay,a.timeOfDay,t,24);let r=(i.timeOfDay-s+36)%24-12;i.sunElevation+=(a.sunElevation-i.sunElevation)*t,i.sunAzimuth=fe(i.sunAzimuth,a.sunAzimuth,t,ft),i.cloudCover+=(a.cloudCover-i.cloudCover)*t;for(let M of be)i.clouds[M]+=(a.clouds[M]-i.clouds[M])*t;i.features.anvil+=(a.features.anvil-i.features.anvil)*t,i.features.velum+=(a.features.velum-i.features.velum)*t,i.rain+=(a.rain-i.rain)*t,i.snow+=(a.snow-i.snow)*t,i.wind+=(a.wind-i.wind)*t,i.thunder+=(a.thunder-i.thunder)*t,i.haze+=(a.haze-i.haze)*t;let n=i.filter,l=a.filter;n.amount+=(l.amount-n.amount)*t,n.saturation+=(l.saturation-n.saturation)*t,n.lift+=(l.lift-n.lift)*t,n.tint=[n.tint[0]+(l.tint[0]-n.tint[0])*t,n.tint[1]+(l.tint[1]-n.tint[1])*t,n.tint[2]+(l.tint[2]-n.tint[2])*t];let h=i.tone,u=a.tone;h.exposure+=(u.exposure-h.exposure)*t,h.contrast+=(u.contrast-h.contrast)*t,h.knee+=(u.knee-h.knee)*t,h.bleach+=(u.bleach-h.bleach)*t;let d=i.polarizer,v=a.polarizer;d.strength+=(v.strength-d.strength)*t,d.saturation+=(v.saturation-d.saturation)*t,d.stopLoss+=(v.stopLoss-d.stopLoss)*t,d.angle=fe(d.angle,v.angle,t,Math.PI);let b=i.celestial,C=a.celestial;b.bortle+=(C.bortle-b.bortle)*t,b.milkyWay+=(C.milkyWay-b.milkyWay)*t,b.meteors+=(C.meteors-b.meteors)*t,b.radiant=C.radiant?[C.radiant[0],C.radiant[1]]:null,this.windOff+=(o.windBase+i.wind*o.windGust)*e+Math.abs(r)*o.windPerHour,this.evoOff+=(o.evoBase+i.wind*o.evoGust)*e+Math.abs(r)*o.evoPerHour}},pt=[.82246197,.17753803,0,.0331942,.9668058,0,.01708263,.07239744,.91051993];function vt(a){let e=o=>[a[o],a[o+3],a[o+6]].map(i=>i.toFixed(8)).join(", ");return`mat3(${e(0)},
       ${e(1)},
       ${e(2)})`}var gt=[1.05,.79],yt=[.98,1.48],ye={"dark-sky":{label:"Dark sky",bortle:2,milkyWay:1,meteors:5,radiant:null},rural:{label:"Rural",bortle:4,milkyWay:.45,meteors:5,radiant:null},suburban:{label:"Suburban",bortle:6,milkyWay:0,meteors:0,radiant:null},city:{label:"City",bortle:8,milkyWay:0,meteors:0,radiant:null},perseids:{label:"Perseids",bortle:3,milkyWay:.75,meteors:100,radiant:gt},geminids:{label:"Geminids",bortle:3,milkyWay:.75,meteors:150,radiant:yt}},Ca=Object.keys(ye);var X={bortle:6,milkyWay:0,meteors:0,radiant:null};function wt(a){return Math.min(1,Math.max(0,(5.5-a)/3.5))}function me(a){return{bortle:a.bortle,milkyWay:a.milkyWay,meteors:a.meteors,radiant:a.radiant?[a.radiant[0],a.radiant[1]]:null}}var Be=(a,e,o)=>Math.min(o,Math.max(e,a));function bt(a){var i,t,s,r,n;if(a==null)return me(X);if(typeof a=="string")return me((i=ye[a])!=null?i:X);let e=a.id&&(t=ye[a.id])!=null?t:X,o=Be((s=a.bortle)!=null?s:e.bortle,1,9);return me({bortle:o,milkyWay:Be((r=a.milkyWay)!=null?r:a.id?e.milkyWay:wt(o),0,1),meteors:Math.max(0,(n=a.meteors)!=null?n:e.meteors),radiant:a.radiant!==void 0?a.radiant:e.radiant})}var O={none:{label:"None",amount:0,tint:[1,1,1],saturation:1,lift:0},sepia:{label:"Sepia",amount:1,tint:[1.07,.93,.72],saturation:.1,lift:.02},mono:{label:"Monochrome",amount:1,tint:[1,1,1],saturation:0,lift:0},faded:{label:"Faded",amount:1,tint:[1.02,.99,.94],saturation:.35,lift:.06},cyanotype:{label:"Cyanotype",amount:1,tint:[.72,.9,1.12],saturation:.08,lift:.03},gold:{label:"Gold",amount:1,tint:[1.15,.95,.6],saturation:.45,lift:.02},ash:{label:"Ash",amount:1,tint:[.92,.95,1],saturation:.2,lift:.04}},Ma=Object.keys(O);var pe=O.none;function J(a){return{amount:a.amount,tint:[a.tint[0],a.tint[1],a.tint[2]],saturation:a.saturation,lift:a.lift}}function kt(a){var o,i,t,s,r,n;if(a==null||a===!1)return J(pe);if(a===!0)return J(O.sepia);if(typeof a=="string")return J((o=O[a])!=null?o:pe);let e=a.id?(i=O[a.id])!=null?i:pe:{amount:1,tint:[1,1,1],saturation:0,lift:0};return J({amount:(t=a.amount)!=null?t:e.amount,tint:(s=a.tint)!=null?s:e.tint,saturation:(r=a.saturation)!=null?r:e.saturation,lift:(n=a.lift)!=null?n:e.lift})}var $={none:{label:"None",strength:0,angle:0,saturation:0,stopLoss:0},light:{label:"Light CPL",strength:.45,angle:0,saturation:.2,stopLoss:0},strong:{label:"Strong CPL",strength:.85,angle:0,saturation:.4,stopLoss:0},crossed:{label:"Crossed CPL",strength:.85,angle:Math.PI/2,saturation:.1,stopLoss:0}},Ta=Object.keys($);var ee=$.none;function te(a){return{strength:a.strength,angle:a.angle,saturation:a.saturation,stopLoss:a.stopLoss}}var ve=a=>Math.min(1,Math.max(0,a));function _t(a){var o,i,t,s,r,n;if(a==null||a===!1)return te(ee);if(a===!0)return te($.light);if(typeof a=="string")return te((o=$[a])!=null?o:ee);let e=a.id&&(i=$[a.id])!=null?i:ee;return te({strength:ve((t=a.strength)!=null?t:e.strength),angle:(s=a.angle)!=null?s:e.angle,saturation:ve((r=a.saturation)!=null?r:e.saturation),stopLoss:ve((n=a.stopLoss)!=null?n:e.stopLoss)})}var P=Math.PI/180,St=864e5,Ct=2440588,Mt=2451545,We=23.4397*P;function Tt(a,e){let o=a.getTime()/St-.5+Ct-Mt,i=P*(357.5291+.98560028*o),t=P*(1.9148*Math.sin(i)+.02*Math.sin(2*i)+3e-4*Math.sin(3*i)),s=i+t+P*102.9372+Math.PI,r=Math.asin(Math.sin(We)*Math.sin(s)),n=Math.atan2(Math.sin(s)*Math.cos(We),Math.cos(s)),l=P*-e.longitude,h=P*e.latitude,u=P*(280.16+360.9856235*o)-l-n,d=Math.asin(Math.sin(h)*Math.sin(r)+Math.cos(h)*Math.cos(r)*Math.cos(u)),v=Math.atan2(Math.sin(u),Math.cos(u)*Math.sin(h)-Math.tan(r)*Math.cos(h))+Math.PI;return{elevation:d,azimuth:(v%(2*Math.PI)+2*Math.PI)%(2*Math.PI)}}function zt(a){let e=(a-6)/12;return{elevation:Math.asin(Math.sin(e*Math.PI)*.72),azimuth:Math.PI/2+e*Math.PI}}function He(a){if(a instanceof Date)return Number.isNaN(a.getTime())?null:a;if(typeof a=="string"&&/\d{4}-\d{2}-\d{2}/.test(a)){let e=new Date(a);return Number.isNaN(e.getTime())?null:e}return null}function At(a){var o;if(typeof a=="number")return(a%24+24)%24;let e=He(a);if(e)return e.getHours()+e.getMinutes()/60+e.getSeconds()/3600;if(typeof a=="string"){let i=/^(\d{1,2})(?::(\d{2}))?/.exec(a.trim());if(i)return((Number(i[1])+Number((o=i[2])!=null?o:0)/60)%24+24)%24}return 12}var ie={neutral:{label:"Neutral",exposure:0,contrast:1,knee:.8,bleach:0},flat:{label:"Flat",exposure:.15,contrast:.82,knee:.55,bleach:.25},punch:{label:"Punch",exposure:-.2,contrast:1.22,knee:.85,bleach:.1},filmic:{label:"Filmic",exposure:.1,contrast:1.08,knee:.42,bleach:.55},blown:{label:"Blown",exposure:.85,contrast:.95,knee:.7,bleach:.4}},za=Object.keys(ie);var ae=ie.neutral;function ge(a){return{exposure:a.exposure,contrast:a.contrast,knee:a.knee,bleach:a.bleach}}function xt(a){var o,i,t,s,r,n;if(a==null)return ge(ae);if(typeof a=="string")return ge((o=ie[a])!=null?o:ae);let e=a.id&&(i=ie[a.id])!=null?i:ae;return ge({exposure:(t=a.exposure)!=null?t:e.exposure,contrast:(s=a.contrast)!=null?s:e.contrast,knee:Math.min(.99,Math.max(.02,(r=a.knee)!=null?r:e.knee)),bleach:Math.min(1,Math.max(0,(n=a.bleach)!=null?n:e.bleach))})}var oe={clear:{label:"Clear",cloudCover:0,windSpeed:2,visibility:45},fair:{label:"Fair",cloudCover:.22,windSpeed:3,visibility:35},summer:{label:"Summer sky",cloudCover:.38,windSpeed:3,visibility:25,convection:.7},overcast:{label:"Overcast",cloudCover:.82,windSpeed:5,visibility:15},fog:{label:"Fog",cloudCover:.75,windSpeed:1,visibility:.6},rain:{label:"Rain",cloudCover:.95,windSpeed:7,visibility:8,precipitation:8,thunder:.08},thunderstorm:{label:"Thunderstorm",cloudCover:.97,windSpeed:12,visibility:5,precipitation:25,thunder:1,convection:.5},snow:{label:"Snow",cloudCover:.9,windSpeed:3,visibility:4,precipitation:3,precipitationType:"snow"},typhoon:{label:"Typhoon",cloudCover:1,windSpeed:30,visibility:6,precipitation:40,thunder:.5}},Aa=Object.keys(oe);var T=a=>a<0?0:a>1?1:a;function Lt(a){return T(Math.pow(T(a/30),.55))}function Pt(a){return T(Math.pow(T(a/33),.8))}function Ft(a){return T(Math.pow(T(a/5),.6))}function Et(a){return T(Math.pow(T((20-a)/20),2.6))}function It(a){var d,v,b,C,M,z,A,E,I,N,_;let e=typeof a=="string"?(d=oe[a])!=null?d:oe.clear:a!=null?a:{},o=(v=e.precipitation)!=null?v:0,i=e.precipitationType==="snow",t=i?0:Lt(o),s=i?Ft(o):0,r=Et((b=e.visibility)!=null?b:30),n=T((C=e.convection)!=null?C:0),l,h;e.clouds!=null?(l=ht(e.clouds),h=ut(l)):(h=T((M=e.cloudCover)!=null?M:0),l=dt(h,Math.max(t,s),n,r));let u=lt(l.cumulonimbus);return{clouds:l,features:{anvil:T((A=(z=e.features)==null?void 0:z.anvil)!=null?A:u.anvil),velum:T((I=(E=e.features)==null?void 0:E.velum)!=null?I:u.velum)},cloudCover:h,rain:t,snow:s,wind:Pt((N=e.windSpeed)!=null?N:0),thunder:T((_=e.thunder)!=null?_:0),haze:r}}var Ge={yaw:Math.PI,pitch:.46,fov:.86},xa=[{yaw:Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:-Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:0,pitch:Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:-Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:0,fov:Math.PI/2},{yaw:Math.PI,pitch:0,fov:Math.PI/2}],Ne={time:12,weather:"clear"};function Ue(a){var s,r;let e=(s=a.time)!=null?s:Ne.time,o=At(e),i=He(e),t=a.location&&i?Tt(i,a.location):zt(o);return y(c({timeOfDay:o,sunElevation:t.elevation,sunAzimuth:t.azimuth},It((r=a.weather)!=null?r:Ne.weather)),{filter:kt(a.filter),tone:xt(a.tone),polarizer:_t(a.polarizer),celestial:bt(a.celestial)})}function qe(a){return c(c({},Ge),a)}var Rt=`
...
void main() {
  ...
  if (u_p3 > 0.5) {
    ...
    sky = mix(srgbToDisplayP3(sky), sky, clamp(wide, 0.0, 1.0) * ${Dt.toFixed(4)});
  }
...
`,Bt=4096,Wt=["u_res","u_time","u_cam","u_sun","u_cover","u_high","u_mid","u_low","u_rain","u_snow","u_wind","u_thunder","u_haze","u_cbFeat","u_windOff","u_evo","u_filtAmt","u_filtTint","u_filtSat","u_filtLift","u_p3","u_headroom","u_tone","u_pol","u_sky","u_radiant"],Nt=class{constructor(a,e={}){m(this,"canvas");m(this,"opts");m(this,"gl",null);m(this,"program",null);m(this,"buffer",null);m(this,"u",{});m(this,"lost",!1);m(this,"p3",!1);m(this,"onLost",a=>{a.preventDefault(),this.lost=!0});m(this,"onRestored",()=>{this.lost=!1,this.init()});this.canvas=a,this.opts=e,a.addEventListener("webglcontextlost",this.onLost),a.addEventListener("webglcontextrestored",this.onRestored),this.init()}get available(){return this.gl!==null}get colorSpace(){return this.p3?"display-p3":"srgb"}init(){let a=this.canvas.getContext("webgl",{alpha:!1,antialias:!1,depth:!1,stencil:!1,powerPreference:"low-power"});if(!a){this.gl=null;return}this.gl=a,this.p3=!1,this.opts.colorSpace!=="srgb"&&"drawingBufferColorSpace"in a&&(a.drawingBufferColorSpace="display-p3",this.p3=a.drawingBufferColorSpace==="display-p3");let e=(r,n)=>{let l=a.createShader(r);return l?(a.shaderSource(l,n),a.compileShader(l),a.getShaderParameter(l,a.COMPILE_STATUS)?l:(console.error("atmosphere shader compile error:",a.getShaderInfoLog(l)),a.deleteShader(l),null)):null},o=e(a.VERTEX_SHADER,Rt),i=e(a.FRAGMENT_SHADER,Ot);if(!o||!i){this.gl=null;return}let t=a.createProgram();if(!t){this.gl=null;return}if(a.attachShader(t,o),a.attachShader(t,i),a.linkProgram(t),a.deleteShader(o),a.deleteShader(i),!a.getProgramParameter(t,a.LINK_STATUS)){console.error("atmosphere shader link error:",a.getProgramInfoLog(t)),this.gl=null;return}this.program=t,a.useProgram(t),this.buffer=a.createBuffer(),a.bindBuffer(a.ARRAY_BUFFER,this.buffer),a.bufferData(a.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),a.STATIC_DRAW);let s=a.getAttribLocation(t,"a_pos");a.enableVertexAttribArray(s),a.vertexAttribPointer(s,2,a.FLOAT,!1,0,0),this.u={};for(let r of Wt)this.u[r]=a.getUniformLocation(t,r)}resize(a,e){var o;this.canvas.width=a,this.canvas.height=e,(o=this.gl)==null||o.viewport(0,0,a,e)}render(a,e,o=Ge,i=0,t=0){var d,v,b,C,M;let s=this.gl;if(!s||this.lost||!this.program)return;s.useProgram(this.program);let r=this.u;s.uniform2f(r.u_res,this.canvas.width,this.canvas.height),s.uniform1f(r.u_time,a%Bt),s.uniform3f(r.u_cam,o.yaw,o.pitch,o.fov),s.uniform2f(r.u_sun,e.sunElevation,e.sunAzimuth);let n=e.clouds;s.uniform1f(r.u_cover,e.cloudCover),s.uniform3f(r.u_high,n.cirrus,n.cirrostratus,n.cirrocumulus),s.uniform3f(r.u_mid,n.altostratus,n.altocumulus,n.nimbostratus),s.uniform4f(r.u_low,n.stratus,n.stratocumulus,n.cumulus,n.cumulonimbus),s.uniform1f(r.u_rain,e.rain),s.uniform1f(r.u_snow,e.snow),s.uniform1f(r.u_wind,e.wind),s.uniform1f(r.u_thunder,e.thunder),s.uniform1f(r.u_haze,e.haze),s.uniform2f(r.u_cbFeat,e.features.anvil,e.features.velum),s.uniform1f(r.u_windOff,i),s.uniform1f(r.u_evo,t),s.uniform1f(r.u_filtAmt,e.filter.amount),s.uniform3f(r.u_filtTint,e.filter.tint[0],e.filter.tint[1],e.filter.tint[2]),s.uniform1f(r.u_filtSat,e.filter.saturation),s.uniform1f(r.u_filtLift,e.filter.lift),s.uniform1f(r.u_p3,this.p3?1:0),s.uniform1f(r.u_headroom,Math.max(1,(d=this.opts.headroom)!=null?d:1));let l=e.tone;s.uniform4f(r.u_tone,l.exposure,l.contrast,l.knee,l.bleach);let h=e.polarizer;s.uniform4f(r.u_pol,h.strength,h.angle,h.saturation,h.stopLoss);let u=e.celestial;s.uniform4f(r.u_sky,u.bortle,u.milkyWay,u.meteors,u.radiant?1:0),s.uniform2f(r.u_radiant,(b=(v=u.radiant)==null?void 0:v[0])!=null?b:0,(M=(C=u.radiant)==null?void 0:C[1])!=null?M:0),s.drawArrays(s.TRIANGLES,0,3)}dispose(a={}){var o;let e=this.gl;this.canvas.removeEventListener("webglcontextlost",this.onLost),this.canvas.removeEventListener("webglcontextrestored",this.onRestored),e&&(this.program&&e.deleteProgram(this.program),this.buffer&&e.deleteBuffer(this.buffer),a.loseContext&&((o=e.getExtension("WEBGL_lose_context"))==null||o.loseContext())),this.gl=null,this.program=null,this.buffer=null}},Ut=()=>Math.min(typeof devicePixelRatio=="number"?devicePixelRatio:1,1.5)*.55,$e=class{constructor(a,e={}){m(this,"canvas");m(this,"renderer");m(this,"animator");m(this,"opts");m(this,"target");m(this,"conditions");m(this,"cam");m(this,"raf",0);m(this,"observer",null);m(this,"startedAt",0);m(this,"last",0);m(this,"lastDraw",0);m(this,"wantRunning",!1);m(this,"motionQuery",null);m(this,"onMotionChange",()=>{this.wantRunning&&(this.reducedMotion?(this.stopLoop(),this.jump()):this.startLoop())});this.canvas=a,this.opts=e,this.conditions={time:e.time,location:e.location,weather:e.weather,filter:e.filter,tone:e.tone,polarizer:e.polarizer,celestial:e.celestial,camera:e.camera},this.target=Ue(this.conditions),this.cam=qe(e.camera),this.renderer=new Nt(a,{colorSpace:e.colorSpace}),this.animator=new mt(this.target,e.animator),this.resize(),typeof ResizeObserver!="undefined"&&(this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(a)),e.respectReducedMotion!==!1&&typeof matchMedia!="undefined"&&(this.motionQuery=matchMedia("(prefers-reduced-motion: reduce)"),this.motionQuery.addEventListener("change",this.onMotionChange)),e.autoStart!==!1&&this.start()}get reducedMotion(){var a,e;return(e=(a=this.motionQuery)==null?void 0:a.matches)!=null?e:!1}get available(){return this.renderer.available}get colorSpace(){return this.renderer.colorSpace}get state(){let a=this.animator.current;return y(c({},a),{clouds:c({},a.clouds),features:c({},a.features),filter:y(c({},a.filter),{tint:[...a.filter.tint]}),tone:c({},a.tone),polarizer:c({},a.polarizer),celestial:y(c({},a.celestial),{radiant:a.celestial.radiant?[a.celestial.radiant[0],a.celestial.radiant[1]]:null})})}get camera(){return this.cam}set(a){this.applyConditions(a),this.wantRunning&&!this.raf&&this.reducedMotion&&(this.animator.jump(this.target),this.draw(performance.now()))}jump(a={}){this.applyConditions(a),this.animator.jump(this.target),this.draw(performance.now())}applyConditions(a){this.conditions=c(c({},this.conditions),a),this.target=Ue(this.conditions),a.camera&&(this.cam=qe(c(c({},this.cam),a.camera)))}resize(){var i;let a=(i=this.opts.resolutionScale)!=null?i:Ut(),e=this.canvas.clientWidth||this.canvas.width,o=this.canvas.clientHeight||this.canvas.height;this.renderer.resize(Math.max(1,Math.round(e*a)),Math.max(1,Math.round(o*a)))}start(){if(this.available){if(this.wantRunning=!0,this.reducedMotion){this.jump();return}this.startLoop()}}stop(){this.wantRunning=!1,this.stopLoop()}startLoop(){if(this.raf)return;let a=performance.now();this.startedAt||(this.startedAt=a),this.last=a;let e=o=>{var s;this.raf=requestAnimationFrame(e);let i=1e3/((s=this.opts.fps)!=null?s:30),t=o-this.lastDraw;t<i||(this.lastDraw=o-t%i,this.draw(o))};this.raf=requestAnimationFrame(e)}stopLoop(){this.raf&&(cancelAnimationFrame(this.raf),this.raf=0)}draw(a){this.startedAt||(this.startedAt=a,this.last=a);let e=Math.min(.2,(a-this.last)/1e3);this.last=a,this.animator.step(this.target,e),this.reducedMotion&&(this.animator.current.celestial.meteors=0),this.renderer.render((a-this.startedAt)/1e3,this.animator.current,this.cam,this.animator.wind,this.animator.evolution)}dispose(a={}){var e,o;this.stop(),(e=this.observer)==null||e.disconnect(),this.observer=null,(o=this.motionQuery)==null||o.removeEventListener("change",this.onMotionChange),this.motionQuery=null,this.renderer.dispose(a)}};function ke(a,e){let o={};for(let i of Object.keys(a))o[i]=e(a[i]);return o}var La={en:ke(oe,a=>a.label),ja:{clear:"\u5FEB\u6674",fair:"\u6674\u308C",summer:"\u590F\u7A7A",overcast:"\u66C7\u308A",fog:"\u9727",rain:"\u96E8",thunderstorm:"\u96F7\u96E8",snow:"\u96EA",typhoon:"\u53F0\u98A8"}},Pa={en:ke(O,a=>a.label),ja:{none:"\u306A\u3057",sepia:"\u30BB\u30D4\u30A2",mono:"\u30E2\u30CE\u30AF\u30ED\u30FC\u30E0",faded:"\u892A\u8272",cyanotype:"\u9752\u306E\u8A18\u61B6",gold:"\u9EC4\u660F",ash:"\u7070"}},Fa={en:ke(we,a=>({label:a.label,alias:a.alias})),ja:{cirrus:{label:"\u5DFB\u96F2",alias:"\u3059\u3058\u96F2"},cirrostratus:{label:"\u5DFB\u5C64\u96F2",alias:"\u3046\u3059\u96F2"},cirrocumulus:{label:"\u5DFB\u7A4D\u96F2",alias:"\u3046\u308D\u3053\u96F2\u30FB\u3044\u308F\u3057\u96F2"},altostratus:{label:"\u9AD8\u5C64\u96F2",alias:"\u304A\u307C\u308D\u96F2"},altocumulus:{label:"\u9AD8\u7A4D\u96F2",alias:"\u3072\u3064\u3058\u96F2"},nimbostratus:{label:"\u4E71\u5C64\u96F2",alias:"\u3042\u307E\u96F2"},stratus:{label:"\u5C64\u96F2",alias:"\u304D\u308A\u96F2"},stratocumulus:{label:"\u5C64\u7A4D\u96F2",alias:"\u304F\u3082\u308A\u96F2"},cumulus:{label:"\u7A4D\u96F2",alias:"\u308F\u305F\u96F2"},cumulonimbus:{label:"\u7A4D\u4E71\u96F2",alias:"\u5165\u9053\u96F2"}}};var qt={latitude:37.8991768,longitude:-122.4949685},f={0:{cloudCover:0,precipitation:0,windSpeed:2,visibility:45,thunder:0},1:{cloudCover:.22,precipitation:0,windSpeed:3,visibility:35,thunder:0},2:{cloudCover:.35,precipitation:0,windSpeed:4,visibility:30,thunder:0},3:{cloudCover:.92,precipitation:0,windSpeed:5,visibility:18,thunder:0},45:{cloudCover:.75,precipitation:0,windSpeed:1,visibility:.6,thunder:0},48:{cloudCover:.78,precipitation:0,windSpeed:1,visibility:.4,thunder:0},51:{cloudCover:.62,precipitation:.2,windSpeed:2,visibility:10,thunder:0,precipitationType:"rain"},53:{cloudCover:.68,precipitation:.5,windSpeed:3,visibility:8,thunder:0,precipitationType:"rain"},55:{cloudCover:.75,precipitation:1.2,windSpeed:4,visibility:6,thunder:0,precipitationType:"rain"},56:{cloudCover:.7,precipitation:.3,windSpeed:3,visibility:3,thunder:0,precipitationType:"rain"},57:{cloudCover:.76,precipitation:1,windSpeed:4,visibility:2,thunder:0,precipitationType:"rain"},61:{cloudCover:.78,precipitation:2,windSpeed:4,visibility:10,thunder:0,precipitationType:"rain"},63:{cloudCover:.85,precipitation:5,windSpeed:6,visibility:8,thunder:0,precipitationType:"rain"},65:{cloudCover:.92,precipitation:18,windSpeed:8,visibility:4,thunder:0,precipitationType:"rain"},66:{cloudCover:.85,precipitation:2,windSpeed:5,visibility:2,thunder:0,precipitationType:"rain"},67:{cloudCover:.9,precipitation:10,windSpeed:7,visibility:1,thunder:0,precipitationType:"rain"},71:{cloudCover:.78,precipitation:.8,windSpeed:4,visibility:3,thunder:0,precipitationType:"snow"},73:{cloudCover:.85,precipitation:2.5,windSpeed:5,visibility:2,thunder:0,precipitationType:"snow"},75:{cloudCover:.92,precipitation:8,windSpeed:7,visibility:1,thunder:0,precipitationType:"snow"},77:{cloudCover:.7,precipitation:.5,windSpeed:5,visibility:2,thunder:0,precipitationType:"snow"},80:{cloudCover:.55,precipitation:2.5,windSpeed:5,visibility:12,thunder:0,precipitationType:"rain",convection:.55},81:{cloudCover:.65,precipitation:6,windSpeed:6,visibility:8,thunder:0,precipitationType:"rain",convection:.7},82:{cloudCover:.75,precipitation:25,windSpeed:8,visibility:4,thunder:0,precipitationType:"rain",convection:.85},85:{cloudCover:.55,precipitation:1,windSpeed:5,visibility:4,thunder:0,precipitationType:"snow",convection:.45},86:{cloudCover:.7,precipitation:6,windSpeed:7,visibility:2,thunder:0,precipitationType:"snow",convection:.7},95:{cloudCover:.96,precipitation:15,windSpeed:10,visibility:5,thunder:1,precipitationType:"rain",convection:.75},96:{cloudCover:.97,precipitation:25,windSpeed:12,visibility:4,thunder:1,precipitationType:"rain",convection:.85},99:{cloudCover:.99,precipitation:45,windSpeed:15,visibility:3,thunder:1,precipitationType:"rain",convection:.95}},Ht={"clear-day":y(c({},f[0]),{cloudCover:.03,windSpeed:3}),"clear-night":y(c({},f[0]),{overlay:"clear-night",cloudCover:0,windSpeed:2}),"mostly-clear-day":y(c({},f[1]),{cloudCover:.15,windSpeed:3}),"mostly-clear-night":y(c({},f[1]),{overlay:"clear-night",cloudCover:.1,windSpeed:2}),"partly-cloudy-day":f[2],"partly-cloudy-night":f[2],"mostly-cloudy-day":y(c({},f[3]),{cloudCover:.78}),"mostly-cloudy-night":y(c({},f[3]),{cloudCover:.78}),overcast:f[3],fog:y(c({},f[45]),{overlay:"fog-bank"}),"drizzle-light":f[51],drizzle:f[53],"drizzle-heavy":f[55],"rain-light":f[61],rain:f[63],"rain-heavy":f[65],"freezing-rain":y(c({},f[67]),{overlay:"ice"}),"snow-light":f[71],snow:f[73],"snow-heavy":f[75],"snow-grains":f[77],"rain-showers-light":f[80],"rain-showers":f[81],"rain-showers-heavy":f[82],"snow-showers-light":f[85],"snow-showers":f[86],thunderstorm:f[95],"thunderstorm-hail":y(c({},f[96]),{overlay:"hail"}),"thunderstorm-hail-heavy":y(c({},f[99]),{overlay:"hail"})},Gt={tornado:{cloudCover:1,precipitation:60,windSpeed:75,visibility:.2,thunder:1,convection:1,precipitationType:"rain",overlay:"tornado",label:"Tornado"},waterspout:{cloudCover:.98,precipitation:45,windSpeed:55,visibility:.5,thunder:1,convection:.95,precipitationType:"rain",overlay:"tornado",label:"Waterspout"},hurricane:{cloudCover:1,precipitation:90,windSpeed:60,visibility:.2,thunder:.9,convection:1,precipitationType:"rain",overlay:"hurricane",label:"Hurricane"},"tropical-storm":{cloudCover:1,precipitation:45,windSpeed:35,visibility:.5,thunder:.7,convection:.8,precipitationType:"rain",overlay:"rain",label:"Tropical Storm"},derecho:{cloudCover:1,precipitation:40,windSpeed:50,visibility:1,thunder:1,convection:.95,precipitationType:"rain",overlay:"lightning",label:"Derecho"},squall:{cloudCover:.95,precipitation:25,windSpeed:30,visibility:2,thunder:.8,convection:.7,precipitationType:"rain",overlay:"rain",label:"Squall"},blizzard:{cloudCover:1,precipitation:20,windSpeed:28,visibility:.1,thunder:0,convection:0,precipitationType:"snow",overlay:"snow-blizzard",label:"Blizzard"},"ice-storm":{cloudCover:.95,precipitation:18,windSpeed:12,visibility:.5,thunder:0,convection:0,precipitationType:"rain",overlay:"ice",label:"Ice Storm"},sandstorm:{cloudCover:.95,precipitation:0,windSpeed:25,visibility:.05,thunder:0,convection:0,overlay:"sand",label:"Sandstorm"},"dust-storm":{cloudCover:.92,precipitation:0,windSpeed:20,visibility:.1,thunder:0,convection:0,overlay:"dust",label:"Dust Storm"},"volcanic-ash":{cloudCover:.95,precipitation:0,windSpeed:8,visibility:.3,thunder:0,convection:0,overlay:"ash",label:"Volcanic Ash"},"wildfire-smoke":{cloudCover:.9,precipitation:0,windSpeed:6,visibility:1,thunder:0,convection:0,overlay:"smoke",label:"Wildfire Smoke"},"forest-fire":{cloudCover:.88,precipitation:0,windSpeed:8,visibility:.5,thunder:0,convection:0,overlay:"fire",label:"Forest Fire"},smoke:{cloudCover:.8,precipitation:0,windSpeed:4,visibility:1.5,thunder:0,convection:0,overlay:"smoke",label:"Smoke"},ash:{cloudCover:.85,precipitation:0,windSpeed:5,visibility:.4,thunder:0,convection:0,overlay:"ash",label:"Ash"},haze:{cloudCover:.35,precipitation:0,windSpeed:3,visibility:5,thunder:0,convection:0,overlay:"haze",label:"Haze"},smog:{cloudCover:.55,precipitation:0,windSpeed:2,visibility:2,thunder:0,convection:0,overlay:"smoke",label:"Smog"},"acid-rain":{cloudCover:.8,precipitation:12,windSpeed:6,visibility:5,thunder:.2,convection:0,precipitationType:"rain",overlay:"acid-rain",label:"Acid Rain"},"flash-flood":{cloudCover:.85,precipitation:50,windSpeed:10,visibility:2,thunder:.4,convection:.5,precipitationType:"rain",overlay:"rain",label:"Flash Flood"},aurora:{cloudCover:.2,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"aurora",label:"Aurora"},eclipse:{cloudCover:.1,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"eclipse",label:"Solar Eclipse"},"eclipse-lunar":{cloudCover:.05,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"eclipse-lunar",label:"Lunar Eclipse"},"blood-moon":{cloudCover:.05,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"blood-moon",label:"Blood Moon"},rainbow:{cloudCover:.3,precipitation:0,windSpeed:4,visibility:35,thunder:0,convection:0,overlay:"rainbow",label:"Rainbow"},"meteor-shower":{cloudCover:.15,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"meteors",label:"Meteor Shower"},"meteor-impact":{cloudCover:.25,precipitation:0,windSpeed:6,visibility:30,thunder:.6,convection:0,overlay:"meteor-impact",label:"Meteor Impact"},"asteroid-impact":{cloudCover:.6,precipitation:0,windSpeed:20,visibility:10,thunder:1,convection:.5,overlay:"meteor-impact",label:"Asteroid Impact"},earthquake:{cloudCover:.5,precipitation:0,windSpeed:4,visibility:20,thunder:0,convection:0,overlay:"earthquake",label:"Earthquake"},tsunami:{cloudCover:.85,precipitation:0,windSpeed:15,visibility:2,thunder:.2,convection:0,overlay:"tsunami",label:"Tsunami"},"volcanic-eruption":{cloudCover:1,precipitation:0,windSpeed:12,visibility:.05,thunder:.8,convection:.9,overlay:"volcano",label:"Volcanic Eruption"},landslide:{cloudCover:.65,precipitation:5,windSpeed:8,visibility:2,thunder:0,convection:0,overlay:"landslide",label:"Landslide"},mudslide:{cloudCover:.7,precipitation:15,windSpeed:10,visibility:1,thunder:0,convection:0,overlay:"mudslide",label:"Mudslide"},avalanche:{cloudCover:.8,precipitation:8,windSpeed:12,visibility:.5,thunder:0,convection:0,precipitationType:"snow",overlay:"avalanche",label:"Avalanche"},rockfall:{cloudCover:.4,precipitation:0,windSpeed:6,visibility:5,thunder:0,convection:0,overlay:"rockfall",label:"Rockfall"},"geological-event":{cloudCover:.55,precipitation:0,windSpeed:5,visibility:10,thunder:0,convection:0,overlay:"earthquake",label:"Geological Event"},apocalypse:{cloudCover:1,precipitation:80,windSpeed:40,visibility:.05,thunder:1,convection:1,precipitationType:"rain",overlay:"tornado",label:"Apocalypse"}},$t=c(c({},Ht),Gt),_e=class{constructor(e){this.canvas=document.createElement("canvas"),this.canvas.id="fx-overlay",this.canvas.style.cssText="position:absolute;inset:0;width:100%;height:100%;pointer-events:none;z-index:1",e.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),this.effect=null,this.t=0,this.w=0,this.h=0,this.particles=[],this.lastTick=0,this.dpr=Math.min(typeof window!="undefined"&&window.devicePixelRatio||1,1.5)*.5,this.fps=20,this.resize(),window.addEventListener("resize",()=>this.resize()),this._tick()}resize(){this.w=this.canvas.clientWidth||window.innerWidth,this.h=this.canvas.clientHeight||window.innerHeight,this.canvas.width=Math.floor(this.w*this.dpr),this.canvas.height=Math.floor(this.h*this.dpr),this.ctx.setTransform(this.dpr,0,0,this.dpr,0,0)}setEffect(e){if(this.effect=e||null,this.t=0,this.particles=[],e&&["clear-day","clear-night","sand","dust","ash","smoke","haze","snow-blizzard","volcano","landslide","mudslide","avalanche","rockfall","earthquake","tsunami","acid-rain","fire","hail"].includes(e)){let i={"clear-day":35,"clear-night":60,sand:300,dust:250,ash:200,smoke:150,haze:100,"snow-blizzard":400,volcano:300,landslide:250,mudslide:300,avalanche:400,rockfall:200,earthquake:250,tsunami:0,"acid-rain":120,fire:150,hail:100}[e]||300;for(let t=0;t<i;t++)this.particles.push(this._newParticle(e))}let o=document.querySelector(".ww");o&&(o.style.transition="none",o.style.transform="")}_rand(e,o){return e+Math.random()*(o-e)}_newParticle(e){let o=this.w,i=this.h;switch(e){case"clear-day":return{x:this._rand(0,o),y:this._rand(0,i),r:this._rand(.8,2.2),v:this._rand(.2,.6),vy:this._rand(-.1,.1),op:this._rand(.15,.35),life:this._rand(120,240),type:"clear-day"};case"clear-night":return{x:this._rand(0,o),y:this._rand(0,i*.6),r:this._rand(.6,1.6),v:this._rand(.05,.15),vy:this._rand(-.03,.03),op:this._rand(.25,.7),life:this._rand(80,180),twinkle:this._rand(.5,1.2),phase:this._rand(0,Math.PI*2),type:"clear-night"};case"sand":case"dust":return{x:this._rand(-o,o),y:this._rand(0,i),r:this._rand(1,3),v:this._rand(12,25),vy:this._rand(-1,1),op:this._rand(.4,.9)};case"ash":return{x:this._rand(0,o),y:this._rand(-i,0),r:this._rand(1,4),v:this._rand(2,6),vy:this._rand(2,8),op:this._rand(.3,.8)};case"smoke":case"haze":return{x:this._rand(-o,o),y:this._rand(0,i),r:this._rand(20,80),v:this._rand(4,10),vy:this._rand(-.5,.5),op:this._rand(.05,.2),grow:this._rand(.2,.8)};case"snow-blizzard":return{x:this._rand(0,o),y:this._rand(-i,i),r:this._rand(1,3),v:this._rand(18,35),vy:this._rand(4,10),op:this._rand(.5,.95)};case"volcano":return{x:this._rand(o*.45,o*.55),y:this._rand(i*.55,i*.75),r:this._rand(2,6),v:this._rand(-2,6),vy:this._rand(-6,-1),op:this._rand(.4,.9),life:this._rand(20,80)};case"landslide":case"mudslide":return{x:this._rand(-100,o),y:this._rand(-50,i*.6),r:this._rand(3,10),v:this._rand(3,10),vy:this._rand(2,8),op:this._rand(.5,.9)};case"avalanche":return{x:this._rand(0,o),y:this._rand(-i,0),r:this._rand(2,6),v:this._rand(10,25),vy:this._rand(8,18),op:this._rand(.5,.95)};case"rockfall":return{x:this._rand(-50,o+50),y:this._rand(-i*.5,0),r:this._rand(3,12),v:this._rand(-2,4),vy:this._rand(4,14),op:this._rand(.5,.9),rot:this._rand(0,Math.PI*2),rotv:this._rand(-.2,.2)};case"earthquake":return{x:this._rand(0,o),y:this._rand(i*.6,i),r:this._rand(1,4),v:this._rand(-1,1),vy:this._rand(-1,-3),op:this._rand(.3,.7),life:this._rand(10,50)};case"acid-rain":return{x:this._rand(0,o),y:this._rand(0,i),len:this._rand(14,28),v:this._rand(9,16),op:this._rand(.35,.75)};case"hail":return{x:this._rand(0,o),y:this._rand(-i,0),r:this._rand(2,6),v:this._rand(6,16),vy:this._rand(18,32),op:this._rand(.55,.9),rot:this._rand(0,Math.PI*2),rotv:this._rand(-.3,.3)};case"fire":return{x:this._rand(0,o),y:this._rand(i*.55,i),r:this._rand(2,7),v:this._rand(-1,2),vy:this._rand(-3,-.5),op:this._rand(.4,.9),life:this._rand(20,70)};default:return{}}}_tick(e){let o=e||performance.now(),i=1e3/this.fps;if(o-this.lastTick<i){requestAnimationFrame(n=>this._tick(n));return}this.lastTick=o-(o-this.lastTick)%i,this.t++;let{ctx:t,w:s,h:r}=this;t.clearRect(0,0,s,r),this.effect==="tornado"?this._drawTornado(t,s,r):this.effect==="hurricane"?this._drawHurricane(t,s,r):this.effect==="lightning"?this._drawLightningBolts(t,s,r):this.effect==="hail"?this._drawHail(t,s,r):this.effect==="ice"?this._drawIce(t,s,r):this.effect==="aurora"?this._drawAurora(t,s,r):this.effect==="eclipse"?this._drawEclipse(t,s,r):this.effect==="eclipse-lunar"?this._drawLunarEclipse(t,s,r):this.effect==="blood-moon"?this._drawBloodMoon(t,s,r):this.effect==="rainbow"?this._drawRainbow(t,s,r):this.effect==="meteors"?this._drawMeteors(t,s,r):this.effect==="meteor-impact"?this._drawMeteorImpact(t,s,r):this.effect==="earthquake"?this._drawEarthquake(t,s,r):this.effect==="tsunami"?this._drawTsunami(t,s,r):this.effect==="volcano"?this._drawVolcano(t,s,r):this.effect==="landslide"?this._drawLandslide(t,s,r):this.effect==="mudslide"?this._drawMudslide(t,s,r):this.effect==="avalanche"?this._drawAvalanche(t,s,r):this.effect==="rockfall"?this._drawRockfall(t,s,r):this.effect==="acid-rain"?this._drawAcidRain(t,s,r):this.effect==="fire"?this._drawFire(t,s,r):this.effect==="fog-bank"?this._drawFogBank(t,s,r):this.effect==="clear-day"?this._drawClearDay(t,s,r):this.effect==="clear-night"?this._drawClearNight(t,s,r):this.particles.length&&this._drawParticles(t,s,r),requestAnimationFrame(n=>this._tick(n))}_drawTornado(e,o,i){let t=o*.5,s=i*.95,r=this.t*.04;e.save(),e.globalCompositeOperation="source-over";let n=e.createLinearGradient(t,s,t,0);n.addColorStop(0,"rgba(20,20,25,0.9)"),n.addColorStop(.45,"rgba(60,60,70,0.5)"),n.addColorStop(1,"rgba(120,120,130,0)"),e.fillStyle=n,e.beginPath();for(let l=i;l>=0;l-=4){let h=1-l/i,u=140*(1-h)+12*h,d=Math.sin(r+l*.03)*(10*(1-h)+2);e.lineTo(t+d+u*.5,l)}for(let l=0;l<=i;l+=4){let h=l/i,u=140*h+12*(1-h),d=Math.sin(r+l*.03)*(10*h+2);e.lineTo(t+d-u*.5,l)}e.closePath(),e.fill(),e.globalCompositeOperation="screen";for(let l=0;l<40;l++){let h=r+l*.35,u=80+Math.sin(this.t*.1+l)*20,d=t+Math.cos(h)*u,v=s-20+Math.sin(h)*10;e.fillStyle=`rgba(180,170,160,${.3+Math.random()*.3})`,e.beginPath(),e.arc(d,v,1.5+Math.random()*2,0,Math.PI*2),e.fill()}e.restore()}_drawHurricane(e,o,i){let t=o*.5,s=i*.45,r=this.t*.015;e.save(),e.globalCompositeOperation="source-over";for(let l=0;l<4;l++){let h=r+l*(Math.PI/2);e.strokeStyle="rgba(60,60,70,0.35)",e.lineWidth=18,e.beginPath();for(let u=40;u<Math.max(o,i)*.8;u+=8){let d=h+u*.018,v=t+Math.cos(d)*u,b=s+Math.sin(d)*u;u===40?e.moveTo(v,b):e.lineTo(v,b)}e.stroke()}let n=e.createRadialGradient(t,s,5,t,s,45);n.addColorStop(0,"rgba(200,190,170,0.9)"),n.addColorStop(.6,"rgba(90,85,80,0.6)"),n.addColorStop(1,"rgba(40,40,45,0)"),e.fillStyle=n,e.beginPath(),e.arc(t,s,45,0,Math.PI*2),e.fill(),e.restore()}_drawLightningBolts(e,o,i){if(Math.random()>.03)return;e.save(),e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,250,220,0.95)",e.lineWidth=2+Math.random()*3,e.shadowColor="#fff8c5",e.shadowBlur=20;let t=this._rand(o*.2,o*.8);e.beginPath(),e.moveTo(t,0);let s=t,r=0;for(;r<i*.6;)s+=this._rand(-30,30),r+=this._rand(15,40),e.lineTo(s,r);e.stroke(),e.restore()}_drawIce(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let t=0;t<30;t++){let s=(this.t*.5+t*137)%(o+60)-30,r=t*79%(i+40)-20,n=8+t%7;e.strokeStyle=`rgba(200,230,255,${.15+t%5*.05})`,e.lineWidth=1,e.beginPath();for(let l=0;l<6;l++){let h=l*Math.PI/3+this.t*.02+t,u=n*.5,d=n;e.moveTo(s+Math.cos(h)*u,r+Math.sin(h)*u),e.lineTo(s+Math.cos(h)*d,r+Math.sin(h)*d)}e.stroke()}e.restore()}_drawHail(e,o,i){e.save(),e.globalCompositeOperation="source-over",e.shadowBlur=2,e.shadowColor="rgba(160, 190, 220, 0.35)";for(let t of this.particles)t.x+=t.v,t.y+=t.vy,t.rot+=t.rotv,t.y>i+t.r&&(t.y=this._rand(-30,-10),t.x=this._rand(0,o),t.v=this._rand(6,16),t.vy=this._rand(18,32)),e.globalAlpha=t.op,e.fillStyle="#e8f0f8",e.beginPath(),e.arc(t.x,t.y,t.r,0,Math.PI*2),e.fill();e.restore()}_drawAurora(e,o,i){e.save(),e.globalCompositeOperation="screen";let t=[{hue:140,baseY:.16,amp:55,speed:.015,thickness:110},{hue:165,baseY:.26,amp:70,speed:.011,thickness:130},{hue:195,baseY:.36,amp:50,speed:.02,thickness:90}];for(let s of t){let r=i*s.baseY,n=10;for(let l=0;l<=o;l+=n){let h=r+Math.sin(l*.012+this.t*s.speed)*s.amp+Math.sin(l*.004+this.t*s.speed*.6)*s.amp*.6,u=.55+.45*Math.sin(l*.05+this.t*.08),d=e.createLinearGradient(0,h-s.thickness*.5,0,h+s.thickness*.5);d.addColorStop(0,`hsla(${s.hue}, 85%, 65%, 0)`),d.addColorStop(.5,`hsla(${s.hue}, 85%, 65%, ${.22*u})`),d.addColorStop(1,`hsla(${s.hue}, 85%, 65%, 0)`),e.fillStyle=d,e.fillRect(l,h-s.thickness*.5,n+2,s.thickness)}}e.restore()}_drawEclipse(e,o,i){let t=o*.5,s=i*.25,r=Math.min(o,i)*.12;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(t,s,r*.9,t,s,r*1.6);n.addColorStop(0,"rgba(255,240,200,0.9)"),n.addColorStop(.5,"rgba(255,220,120,0.4)"),n.addColorStop(1,"rgba(255,200,80,0)"),e.fillStyle=n,e.beginPath(),e.arc(t,s,r*1.6,0,Math.PI*2),e.fill(),e.fillStyle="rgba(10,10,12,0.85)",e.beginPath(),e.arc(t+r*.15,s,r,0,Math.PI*2),e.fill(),e.restore()}_drawLunarEclipse(e,o,i){let t=o*.5,s=i*.28,r=Math.min(o,i)*.11;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(t,s,r*.8,t,s,r*2.2);n.addColorStop(0,"rgba(226,232,240,0.35)"),n.addColorStop(1,"rgba(226,232,240,0)"),e.fillStyle=n,e.beginPath(),e.arc(t,s,r*2.2,0,Math.PI*2),e.fill(),e.fillStyle="#e8edf4",e.beginPath(),e.arc(t,s,r,0,Math.PI*2),e.fill();let l=.5+.5*Math.sin(this.t*.01);e.globalAlpha=.82,e.fillStyle="#1e293b",e.beginPath(),e.arc(t+r*(.55+.25*l),s-r*.1,r*1.05,0,Math.PI*2),e.fill(),e.restore()}_drawBloodMoon(e,o,i){let t=o*.5,s=i*.28,r=Math.min(o,i)*.11;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(t,s,r*.7,t,s,r*2.6);n.addColorStop(0,"rgba(220,38,38,0.30)"),n.addColorStop(1,"rgba(220,38,38,0)"),e.fillStyle=n,e.beginPath(),e.arc(t,s,r*2.6,0,Math.PI*2),e.fill();let l=e.createRadialGradient(t-r*.3,s-r*.3,r*.1,t,s,r);l.addColorStop(0,"#c2410c"),l.addColorStop(.55,"#9a3412"),l.addColorStop(1,"#5c1a0a"),e.fillStyle=l,e.beginPath(),e.arc(t,s,r,0,Math.PI*2),e.fill(),e.globalAlpha=.35,e.fillStyle="#7c2d12",e.beginPath(),e.arc(t-r*.25,s-r*.15,r*.28,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(t+r*.3,s+r*.3,r*.2,0,Math.PI*2),e.fill(),e.restore()}_drawRainbow(e,o,i){let t=o*.5,s=i*.95,r=Math.min(o,i)*.75;e.save(),e.globalCompositeOperation="screen";let n=["#ff0000","#ff7f00","#ffff00","#00ff00","#0000ff","#4b0082","#9400d3"];for(let l=0;l<n.length;l++){let h=r-l*8;e.strokeStyle=n[l],e.lineWidth=7,e.globalAlpha=.55,e.beginPath(),e.arc(t,s,h,Math.PI,0),e.stroke()}e.restore()}_drawFogBank(e,o,i){e.save(),e.globalCompositeOperation="source-over";let t=5;for(let r=0;r<t;r++){let n=i*(.25+r*.16),l=Math.sin(this.t*.006+r*1.7)*40,h=Math.sin(this.t*.01+r)*12,u=e.createLinearGradient(0,n-60+h,0,n+60+h);u.addColorStop(0,"rgba(235,238,242,0)"),u.addColorStop(.5,`rgba(235,238,242,${.22-r*.02})`),u.addColorStop(1,"rgba(235,238,242,0)"),e.fillStyle=u,e.fillRect(l-100,0,o+200,i)}let s=e.createLinearGradient(0,0,0,i);s.addColorStop(0,"rgba(240,242,246,0.06)"),s.addColorStop(1,"rgba(240,242,246,0.28)"),e.fillStyle=s,e.fillRect(0,0,o,i),e.restore()}_drawParticles(e,o,i){let t=this.effect;if(e.save(),t==="sand"||t==="dust"){e.fillStyle=t==="sand"?"rgba(194,160,120,":"rgba(160,150,130,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.x>o+50&&(s.x=-50,s.y=this._rand(0,i)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.globalAlpha=t==="sand"?.25:.18,e.fillStyle=t==="sand"?"#c2a078":"#a69b8a",e.fillRect(0,0,o,i)}else if(t==="ash"){e.fillStyle="rgba(60,55,55,";for(let s of this.particles)s.x+=Math.sin(this.t*.02+s.y*.01)*.5,s.y+=s.vy,s.y>i+10&&(s.y=-10,s.x=this._rand(0,o)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.globalAlpha=.15,e.fillStyle="#6b2e1d",e.fillRect(0,0,o,i)}else if(t==="smoke"||t==="haze")for(let s of this.particles){s.x+=s.v,s.y+=s.vy,s.r+=s.grow,s.x>o+s.r&&(s.x=-s.r,s.y=this._rand(0,i),s.r=this._rand(20,80));let r=t==="smoke"?"80,70,60":"120,110,100";e.fillStyle=`rgba(${r},${s.op})`,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill()}else if(t==="snow-blizzard"){e.fillStyle="rgba(255,250,240,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.x>o+20&&(s.x=-20,s.y=this._rand(0,i)),s.y>i+20&&(s.y=-20,s.x=this._rand(0,o)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill()}e.restore()}_drawMeteors(e,o,i){e.save(),e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,255,240,0.9)",e.lineWidth=2,e.shadowColor="#fff",e.shadowBlur=6;for(let t=0;t<5;t++){if(Math.random()>.25)continue;let s=this._rand(o*.1,o*.9),r=this._rand(0,i*.4),n=this._rand(40,120),l=this._rand(Math.PI*.2,Math.PI*.8);e.beginPath(),e.moveTo(s,r),e.lineTo(s+Math.cos(l)*n,r+Math.sin(l)*n),e.stroke()}e.restore()}_drawMeteorImpact(e,o,i){e.save();let t=this.t;t<40&&(e.globalCompositeOperation="screen",e.fillStyle=`rgba(255,240,200,${Math.max(0,.9-t/40)})`,e.fillRect(0,0,o,i));let s=t*3%300;e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,220,160,0.4)",e.lineWidth=3,e.beginPath(),e.arc(o*.5,i*.3,s,0,Math.PI*2),e.stroke(),e.strokeStyle="rgba(255,160,60,0.85)",e.lineWidth=4,e.shadowColor="#ff8a00",e.shadowBlur=15;let r=o*.5+t*.4,n=i*.3+t*.9;e.beginPath(),e.moveTo(r,n),e.lineTo(r-40,n-90),e.stroke(),e.restore()}_drawEarthquake(e,o,i){let t=document.querySelector(".ww");if(t){let s=(Math.random()-.5)*6,r=(Math.random()-.5)*4;t.style.transform=`translate(${s}px, ${r}px)`}e.save(),e.fillStyle="rgba(120,110,100,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.life--,s.life<=0&&(s.x=this._rand(0,o),s.y=this._rand(i*.7,i),s.life=this._rand(10,50)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.strokeStyle="rgba(30,25,20,0.6)",e.lineWidth=2,e.beginPath(),e.moveTo(o*.2,i),e.lineTo(o*.35,i*.82),e.lineTo(o*.5,i*.88),e.lineTo(o*.8,i),e.stroke(),e.restore()}_drawTsunami(e,o,i){e.save(),e.globalCompositeOperation="source-over",e.fillStyle="rgba(10,25,40,0.35)",e.fillRect(0,0,o,i);let t=i*.55+Math.sin(this.t*.03)*20,s=e.createLinearGradient(0,i-t,0,i);s.addColorStop(0,"rgba(20,60,90,0.7)"),s.addColorStop(.6,"rgba(10,40,70,0.9)"),s.addColorStop(1,"rgba(5,25,50,0.95)"),e.fillStyle=s,e.beginPath(),e.moveTo(0,i);for(let r=0;r<=o;r+=20){let n=i-t+Math.sin(r*.02+this.t*.06)*25;e.lineTo(r,n)}e.lineTo(o,i),e.closePath(),e.fill(),e.strokeStyle="rgba(220,240,255,0.6)",e.lineWidth=5,e.beginPath();for(let r=0;r<=o;r+=20){let n=i-t+Math.sin(r*.02+this.t*.06)*25;r===0?e.moveTo(r,n):e.lineTo(r,n)}e.stroke(),e.restore()}_drawVolcano(e,o,i){e.save();let t=o*.5,s=i*.62;e.fillStyle="rgba(20,15,12,0.95)",e.beginPath(),e.moveTo(0,i),e.lineTo(t,s),e.lineTo(o,i),e.closePath(),e.fill();let r=e.createRadialGradient(t,s,4,t,s-120,90);r.addColorStop(0,"rgba(60,55,50,0.95)"),r.addColorStop(.5,"rgba(90,80,70,0.7)"),r.addColorStop(1,"rgba(120,110,100,0)"),e.fillStyle=r,e.beginPath(),e.arc(t,s-60,100+Math.sin(this.t*.05)*20,0,Math.PI*2),e.fill(),e.globalCompositeOperation="screen";for(let n of this.particles)n.x+=n.v,n.y+=n.vy,n.vy+=.15,(n.y>i||n.life--<=0)&&(n.x=this._rand(o*.48,o*.52),n.y=this._rand(i*.58,i*.65),n.vy=this._rand(-6,-1),n.v=this._rand(-2,4),n.life=this._rand(20,80)),e.fillStyle=`rgba(255,${Math.floor(80+Math.random()*80)},30,${n.op})`,e.shadowColor="#ff4500",e.shadowBlur=8,e.beginPath(),e.arc(n.x,n.y,n.r,0,Math.PI*2),e.fill();e.globalCompositeOperation="source-over",e.fillStyle="rgba(80,70,65,0.18)",e.fillRect(0,0,o,i),e.restore()}_drawLandslide(e,o,i){e.save(),e.fillStyle="rgba(90,75,55,";for(let t of this.particles)t.x+=t.v,t.y+=t.vy,(t.x>o+50||t.y>i+50)&&(t.x=this._rand(-100,o),t.y=this._rand(-50,i*.5)),e.globalAlpha=t.op,e.beginPath(),e.arc(t.x,t.y,t.r,0,Math.PI*2),e.fill();e.globalAlpha=.25,e.fillStyle="#5c4a35",e.beginPath(),e.moveTo(0,i*.45),e.lineTo(o,i*.35),e.lineTo(o,i),e.lineTo(0,i),e.closePath(),e.fill(),e.restore()}_drawMudslide(e,o,i){e.save(),e.fillStyle="rgba(75,60,45,";for(let t of this.particles)t.x+=t.v*1.2,t.y+=t.vy*1.2,(t.x>o+50||t.y>i+50)&&(t.x=this._rand(-100,o),t.y=this._rand(-50,i*.5)),e.globalAlpha=t.op,e.beginPath(),e.arc(t.x,t.y,t.r,0,Math.PI*2),e.fill();e.globalAlpha=.35,e.fillStyle="#4a3b2a",e.fillRect(0,i*.5,o,i*.5),e.restore()}_drawAvalanche(e,o,i){e.save(),e.fillStyle="rgba(245,245,255,";for(let t of this.particles)t.x+=t.v,t.y+=t.vy,t.y>i+20&&(t.y=this._rand(-i,0),t.x=this._rand(0,o)),e.globalAlpha=t.op,e.beginPath(),e.arc(t.x,t.y,t.r,0,Math.PI*2),e.fill();e.globalAlpha=.3,e.fillStyle="#e8eef5",e.beginPath(),e.moveTo(0,0),e.lineTo(o,0),e.lineTo(o,i*.55),e.lineTo(0,i*.65),e.closePath(),e.fill(),e.restore()}_drawRockfall(e,o,i){e.save(),e.fillStyle="rgba(90,85,80,";for(let t of this.particles)t.x+=t.v,t.y+=t.vy,t.rot+=t.rotv,t.vy+=.2,t.y>i+20&&(t.y=this._rand(-i*.5,0),t.x=this._rand(-50,o+50),t.vy=this._rand(4,14)),e.globalAlpha=t.op,e.save(),e.translate(t.x,t.y),e.rotate(t.rot),e.fillRect(-t.r,-t.r,t.r*2,t.r*2),e.restore();e.restore()}_drawAcidRain(e,o,i){e.save(),e.globalCompositeOperation="source-over",e.fillStyle="rgba(160,180,60,0.15)",e.fillRect(0,0,o,i);for(let t of this.particles)t.y+=t.v,t.y>i+20&&(t.y=-10,t.x=this._rand(0,o)),e.strokeStyle=`rgba(200,230,80,${t.op})`,e.lineWidth=2,e.lineCap="round",e.beginPath(),e.moveTo(t.x,t.y),e.lineTo(t.x-2,t.y+t.len),e.stroke();e.restore()}_drawFire(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let t of this.particles){t.x+=t.v,t.y+=t.vy,t.vy+=.05,t.life--,(t.life<=0||t.y<i*.3)&&(t.x=this._rand(o*.1,o*.9),t.y=this._rand(i*.7,i),t.vy=this._rand(-3,-.5),t.v=this._rand(-1,1),t.life=this._rand(20,70));let s=t.r*(t.life/70);e.fillStyle=`rgba(255,${Math.floor(100+Math.random()*100)},30,${t.op})`,e.shadowColor="#ff6b00",e.shadowBlur=10,e.beginPath(),e.arc(t.x,t.y,s,0,Math.PI*2),e.fill()}e.globalCompositeOperation="source-over",e.fillStyle="rgba(60,55,50,0.2)",e.fillRect(0,0,o,i),e.restore()}_drawClearDay(e,o,i){e.save(),e.globalCompositeOperation="source-over";for(let t of this.particles){t.x+=t.v,t.y+=t.vy,t.life--,(t.x>o+20||t.y<-20||t.life<=0)&&(t.x=this._rand(-20,o),t.y=this._rand(i*.2,i),t.v=this._rand(.3,.8),t.vy=this._rand(-.12,.12),t.life=this._rand(180,360));let s=.7+.3*Math.sin(this.t*.05+t.x*.01);e.globalAlpha=t.op*s,e.fillStyle="#ffffff",e.beginPath(),e.arc(t.x,t.y,t.r,0,Math.PI*2),e.fill(),e.globalAlpha=1}e.restore()}_drawClearNight(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let t of this.particles){t.x+=t.v,t.y+=t.vy,t.life--;let s=.5+.5*Math.sin(this.t*t.twinkle+t.phase);(t.life<=0||t.y<-10||t.x>o+10)&&(t.x=this._rand(0,o),t.y=this._rand(i*.1,i*.7),t.v=this._rand(.05,.15),t.vy=this._rand(-.05,.05),t.life=this._rand(150,320),t.twinkle=this._rand(.08,.18),t.phase=this._rand(0,Math.PI*2)),e.fillStyle=`rgba(255,245,220,${t.op*s})`,e.beginPath(),e.arc(t.x,t.y,t.r,0,Math.PI*2),e.fill()}if(Math.random()<.012){let t=this._rand(o*.1,o*.9),s=this._rand(0,i*.4),r=this._rand(20,60),n=this._rand(Math.PI*.25,Math.PI*.55);e.strokeStyle="rgba(255,245,220,0.8)",e.lineWidth=1.5,e.beginPath(),e.moveTo(t,s),e.lineTo(t-Math.cos(n)*r,s+Math.sin(n)*r),e.stroke()}e.restore()}},j=class{constructor(e,o={},i={}){this.canvas=e,this.colors=o,this.location=i.location||qt,this.timeOffsetMs=0,this.forceDay=i.forceDay||!1,this.forceNight=i.forceNight||!1,this.currentKey=null,this.currentParams=null,this.overlayEffect=null;let t=e.parentElement;t&&!t.querySelector("#fx-overlay")&&(this.overlay=new _e(t));try{this.sky=new $e(e,{time:this._now(),location:this.location,weather:f[0],resolutionScale:.55,fps:24,colorSpace:"srgb",celestial:{bortle:6,milkyWay:0,meteors:0}})}catch(s){console.error("Atmosphere initialization failed",s),this.sky=null}}_now(){let e=new Date(Date.now()+this.timeOffsetMs);if(!this.forceDay&&!this.forceNight)return e;let o=new Date(e.getFullYear(),e.getMonth(),e.getDate(),12,0,0),i=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0);return this.forceDay?o:i}setSunState(e,o){this.sky&&(this.timeOffsetMs=0,this.sky.set({time:this._now()}))}setCondition(e){this.currentKey=e||"clear-day";let o=$t[this.currentKey]||f[0];this.currentParams=c({},o),this.currentKey.includes("night")&&this.currentParams.isNightAdjusted,this.currentParams.precipitation>0&&!this.currentParams.precipitationType&&(this.currentParams.precipitationType="rain"),this.sky&&this.sky.set({time:this._now(),weather:{cloudCover:this.currentParams.cloudCover,precipitation:this.currentParams.precipitation,precipitationType:this.currentParams.precipitationType,windSpeed:this.currentParams.windSpeed,visibility:this.currentParams.visibility,thunder:this.currentParams.thunder||0,convection:this.currentParams.convection||0}}),this.overlayEffect=this.currentParams.overlay||null,this.overlay&&this.overlay.setEffect(this.overlayEffect)}setWeatherData(e){e=e||{};let o=this.currentParams||{},i=e.cloudCover,t=e.precipitation,s=e.windSpeed,r=e.visibility,n=e.thunder,l=e.precipitationType;this.sky&&this.sky.set({time:this._now(),weather:{cloudCover:i!=null?i:o.cloudCover!=null?o.cloudCover:0,precipitation:t!=null?t:o.precipitation!=null?o.precipitation:0,windSpeed:s!=null?s:o.windSpeed!=null?o.windSpeed:2,visibility:r!=null?r:o.visibility!=null?o.visibility:45,thunder:n!=null?n:o.thunder!=null?o.thunder:0,precipitationType:l!=null?l:o.precipitationType!=null?o.precipitationType:"rain"}})}dispose(){this.sky&&(this.sky.stop&&this.sky.stop(),this.sky.dispose&&this.sky.dispose()),this.overlay&&this.overlay.canvas.remove()}};window.WeatherAtmosphere=j;var ne=37.8991768,le=-122.4949685,x="America/Los_Angeles",jt=900*1e3;var W=document.documentElement.getAttribute("data-theme")||"day",se=new URLSearchParams(location.search).get("scene");function w(a){return getComputedStyle(document.documentElement).getPropertyValue(a).trim()}function je(a){let e=parseInt(a.slice(1),16);return[e>>16&255,e>>8&255,e&255]}function Vt([a,e,o]){return"#"+[a,e,o].map(i=>Math.round(Math.max(0,Math.min(255,i))).toString(16).padStart(2,"0")).join("")}function Se(a,e,o){let i=je(a),t=je(e);return Vt([i[0]+(t[0]-i[0])*o,i[1]+(t[1]-i[1])*o,i[2]+(t[2]-i[2])*o])}var Yt=[[0,"#7fa8cf","#ffcf9e","#fff6ea"],[.25,"#5b9bda","#bfe0f0","#eef7fa"],[.55,"#4a90d9","#8ec9ee","#eaf6fc"],[1,"#3f86d4","#8ec9ee","#e8f4fb"]],Zt=[[0,"#140a1e","#3a2210","#0d0800"],[-.15,"#0a0614","#20120a","#050301"],[-.45,"#050308","#0f0803","#000000"],[-1,"#020104","#080402","#000000"]];function Kt(a){let e=W==="night"?Zt:Yt,o=W==="night"?-Math.abs(a):Math.abs(a),i=e[0],t=e[e.length-1];for(let n=0;n<e.length-1;n++){let l=e[n],h=e[n+1];if(W==="night"?o<=l[0]&&o>=h[0]:o>=l[0]&&o<=h[0]){i=l,t=h;break}}let s=t[0]-i[0],r=s!==0?(o-i[0])/s:0;return{top:Se(i[1],t[1],Math.max(0,Math.min(1,r))),mid:Se(i[2],t[2],Math.max(0,Math.min(1,r))),bottom:Se(i[3],t[3],Math.max(0,Math.min(1,r)))}}var S=1;function B(a,e){let o=new Date(a.endsWith("Z")?a:a+"Z"),i=new Date(o.toLocaleString("en-US",{timeZone:e})),s=new Date(o.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-i.getTime();return new Date(o.getTime()+s)}function Me(a){let e=new Date,o=B(a.sunrise[S],x),i=B(a.sunset[S],x),t;if(e>=o&&e<=i){let n=(e-o)/(i-o);t={frac:n,elevation:Math.sin(Math.PI*n)}}else if(e<o){let n=B(a.sunset[S-1],x),l=Math.max(0,Math.min(1,(e-n)/(o-n)));t={frac:l,elevation:-Math.sin(Math.PI*l)}}else{let n=a.sunrise[S+1]?B(a.sunrise[S+1],x):new Date(i.getTime()+432e5),l=Math.max(0,Math.min(1,(e-i)/(n-i)));t={frac:l,elevation:-Math.sin(Math.PI*l)}}let s=Kt(t.elevation),r=document.documentElement;return r.style.setProperty("--sky-top",s.top),r.style.setProperty("--sky-mid",s.mid),r.style.setProperty("--sky-bottom",s.bottom),t}function Ce(a){return`${Math.round(a)}\xB0`}function Qt(a){return a==null?{label:"\u2014",color:"var(--fg3)",desc:"Air quality data is unavailable right now."}:a<=50?{label:"Good",color:"var(--good)",desc:"Air quality is good. Enjoy your usual outdoor activities."}:a<=100?{label:"Moderate",color:"var(--warn)",desc:"Air quality is acceptable, though there may be a risk for sensitive groups."}:a<=150?{label:"Unhealthy (SG)",color:"var(--warn)",desc:"Sensitive groups may experience health effects. Others are unlikely to be affected."}:a<=200?{label:"Unhealthy",color:"var(--bad)",desc:"Everyone may begin to experience health effects; sensitive groups more so."}:a<=300?{label:"Very Unhealthy",color:"var(--bad)",desc:"Health alert: everyone may experience more serious health effects."}:{label:"Hazardous",color:"var(--bad)",desc:"Health warning of emergency conditions. Everyone is at risk."}}function Xt(a){return["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round(a/22.5)%16]}function Jt(a,e){return`<svg viewBox="0 0 100 100">
  ...
  </svg>`}function ea(a,e){let i=new Date(a).getHours(),t=i>=12?"PM":"AM";return i=i%12,i===0&&(i=12),e?`${i}${t}`:"NOW"}function ta(a,e){if(!e)return"NOW";let o=new Date(a),i=o.getHours(),t=o.getMinutes().toString().padStart(2,"0"),s=i>=12?"PM":"AM";return i=i%12,i===0&&(i=12),`${i}:${t}`}function aa(a,e){return e===0?"Today":new Date(a+"T00:00:00").toLocaleDateString("en-US",{weekday:"short"})}function ia(){return L(this,null,function*(){let e=`https://api.open-meteo.com/v1/forecast?${`latitude=${ne}&longitude=${le}&cell_selection=land&elevation=4`}&current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,weather_code,cloud_cover,wind_speed_10m,wind_direction_10m&minutely_15=temperature_2m,weather_code,precipitation_probability,is_day,cloud_cover&hourly=temperature_2m,weather_code,precipitation_probability,visibility,is_day,cloud_cover&daily=weather_code,temperature_2m_max,temperature_2m_min,precipitation_probability_max,sunrise,sunset,uv_index_max&temperature_unit=fahrenheit&wind_speed_unit=mph&precipitation_unit=inch&timezone=${encodeURIComponent(x)}&forecast_days=7&past_days=1`,o=`https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${ne}&longitude=${le}&current=us_aqi&timezone=${encodeURIComponent(x)}`,[i,t,s]=yield Promise.all([fetch(e).then(r=>r.json()),fetch(o).then(r=>r.json()).catch(()=>null),da()]);return{weather:i,aq:t,skyCoverIntervals:s}})}var V=null,Te=null,ze=null,oa=`https://api.weather.gov/alerts/active?status=actual&point=${ne},${le}`,sa=`https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&latitude=${ne}&longitude=${le}&maxradiuskm=200&minmagnitude=4.0&starttime=`,ra="https://noaa-storm-proxy.iamflying29-sketch.deno.net",na="https://api.weather.gov/gridpoints/MTR/83,111";function la(a){let e=/^P(?:(\d+)D)?T(?:(\d+)H)?(?:(\d+)M)?/.exec(a||"");if(!e)return 0;let o=parseInt(e[1]||"0",10),i=parseInt(e[2]||"0",10),t=parseInt(e[3]||"0",10);return((o*24+i)*60+t)*60*1e3}function ha(a){return!a||!Array.isArray(a.values)?[]:a.values.map(e=>{let[o,i]=e.validTime.split("/"),t=new Date(o),s=new Date(t.getTime()+la(i));return{start:t,end:s,value:e.value}})}function da(){return L(this,null,function*(){try{let a=yield fetch(na);if(!a.ok)return null;let e=yield a.json();return ha(e.properties&&e.properties.skyCover)}catch(a){return console.warn("NWS gridpoint skyCover fetch failed",a),null}})}function Ae(a,e){if(!a||!a.length)return null;for(let o of a)if(e>=o.start&&e<o.end)return o.value;return null}function ua(a,e){if(!a||!a.length)return null;let o=[];for(let i=9;i<=18;i++){let t=B(`${e}T${String(i).padStart(2,"0")}:00:00`,x),s=Ae(a,t);s!=null&&o.push(s)}return o.length?o.reduce((i,t)=>i+t,0)/o.length:null}function ca(a,e){if(!a||!a.time)return null;let o=new Map;for(let t=0;t<a.time.length;t++){if(a.time[t].slice(0,10)!==e)continue;let s=parseInt(a.time[t].slice(11,13),10);if(s<9||s>18)continue;let r=a.weather_code[t];o.set(r,(o.get(r)||0)+1)}if(!o.size)return null;let i=null;for(let[t,s]of o)(!i||s>i.n||s===i.n&&t>i.code)&&(i={code:t,n:s});return i.code}var fa=[{re:/tornado/i,key:"tornado",label:"Tornado Warning",severity:5},{re:/tsunami/i,key:"tsunami",label:"Tsunami Warning",severity:5},{re:/hurricane/i,key:"hurricane",label:"Hurricane Warning",severity:4},{re:/tropical storm/i,key:"tropical-storm",label:"Tropical Storm Warning",severity:4},{re:/flash flood/i,key:"flash-flood",label:"Flash Flood Warning",severity:4},{re:/severe thunderstorm/i,key:"thunderstorm-hail",label:"Severe Thunderstorm Warning",severity:3},{re:/tornado watch|severe thunderstorm watch/i,key:"thunderstorm",label:"Severe Weather Watch",severity:2},{re:/fire weather|red flag/i,key:"wildfire-smoke",label:"Fire Weather Warning",severity:3},{re:/dust storm/i,key:"dust-storm",label:"Dust Storm Warning",severity:3},{re:/blizzard|winter storm/i,key:"blizzard",label:"Winter Storm Warning",severity:3},{re:/ice storm/i,key:"ice-storm",label:"Ice Storm Warning",severity:3},{re:/volcanic/i,key:"volcanic-eruption",label:"Volcanic Warning",severity:4}];function ma(a){return{Extreme:4,Severe:3,Moderate:2,Minor:1,Unknown:0}[a]||0}function pa(){return L(this,null,function*(){try{let a=yield fetch(oa);if(!a.ok)return[];let e=yield a.json();return Array.isArray(e.features)?e.features:[]}catch(a){return console.warn("NWS alerts fetch failed",a),[]}})}function va(){return L(this,null,function*(){try{let a=new Date(Date.now()-864e5).toISOString(),e=yield fetch(sa+encodeURIComponent(a));if(!e.ok)return null;let o=yield e.json();if(!o.features||!o.features.length)return null;let i=o.features[0];return{magnitude:i.properties.mag,place:i.properties.place,time:i.properties.time}}catch(a){return console.warn("USGS earthquake fetch failed",a),null}})}function ga(){return L(this,null,function*(){try{let a=yield fetch(`${ra}?v=1`);return a.ok?yield a.json():null}catch(a){return console.warn("NOAA/NHC storm fetch failed",a),null}})}function ya(a,e,o){let i=null;for(let t of a){let s=t.properties.event||"",r=ma(t.properties.severity);for(let n of fa)if(n.re.test(s)){let l=n.severity*10+r;(!i||l>i.score)&&(i=y(c({},n),{score:l}))}}return i?{key:i.key,label:i.label,source:"NWS"}:e?{key:"earthquake",label:`Earthquake M${e.magnitude}`,source:"USGS"}:null}var wa=[{penumbral:["2026-03-03T08:44:00Z","2026-03-03T14:23:00Z"],umbral:["2026-03-03T09:50:00Z","2026-03-03T13:17:00Z"],total:["2026-03-03T11:04:00Z","2026-03-03T12:03:00Z"]},{penumbral:["2026-08-28T01:23:00Z","2026-08-28T07:02:00Z"],umbral:["2026-08-28T02:33:00Z","2026-08-28T05:52:00Z"],bloodAtMax:!0,maxWindow:["2026-08-28T03:43:00Z","2026-08-28T04:43:00Z"]}];function re(a,e){return a>=new Date(e[0])&&a<=new Date(e[1])}function ba(a){for(let e of wa){if(e.total&&re(a,e.total))return{key:"blood-moon",label:"Blood Moon (Total Lunar Eclipse)",source:"NASA"};if(e.bloodAtMax&&e.maxWindow&&re(a,e.maxWindow))return{key:"blood-moon",label:"Blood Moon (Lunar Eclipse)",source:"NASA"};if(e.umbral&&re(a,e.umbral))return{key:"eclipse-lunar",label:"Partial Lunar Eclipse",source:"NASA"};if(e.penumbral&&re(a,e.penumbral))return{key:"eclipse-lunar",label:"Lunar Eclipse",source:"NASA"}}return null}function ka(a,e){let{weather:o,aq:i,alerts:t,quake:s,noaaStorms:r,skyCoverIntervals:n}=a,l=o.current,h=o.hourly,u=o.minutely_15,d=o.daily;V=d;let v=Me(d);e&&e.setSunState(v.frac,v.elevation);let b=!!l.is_day,C=Ae(n,new Date),M=C!=null?C:l.cloud_cover,z=wmoInfo(l.weather_code,b,M),A=se||z.key;se&&(z={key:A,label:labelForKey(A)});let E=se?null:ya(t||[],s,r);if(E)z={key:E.key,label:E.label},A=z.key;else if(!se){let p=ba(new Date);p&&(z={key:p.key,label:p.label},A=z.key)}let I={theme:W,"--sun-core":w("--sun-core"),"--moon-core":w("--moon-core"),"--cloud":w("--cloud"),"--cloud2":w("--cloud2"),"--rain":w("--rain"),"--snow":w("--snow"),"--fog":w("--fog"),"--bolt":w("--bolt"),"--fg":w("--fg")};document.getElementById("nowIcon").innerHTML=iconSvgFor(A,I),document.getElementById("nowTemp").textContent=Ce(l.temperature_2m),document.getElementById("nowCond").textContent=z.label,document.getElementById("nowSub").textContent=`Feels like ${Ce(l.apparent_temperature)}`,document.getElementById("hilo").textContent=`H:${Math.round(d.temperature_2m_max[S])}\xB0  L:${Math.round(d.temperature_2m_min[S])}\xB0`,Te=A,ze=M,e&&e.setCondition(A),e&&M!=null&&e.setWeatherData({cloudCover:M/100});let N=u&&u.time&&u.time.length>0,_=N?u:h,Ze=o.current.time.slice(0,16),U=_.time.findIndex(p=>p>=Ze);U<0&&(U=0);let xe=document.getElementById("hourly");xe.innerHTML="";for(let p=0;p<12;p++){let g=U+p;if(g>=_.time.length)break;let de=_.is_day?!!_.is_day[g]:!0,Z=_.cloud_cover?_.cloud_cover[g]:null,K=Ae(n,B(_.time[g],x)),H=wmoInfo(_.weather_code[g],de,K!=null?K:Z),D=_.precipitation_probability?_.precipitation_probability[g]:null,G=document.createElement("div");G.className="ww-hour",G.innerHTML=`
      <div class="hh">${N?ta(_.time[g],p):ea(_.time[g],p)}</div>
      ${iconSvgFor(H.key,I)}
      <div class="ht">${Math.round(_.temperature_2m[g])}\xB0</div>
      <div class="hp">${D!=null&&D>=15?D+"%":""}</div>
    `,xe.appendChild(G)}let Le=document.getElementById("daily");Le.innerHTML="";let Pe=Math.min(...d.temperature_2m_min.slice(S,S+5)),Ke=Math.max(...d.temperature_2m_max.slice(S,S+5)),Fe=Math.max(1,Ke-Pe);for(let p=0;p<5;p++){let g=S+p,de=ua(n,d.time[g]),Z=ca(h,d.time[g]),K=wmoInfo(Z!=null?Z:d.weather_code[g],!0,de),H=d.temperature_2m_min[g],D=d.temperature_2m_max[g],G=(H-Pe)/Fe*100,at=(D-H)/Fe*100,Re=d.precipitation_probability_max[g],ue=document.createElement("div");ue.className="ww-day-row",ue.innerHTML=`
      <div class="dn">${aa(d.time[g],p)}</div>
      ${iconSvgFor(K.key,I)}
      <div class="ww-bar"><span style="left:${G}%;width:${at}%"></span></div>
      <div class="dp">${Re>=15?Re+"%":""}</div>
      <div class="dlo">${Math.round(H)}\xB0</div>
      <div class="dhi">${Math.round(D)}\xB0</div>
    `,Le.appendChild(ue)}let q=i&&i.current?i.current.us_aqi:null,he=Qt(q);document.getElementById("aqiVal").textContent=q!=null?Math.round(q):"\u2014",document.getElementById("aqiVal").style.color=he.color,document.getElementById("aqiCat").textContent=he.label,document.getElementById("aqiDesc").textContent=he.desc;let Qe=q!=null?Math.min(100,q/300*100):0;document.getElementById("aqiMarker").style.left=`${Qe}%`;let Xe=new Date(d.sunrise[S]),Je=new Date(d.sunset[S]),Ee=p=>p.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),et=h.visibility&&h.visibility[U]!=null?(h.visibility[U]/1609.34).toFixed(1):"\u2014",R=w("--fg"),tt=[{icon:WI.uv(R),label:"UV Index",value:Math.round(d.uv_index_max[S]),sub:_a(d.uv_index_max[S])},{icon:WI.sunrise(R),label:"Sunrise",value:Ee(Xe),sub:`Sunset ${Ee(Je)}`},{icon:"",label:"Wind",value:`${Math.round(l.wind_speed_10m)} mph`,sub:Xt(l.wind_direction_10m),compass:l.wind_direction_10m},{icon:WI.drop(R),label:"Humidity",value:`${Math.round(l.relative_humidity_2m)}%`,sub:""},{icon:WI.eye(R),label:"Visibility",value:`${et} mi`,sub:""},{icon:WI.thermo(R),label:"Feels Like",value:Ce(l.apparent_temperature),sub:""}],Ie=document.getElementById("grid");Ie.innerHTML="";for(let p of tt){let g=document.createElement("div");g.className="ww-card",p.compass!==void 0?g.innerHTML=`<div class="cl">${p.label}</div><div class="ww-compass">${Jt(p.compass,R)}</div><div class="cv" style="font-size:16px">${p.value}</div><div class="cs">${p.sub}</div>`:g.innerHTML=`<div class="cl">${p.icon}${p.label}</div><div class="cv">${p.value}</div><div class="cs">${p.sub}</div>`,Ie.appendChild(g)}}function _a(a){return a<3?"Low":a<6?"Moderate":a<8?"High":a<11?"Very High":"Extreme"}var Y=null;window.fxEngine=null;function Ve(){return L(this,null,function*(){try{let[a,e,o,i]=yield Promise.all([ia(),pa(),va(),ga()]);ka(y(c({},a),{alerts:e,quake:o,noaaStorms:i}),Y)}catch(a){console.error("Weather fetch failed",a)}})}function Ye(){Ve(),setInterval(Ve,jt),setInterval(()=>{if(V){let a=Me(V);Y&&Y.setSunState(a.frac,a.elevation)}},60*1e3),setTimeout(()=>{try{let a=document.getElementById("fx"),e=new j(a,{sunCore:w("--sun-core"),sunGlow:w("--sun-glow"),moonCore:w("--moon-core"),moonGlow:w("--moon-glow"),cloud:w("--cloud"),cloud2:w("--cloud2"),rain:w("--rain"),snow:w("--snow"),fog:w("--fog"),bolt:w("--bolt")},{forceDay:W==="day",forceNight:W==="night"});if(Y=e,window.fxEngine=e,V){let o=Me(V);e.setSunState(o.frac,o.elevation)}Te&&(e.setCondition(Te),ze!=null&&e.setWeatherData({cloudCover:ze/100}))}catch(a){console.error("Atmosphere engine failed to start; continuing without it",a),Y=null,window.fxEngine=null}},0)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ye):Ye();})();
