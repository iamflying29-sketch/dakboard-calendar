(()=>{var dt=Object.defineProperty,ct=Object.defineProperties;var ft=Object.getOwnPropertyDescriptors;var Be=Object.getOwnPropertySymbols;var mt=Object.prototype.hasOwnProperty,pt=Object.prototype.propertyIsEnumerable;var me=(t,e,o)=>e in t?dt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,d=(t,e)=>{for(var o in e||(e={}))mt.call(e,o)&&me(t,o,e[o]);if(Be)for(var o of Be(e))pt.call(e,o)&&me(t,o,e[o]);return t},w=(t,e)=>ct(t,ft(e));var p=(t,e,o)=>me(t,typeof e!="symbol"?e+"":e,o);var L=(t,e,o)=>new Promise((i,a)=>{var s=l=>{try{n(o.next(l))}catch(h){a(h)}},r=l=>{try{n(o.throw(l))}catch(h){a(h)}},n=l=>l.done?i(l.value):Promise.resolve(l.value).then(s,r);n((o=o.apply(t,e)).next())});var ke={cirrus:{label:"Cirrus",alias:"Mare's tail",abbr:"Ci",level:"high",form:"filament",opacity:.15},cirrostratus:{label:"Cirrostratus",alias:"Veil cloud",abbr:"Cs",level:"high",form:"stratiform",opacity:.45},cirrocumulus:{label:"Cirrocumulus",alias:"Mackerel sky",abbr:"Cc",level:"high",form:"granular",opacity:.25},altostratus:{label:"Altostratus",alias:"Grey veil",abbr:"As",level:"mid",form:"stratiform",opacity:.9},altocumulus:{label:"Altocumulus",alias:"Sheep cloud",abbr:"Ac",level:"mid",form:"granular",opacity:.45},nimbostratus:{label:"Nimbostratus",alias:"Rain cloud",abbr:"Ns",level:"mid",form:"stratiform",opacity:1},stratus:{label:"Stratus",alias:"Fog cloud",abbr:"St",level:"low",form:"stratiform",opacity:.95},stratocumulus:{label:"Stratocumulus",alias:"Roll cloud",abbr:"Sc",level:"low",form:"granular",opacity:.75},cumulus:{label:"Cumulus",alias:"Cotton cloud",abbr:"Cu",level:"low",form:"convective",opacity:.4},cumulonimbus:{label:"Cumulonimbus",alias:"Thunderhead",abbr:"Cb",level:"low",form:"convective",opacity:.28}},_e=Object.keys(ke),I=t=>t<0?0:t>1?1:t;function _(t,e,o){let i=I((t-e)/(o-e));return i*i*(3-2*i)}function vt(t){let e=I(t);return{anvil:_(e,.68,1),velum:_(e,.22,.5)*(1-_(e,.68,.95))}}var ae={cirrus:0,cirrostratus:0,cirrocumulus:0,altostratus:0,altocumulus:0,nimbostratus:0,stratus:0,stratocumulus:0,cumulus:0,cumulonimbus:0};function gt(t){var o;if(t==null)return d({},ae);if(typeof t=="string")return w(d({},ae),{[t]:1});if(Array.isArray(t)){let i=d({},ae);for(let a of t)i[a]=1;return i}let e=d({},ae);for(let i of _e)e[i]=I((o=t[i])!=null?o:0);return e}function yt(t,e,o,i){let a=I(t),s=I(e),r=1-s,n=1-_(a,.28,.72),l=1-_(a,.45,.85),h=a>=.15&&a<.52,u=a>=.52&&a<.85,c=a>=.85,v=s>.05;return{cirrus:_(a,.05,.55)*.42*n,cirrostratus:_(a,.1,.55)*.25*n,cirrocumulus:_(a,.14,.45)*(h?.22:.14)*n*r,altostratus:_(a,.45,.82)*(v?.85:.55)*(1-_(a,.82,.98))*r,altocumulus:_(a,.22,.55)*(h?.35:u?.62:.45)*(1-_(a,.72,.95))*r,nimbostratus:s*_(a,.55,.88),stratus:c?_(a,.65,.95)*.85*(1-s*.4):i>.1?i*.45:0,stratocumulus:_(a,.28,.78)*(h?.38:u?.82:.85)*(1-s*.6)*r,cumulus:_(a,.08,.48)*(h?.42:.28)*l*r,cumulonimbus:I(o)*_(a,.12,.45)}}function wt(t){let e=1;for(let o of _e)e*=1-t[o]*ke[o].opacity;return I(1-e)}var bt={tau:2.2,windBase:.006,windGust:.22,evoBase:.07,evoGust:.09,windPerHour:.25,evoPerHour:.06},kt=Math.PI*2;function Ue(t){return{filter:w(d({},t.filter),{tint:[t.filter.tint[0],t.filter.tint[1],t.filter.tint[2]]}),tone:d({},t.tone),polarizer:d({},t.polarizer),celestial:w(d({},t.celestial),{radiant:t.celestial.radiant?[t.celestial.radiant[0],t.celestial.radiant[1]]:null}),clouds:d({},t.clouds),features:d({},t.features)}}function pe(t,e,o,i){let a=i/2,s=(e-t+i*1.5)%i-a;return(t+s*o+i)%i}var _t=class{constructor(t,e={}){p(this,"current");p(this,"windOff",41.7);p(this,"evoOff",7.3);p(this,"opts");this.current=d(d({},t),Ue(t)),this.opts=d(d({},bt),e)}get wind(){return this.windOff}get evolution(){return this.evoOff}jump(t){Object.assign(this.current,t,Ue(t))}step(t,e){let o=this.opts,i=this.current,a=1-Math.exp(-e/o.tau),s=i.timeOfDay;i.timeOfDay=pe(i.timeOfDay,t.timeOfDay,a,24);let r=(i.timeOfDay-s+36)%24-12;i.sunElevation+=(t.sunElevation-i.sunElevation)*a,i.sunAzimuth=pe(i.sunAzimuth,t.sunAzimuth,a,kt),i.cloudCover+=(t.cloudCover-i.cloudCover)*a;for(let T of _e)i.clouds[T]+=(t.clouds[T]-i.clouds[T])*a;i.features.anvil+=(t.features.anvil-i.features.anvil)*a,i.features.velum+=(t.features.velum-i.features.velum)*a,i.rain+=(t.rain-i.rain)*a,i.snow+=(t.snow-i.snow)*a,i.wind+=(t.wind-i.wind)*a,i.thunder+=(t.thunder-i.thunder)*a,i.haze+=(t.haze-i.haze)*a;let n=i.filter,l=t.filter;n.amount+=(l.amount-n.amount)*a,n.saturation+=(l.saturation-n.saturation)*a,n.lift+=(l.lift-n.lift)*a,n.tint=[n.tint[0]+(l.tint[0]-n.tint[0])*a,n.tint[1]+(l.tint[1]-n.tint[1])*a,n.tint[2]+(l.tint[2]-n.tint[2])*a];let h=i.tone,u=t.tone;h.exposure+=(u.exposure-h.exposure)*a,h.contrast+=(u.contrast-h.contrast)*a,h.knee+=(u.knee-h.knee)*a,h.bleach+=(u.bleach-h.bleach)*a;let c=i.polarizer,v=t.polarizer;c.strength+=(v.strength-c.strength)*a,c.saturation+=(v.saturation-c.saturation)*a,c.stopLoss+=(v.stopLoss-c.stopLoss)*a,c.angle=pe(c.angle,v.angle,a,Math.PI);let f=i.celestial,b=t.celestial;f.bortle+=(b.bortle-f.bortle)*a,f.milkyWay+=(b.milkyWay-f.milkyWay)*a,f.meteors+=(b.meteors-f.meteors)*a,f.radiant=b.radiant?[b.radiant[0],b.radiant[1]]:null,this.windOff+=(o.windBase+i.wind*o.windGust)*e+Math.abs(r)*o.windPerHour,this.evoOff+=(o.evoBase+i.wind*o.evoGust)*e+Math.abs(r)*o.evoPerHour}},St=[.82246197,.17753803,0,.0331942,.9668058,0,.01708263,.07239744,.91051993];function Mt(t){let e=o=>[t[o],t[o+3],t[o+6]].map(i=>i.toFixed(8)).join(", ");return`mat3(${e(0)},
       ${e(1)},
       ${e(2)})`}var Ct=[1.05,.79],Tt=[.98,1.48],be={"dark-sky":{label:"Dark sky",bortle:2,milkyWay:1,meteors:5,radiant:null},rural:{label:"Rural",bortle:4,milkyWay:.45,meteors:5,radiant:null},suburban:{label:"Suburban",bortle:6,milkyWay:0,meteors:0,radiant:null},city:{label:"City",bortle:8,milkyWay:0,meteors:0,radiant:null},perseids:{label:"Perseids",bortle:3,milkyWay:.75,meteors:100,radiant:Ct},geminids:{label:"Geminids",bortle:3,milkyWay:.75,meteors:150,radiant:Tt}},Xa=Object.keys(be);var oe={bortle:6,milkyWay:0,meteors:0,radiant:null};function zt(t){return Math.min(1,Math.max(0,(5.5-t)/3.5))}function ve(t){return{bortle:t.bortle,milkyWay:t.milkyWay,meteors:t.meteors,radiant:t.radiant?[t.radiant[0],t.radiant[1]]:null}}var He=(t,e,o)=>Math.min(o,Math.max(e,t));function At(t){var i,a,s,r,n;if(t==null)return ve(oe);if(typeof t=="string")return ve((i=be[t])!=null?i:oe);let e=t.id&&(a=be[t.id])!=null?a:oe,o=He((s=t.bortle)!=null?s:e.bortle,1,9);return ve({bortle:o,milkyWay:He((r=t.milkyWay)!=null?r:t.id?e.milkyWay:zt(o),0,1),meteors:Math.max(0,(n=t.meteors)!=null?n:e.meteors),radiant:t.radiant!==void 0?t.radiant:e.radiant})}var W={none:{label:"None",amount:0,tint:[1,1,1],saturation:1,lift:0},sepia:{label:"Sepia",amount:1,tint:[1.07,.93,.72],saturation:.1,lift:.02},mono:{label:"Monochrome",amount:1,tint:[1,1,1],saturation:0,lift:0},faded:{label:"Faded",amount:1,tint:[1.02,.99,.94],saturation:.35,lift:.06},cyanotype:{label:"Cyanotype",amount:1,tint:[.72,.9,1.12],saturation:.08,lift:.03},gold:{label:"Gold",amount:1,tint:[1.15,.95,.6],saturation:.45,lift:.02},ash:{label:"Ash",amount:1,tint:[.92,.95,1],saturation:.2,lift:.04}},eo=Object.keys(W);var ge=W.none;function ie(t){return{amount:t.amount,tint:[t.tint[0],t.tint[1],t.tint[2]],saturation:t.saturation,lift:t.lift}}function Lt(t){var o,i,a,s,r,n;if(t==null||t===!1)return ie(ge);if(t===!0)return ie(W.sepia);if(typeof t=="string")return ie((o=W[t])!=null?o:ge);let e=t.id?(i=W[t.id])!=null?i:ge:{amount:1,tint:[1,1,1],saturation:0,lift:0};return ie({amount:(a=t.amount)!=null?a:e.amount,tint:(s=t.tint)!=null?s:e.tint,saturation:(r=t.saturation)!=null?r:e.saturation,lift:(n=t.lift)!=null?n:e.lift})}var Y={none:{label:"None",strength:0,angle:0,saturation:0,stopLoss:0},light:{label:"Light CPL",strength:.45,angle:0,saturation:.2,stopLoss:0},strong:{label:"Strong CPL",strength:.85,angle:0,saturation:.4,stopLoss:0},crossed:{label:"Crossed CPL",strength:.85,angle:Math.PI/2,saturation:.1,stopLoss:0}},to=Object.keys(Y);var se=Y.none;function re(t){return{strength:t.strength,angle:t.angle,saturation:t.saturation,stopLoss:t.stopLoss}}var ye=t=>Math.min(1,Math.max(0,t));function Pt(t){var o,i,a,s,r,n;if(t==null||t===!1)return re(se);if(t===!0)return re(Y.light);if(typeof t=="string")return re((o=Y[t])!=null?o:se);let e=t.id&&(i=Y[t.id])!=null?i:se;return re({strength:ye((a=t.strength)!=null?a:e.strength),angle:(s=t.angle)!=null?s:e.angle,saturation:ye((r=t.saturation)!=null?r:e.saturation),stopLoss:ye((n=t.stopLoss)!=null?n:e.stopLoss)})}var x=Math.PI/180,Et=864e5,Ft=2440588,xt=2451545,qe=23.4397*x;function It(t,e){let o=t.getTime()/Et-.5+Ft-xt,i=x*(357.5291+.98560028*o),a=x*(1.9148*Math.sin(i)+.02*Math.sin(2*i)+3e-4*Math.sin(3*i)),s=i+a+x*102.9372+Math.PI,r=Math.asin(Math.sin(qe)*Math.sin(s)),n=Math.atan2(Math.sin(s)*Math.cos(qe),Math.cos(s)),l=x*-e.longitude,h=x*e.latitude,u=x*(280.16+360.9856235*o)-l-n,c=Math.asin(Math.sin(h)*Math.sin(r)+Math.cos(h)*Math.cos(r)*Math.cos(u)),v=Math.atan2(Math.sin(u),Math.cos(u)*Math.sin(h)-Math.tan(r)*Math.cos(h))+Math.PI;return{elevation:c,azimuth:(v%(2*Math.PI)+2*Math.PI)%(2*Math.PI)}}function Dt(t){let e=(t-6)/12;return{elevation:Math.asin(Math.sin(e*Math.PI)*.72),azimuth:Math.PI/2+e*Math.PI}}function Ze(t){if(t instanceof Date)return Number.isNaN(t.getTime())?null:t;if(typeof t=="string"&&/\d{4}-\d{2}-\d{2}/.test(t)){let e=new Date(t);return Number.isNaN(e.getTime())?null:e}return null}function Rt(t){var o;if(typeof t=="number")return(t%24+24)%24;let e=Ze(t);if(e)return e.getHours()+e.getMinutes()/60+e.getSeconds()/3600;if(typeof t=="string"){let i=/^(\d{1,2})(?::(\d{2}))?/.exec(t.trim());if(i)return((Number(i[1])+Number((o=i[2])!=null?o:0)/60)%24+24)%24}return 12}var le={neutral:{label:"Neutral",exposure:0,contrast:1,knee:.8,bleach:0},flat:{label:"Flat",exposure:.15,contrast:.82,knee:.55,bleach:.25},punch:{label:"Punch",exposure:-.2,contrast:1.22,knee:.85,bleach:.1},filmic:{label:"Filmic",exposure:.1,contrast:1.08,knee:.42,bleach:.55},blown:{label:"Blown",exposure:.85,contrast:.95,knee:.7,bleach:.4}},ao=Object.keys(le);var ne=le.neutral;function we(t){return{exposure:t.exposure,contrast:t.contrast,knee:t.knee,bleach:t.bleach}}function Ot(t){var o,i,a,s,r,n;if(t==null)return we(ne);if(typeof t=="string")return we((o=le[t])!=null?o:ne);let e=t.id&&(i=le[t.id])!=null?i:ne;return we({exposure:(a=t.exposure)!=null?a:e.exposure,contrast:(s=t.contrast)!=null?s:e.contrast,knee:Math.min(.99,Math.max(.02,(r=t.knee)!=null?r:e.knee)),bleach:Math.min(1,Math.max(0,(n=t.bleach)!=null?n:e.bleach))})}var he={clear:{label:"Clear",cloudCover:0,windSpeed:2,visibility:45},fair:{label:"Fair",cloudCover:.22,windSpeed:3,visibility:35},summer:{label:"Summer sky",cloudCover:.38,windSpeed:3,visibility:25,convection:.7},overcast:{label:"Overcast",cloudCover:.82,windSpeed:5,visibility:15},fog:{label:"Fog",cloudCover:.75,windSpeed:1,visibility:.6},rain:{label:"Rain",cloudCover:.95,windSpeed:7,visibility:8,precipitation:8,thunder:.08},thunderstorm:{label:"Thunderstorm",cloudCover:.97,windSpeed:12,visibility:5,precipitation:25,thunder:1,convection:.5},snow:{label:"Snow",cloudCover:.9,windSpeed:3,visibility:4,precipitation:3,precipitationType:"snow"},typhoon:{label:"Typhoon",cloudCover:1,windSpeed:30,visibility:6,precipitation:40,thunder:.5}},oo=Object.keys(he);var C=t=>t<0?0:t>1?1:t;function Nt(t){return C(Math.pow(C(t/30),.55))}function Wt(t){return C(Math.pow(C(t/33),.8))}function Bt(t){return C(Math.pow(C(t/5),.6))}function Ut(t){return C(Math.pow(C((20-t)/20),2.6))}function Ht(t){var c,v,f,b,T,G,F,z,A,D,R;let e=typeof t=="string"?(c=he[t])!=null?c:he.clear:t!=null?t:{},o=(v=e.precipitation)!=null?v:0,i=e.precipitationType==="snow",a=i?0:Nt(o),s=i?Bt(o):0,r=Ut((f=e.visibility)!=null?f:30),n=C((b=e.convection)!=null?b:0),l,h;e.clouds!=null?(l=gt(e.clouds),h=wt(l)):(h=C((T=e.cloudCover)!=null?T:0),l=yt(h,Math.max(a,s),n,r));let u=vt(l.cumulonimbus);return{clouds:l,features:{anvil:C((F=(G=e.features)==null?void 0:G.anvil)!=null?F:u.anvil),velum:C((A=(z=e.features)==null?void 0:z.velum)!=null?A:u.velum)},cloudCover:h,rain:a,snow:s,wind:Wt((D=e.windSpeed)!=null?D:0),thunder:C((R=e.thunder)!=null?R:0),haze:r}}var Ve={yaw:Math.PI,pitch:.46,fov:.86},io=[{yaw:Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:-Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:0,pitch:Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:-Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:0,fov:Math.PI/2},{yaw:Math.PI,pitch:0,fov:Math.PI/2}],Ge={time:12,weather:"clear"};function $e(t){var s,r;let e=(s=t.time)!=null?s:Ge.time,o=Rt(e),i=Ze(e),a=t.location&&i?It(i,t.location):Dt(o);return w(d({timeOfDay:o,sunElevation:a.elevation,sunAzimuth:a.azimuth},Ht((r=t.weather)!=null?r:Ge.weather)),{filter:Lt(t.filter),tone:Ot(t.tone),polarizer:Pt(t.polarizer),celestial:At(t.celestial)})}function je(t){return d(d({},Ve),t)}var qt=`
...
`,jt=4096,Zt=["u_res","u_time","u_cam","u_sun","u_cover","u_high","u_mid","u_low","u_rain","u_snow","u_wind","u_thunder","u_haze","u_cbFeat","u_windOff","u_evo","u_filtAmt","u_filtTint","u_filtSat","u_filtLift","u_p3","u_headroom","u_tone","u_pol","u_sky","u_radiant"],Vt=class{constructor(t,e={}){p(this,"canvas");p(this,"opts");p(this,"gl",null);p(this,"program",null);p(this,"buffer",null);p(this,"u",{});p(this,"lost",!1);p(this,"p3",!1);p(this,"onLost",t=>{t.preventDefault(),this.lost=!0});p(this,"onRestored",()=>{this.lost=!1,this.init()});this.canvas=t,this.opts=e,t.addEventListener("webglcontextlost",this.onLost),t.addEventListener("webglcontextrestored",this.onRestored),this.init()}get available(){return this.gl!==null}get colorSpace(){return this.p3?"display-p3":"srgb"}init(){let t=this.canvas.getContext("webgl",{alpha:!1,antialias:!1,depth:!1,stencil:!1,powerPreference:"low-power"});if(!t){this.gl=null;return}this.gl=t,this.p3=!1,this.opts.colorSpace!=="srgb"&&"drawingBufferColorSpace"in t&&(t.drawingBufferColorSpace="display-p3",this.p3=t.drawingBufferColorSpace==="display-p3");let e=(r,n)=>{let l=t.createShader(r);return l?(t.shaderSource(l,n),t.compileShader(l),t.getShaderParameter(l,t.COMPILE_STATUS)?l:(console.error("atmosphere shader compile error:",t.getShaderInfoLog(l)),t.deleteShader(l),null)):null},o=e(t.VERTEX_SHADER,qt),i=e(t.FRAGMENT_SHADER,$t);if(!o||!i){this.gl=null;return}let a=t.createProgram();if(!a){this.gl=null;return}if(t.attachShader(a,o),t.attachShader(a,i),t.linkProgram(a),t.deleteShader(o),t.deleteShader(i),!t.getProgramParameter(a,t.LINK_STATUS)){console.error("atmosphere shader link error:",t.getProgramInfoLog(a)),this.gl=null;return}this.program=a,t.useProgram(a),this.buffer=t.createBuffer(),t.bindBuffer(t.ARRAY_BUFFER,this.buffer),t.bufferData(t.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),t.STATIC_DRAW);let s=t.getAttribLocation(a,"a_pos");t.enableVertexAttribArray(s),t.vertexAttribPointer(s,2,t.FLOAT,!1,0,0),this.u={};for(let r of Zt)this.u[r]=t.getUniformLocation(a,r)}resize(t,e){var o;this.canvas.width=t,this.canvas.height=e,(o=this.gl)==null||o.viewport(0,0,t,e)}render(t,e,o=Ve,i=0,a=0){var c,v,f,b,T;let s=this.gl;if(!s||this.lost||!this.program)return;s.useProgram(this.program);let r=this.u;s.uniform2f(r.u_res,this.canvas.width,this.canvas.height),s.uniform1f(r.u_time,t%jt),s.uniform3f(r.u_cam,o.yaw,o.pitch,o.fov),s.uniform2f(r.u_sun,e.sunElevation,e.sunAzimuth);let n=e.clouds;s.uniform1f(r.u_cover,e.cloudCover),s.uniform3f(r.u_high,n.cirrus,n.cirrostratus,n.cirrocumulus),s.uniform3f(r.u_mid,n.altostratus,n.altocumulus,n.nimbostratus),s.uniform4f(r.u_low,n.stratus,n.stratocumulus,n.cumulus,n.cumulonimbus),s.uniform1f(r.u_rain,e.rain),s.uniform1f(r.u_snow,e.snow),s.uniform1f(r.u_wind,e.wind),s.uniform1f(r.u_thunder,e.thunder),s.uniform1f(r.u_haze,e.haze),s.uniform2f(r.u_cbFeat,e.features.anvil,e.features.velum),s.uniform1f(r.u_windOff,i),s.uniform1f(r.u_evo,a),s.uniform1f(r.u_filtAmt,e.filter.amount),s.uniform3f(r.u_filtTint,e.filter.tint[0],e.filter.tint[1],e.filter.tint[2]),s.uniform1f(r.u_filtSat,e.filter.saturation),s.uniform1f(r.u_filtLift,e.filter.lift),s.uniform1f(r.u_p3,this.p3?1:0),s.uniform1f(r.u_headroom,Math.max(1,(c=this.opts.headroom)!=null?c:1));let l=e.tone;s.uniform4f(r.u_tone,l.exposure,l.contrast,l.knee,l.bleach);let h=e.polarizer;s.uniform4f(r.u_pol,h.strength,h.angle,h.saturation,h.stopLoss);let u=e.celestial;s.uniform4f(r.u_sky,u.bortle,u.milkyWay,u.meteors,u.radiant?1:0),s.uniform2f(r.u_radiant,(f=(v=u.radiant)==null?void 0:v[0])!=null?f:0,(T=(b=u.radiant)==null?void 0:b[1])!=null?T:0),s.drawArrays(s.TRIANGLES,0,3)}dispose(t={}){var o;let e=this.gl;this.canvas.removeEventListener("webglcontextlost",this.onLost),this.canvas.removeEventListener("webglcontextrestored",this.onRestored),e&&(this.program&&e.deleteProgram(this.program),this.buffer&&e.deleteBuffer(this.buffer),t.loseContext&&((o=e.getExtension("WEBGL_lose_context"))==null||o.loseContext())),this.gl=null,this.program=null,this.buffer=null}},Yt=()=>Math.min(typeof devicePixelRatio=="number"?devicePixelRatio:1,1.5)*.55,Ye=class{constructor(t,e={}){p(this,"canvas");p(this,"renderer");p(this,"animator");p(this,"opts");p(this,"target");p(this,"conditions");p(this,"cam");p(this,"raf",0);p(this,"observer",null);p(this,"startedAt",0);p(this,"last",0);p(this,"lastDraw",0);p(this,"wantRunning",!1);p(this,"motionQuery",null);p(this,"onMotionChange",()=>{this.wantRunning&&(this.reducedMotion?(this.stopLoop(),this.jump()):this.startLoop())});this.canvas=t,this.opts=e,this.conditions={time:e.time,location:e.location,weather:e.weather,filter:e.filter,tone:e.tone,polarizer:e.polarizer,celestial:e.celestial,camera:e.camera},this.target=$e(this.conditions),this.cam=je(e.camera),this.renderer=new Vt(t,{colorSpace:e.colorSpace}),this.animator=new _t(this.target,e.animator),this.resize(),typeof ResizeObserver!="undefined"&&(this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(t)),e.respectReducedMotion!==!1&&typeof matchMedia!="undefined"&&(this.motionQuery=matchMedia("(prefers-reduced-motion: reduce)"),this.motionQuery.addEventListener("change",this.onMotionChange)),e.autoStart!==!1&&this.start()}get reducedMotion(){var t,e;return(e=(t=this.motionQuery)==null?void 0:t.matches)!=null?e:!1}get available(){return this.renderer.available}get colorSpace(){return this.renderer.colorSpace}get state(){let t=this.animator.current;return w(d({},t),{clouds:d({},t.clouds),features:d({},t.features),filter:w(d({},t.filter),{tint:[...t.filter.tint]}),tone:d({},t.tone),polarizer:d({},t.polarizer),celestial:w(d({},t.celestial),{radiant:t.celestial.radiant?[t.celestial.radiant[0],t.celestial.radiant[1]]:null})})}get camera(){return this.cam}set(t){this.applyConditions(t),this.wantRunning&&!this.raf&&this.reducedMotion&&(this.animator.jump(this.target),this.draw(performance.now()))}jump(t={}){this.applyConditions(t),this.animator.jump(this.target),this.draw(performance.now())}applyConditions(t){this.conditions=d(d({},this.conditions),t),this.target=$e(this.conditions),t.camera&&(this.cam=je(d(d({},this.cam),t.camera)))}resize(){var i;let t=(i=this.opts.resolutionScale)!=null?i:Yt(),e=this.canvas.clientWidth||this.canvas.width,o=this.canvas.clientHeight||this.canvas.height;this.renderer.resize(Math.max(1,Math.round(e*t)),Math.max(1,Math.round(o*t)))}start(){if(this.available){if(this.wantRunning=!0,this.reducedMotion){this.jump();return}this.startLoop()}}stop(){this.wantRunning=!1,this.stopLoop()}startLoop(){if(this.raf)return;let t=performance.now();this.startedAt||(this.startedAt=t),this.last=t;let e=o=>{var s;this.raf=requestAnimationFrame(e);let i=1e3/((s=this.opts.fps)!=null?s:30),a=o-this.lastDraw;a<i||(this.lastDraw=o-a%i,this.draw(o))};this.raf=requestAnimationFrame(e)}stopLoop(){this.raf&&(cancelAnimationFrame(this.raf),this.raf=0)}draw(t){this.startedAt||(this.startedAt=t,this.last=t);let e=Math.min(.2,(t-this.last)/1e3);this.last=t,this.animator.step(this.target,e),this.reducedMotion&&(this.animator.current.celestial.meteors=0),this.renderer.render((t-this.startedAt)/1e3,this.animator.current,this.cam,this.animator.wind,this.animator.evolution)}dispose(t={}){var e,o;this.stop(),(e=this.observer)==null||e.disconnect(),this.observer=null,(o=this.motionQuery)==null||o.removeEventListener("change",this.onMotionChange),this.motionQuery=null,this.renderer.dispose(t)}};function Se(t,e){let o={};for(let i of Object.keys(t))o[i]=e(t[i]);return o}var so={en:Se(he,t=>t.label),ja:{clear:"\u5FEB\u6674",fair:"\u6674\u308C",summer:"\u590F\u7A7A",overcast:"\u66C7\u308A",fog:"\u9727",rain:"\u96E8",thunderstorm:"\u96F7\u96E8",snow:"\u96EA",typhoon:"\u53F0\u98A8"}},ro={en:Se(W,t=>t.label),ja:{none:"\u306A\u3057",sepia:"\u30BB\u30D4\u30A2",mono:"\u30E2\u30CE\u30AF\u30ED\u30FC\u30E0",faded:"\u892A\u8272",cyanotype:"\u9752\u306E\u8A18\u61B6",gold:"\u9EC4\u660F",ash:"\u7070"}},no={en:Se(ke,t=>({label:t.label,alias:t.alias})),ja:{cirrus:{label:"\u5DFB\u96F2",alias:"\u3059\u3058\u96F2"},cirrostratus:{label:"\u5DFB\u5C64\u96F2",alias:"\u3046\u3059\u96F2"},cirrocumulus:{label:"\u5DFB\u7A4D\u96F2",alias:"\u3046\u308D\u3053\u96F2\u30FB\u3044\u308F\u3057\u96F2"},altostratus:{label:"\u9AD8\u5C64\u96F2",alias:"\u304A\u307C\u308D\u96F2"},altocumulus:{label:"\u9AD8\u7A4D\u96F2",alias:"\u3072\u3064\u3058\u96F2"},nimbostratus:{label:"\u4E71\u5C64\u96F2",alias:"\u3042\u307E\u96F2"},stratus:{label:"\u5C64\u96F2",alias:"\u304D\u308A\u96F2"},stratocumulus:{label:"\u5C64\u7A4D\u96F2",alias:"\u304F\u3082\u308A\u96F2"},cumulus:{label:"\u7A4D\u96F2",alias:"\u308F\u305F\u96F2"},cumulonimbus:{label:"\u7A4D\u4E71\u96F2",alias:"\u5165\u9053\u96F2"}}};var Kt={latitude:37.8991768,longitude:-122.4949685},m={0:{cloudCover:0,precipitation:0,windSpeed:2,visibility:45,thunder:0},1:{cloudCover:.22,precipitation:0,windSpeed:3,visibility:35,thunder:0},2:{cloudCover:.35,precipitation:0,windSpeed:4,visibility:30,thunder:0},3:{cloudCover:.92,precipitation:0,windSpeed:5,visibility:18,thunder:0},45:{cloudCover:.75,precipitation:0,windSpeed:1,visibility:.6,thunder:0},48:{cloudCover:.78,precipitation:0,windSpeed:1,visibility:.4,thunder:0},51:{cloudCover:.62,precipitation:.2,windSpeed:2,visibility:10,thunder:0,precipitationType:"rain"},53:{cloudCover:.68,precipitation:.5,windSpeed:3,visibility:8,thunder:0,precipitationType:"rain"},55:{cloudCover:.75,precipitation:1.2,windSpeed:4,visibility:6,thunder:0,precipitationType:"rain"},56:{cloudCover:.7,precipitation:.3,windSpeed:3,visibility:3,thunder:0,precipitationType:"rain"},57:{cloudCover:.76,precipitation:1,windSpeed:4,visibility:2,thunder:0,precipitationType:"rain"},61:{cloudCover:.78,precipitation:2,windSpeed:4,visibility:10,thunder:0,precipitationType:"rain"},63:{cloudCover:.85,precipitation:5,windSpeed:6,visibility:8,thunder:0,precipitationType:"rain"},65:{cloudCover:.92,precipitation:18,windSpeed:8,visibility:4,thunder:0,precipitationType:"rain"},66:{cloudCover:.85,precipitation:2,windSpeed:5,visibility:2,thunder:0,precipitationType:"rain"},67:{cloudCover:.9,precipitation:10,windSpeed:7,visibility:1,thunder:0,precipitationType:"rain"},71:{cloudCover:.78,precipitation:.8,windSpeed:4,visibility:3,thunder:0,precipitationType:"snow"},73:{cloudCover:.85,precipitation:2.5,windSpeed:5,visibility:2,thunder:0,precipitationType:"snow"},75:{cloudCover:.92,precipitation:8,windSpeed:7,visibility:1,thunder:0,precipitationType:"snow"},77:{cloudCover:.7,precipitation:.5,windSpeed:5,visibility:2,thunder:0,precipitationType:"snow"},80:{cloudCover:.55,precipitation:2.5,windSpeed:5,visibility:12,thunder:0,precipitationType:"rain",convection:.55},81:{cloudCover:.65,precipitation:6,windSpeed:6,visibility:8,thunder:0,precipitationType:"rain",convection:.7},82:{cloudCover:.75,precipitation:25,windSpeed:8,visibility:4,thunder:0,precipitationType:"rain",convection:.85},85:{cloudCover:.55,precipitation:1,windSpeed:5,visibility:4,thunder:0,precipitationType:"snow",convection:.45},86:{cloudCover:.7,precipitation:6,windSpeed:7,visibility:2,thunder:0,precipitationType:"snow",convection:.7},95:{cloudCover:.96,precipitation:15,windSpeed:10,visibility:5,thunder:1,precipitationType:"rain",convection:.75},96:{cloudCover:.97,precipitation:25,windSpeed:12,visibility:4,thunder:1,precipitationType:"rain",convection:.85},99:{cloudCover:.99,precipitation:45,windSpeed:15,visibility:3,thunder:1,precipitationType:"rain",convection:.95}},Jt={"clear-day":w(d({},m[0]),{cloudCover:.03,windSpeed:3}),"clear-night":w(d({},m[0]),{overlay:"clear-night",cloudCover:0,windSpeed:2}),"mostly-clear-day":w(d({},m[1]),{cloudCover:.15,windSpeed:3}),"mostly-clear-night":w(d({},m[1]),{overlay:"clear-night",cloudCover:.1,windSpeed:2}),"partly-cloudy-day":m[2],"partly-cloudy-night":m[2],"mostly-cloudy-day":w(d({},m[3]),{cloudCover:.78}),"mostly-cloudy-night":w(d({},m[3]),{cloudCover:.78}),overcast:m[3],fog:w(d({},m[45]),{overlay:"fog-bank"}),"drizzle-light":m[51],drizzle:m[53],"drizzle-heavy":m[55],"rain-light":m[61],rain:m[63],"rain-heavy":m[65],"freezing-rain":w(d({},m[67]),{overlay:"ice"}),"snow-light":m[71],snow:m[73],"snow-heavy":m[75],"snow-grains":m[77],"rain-showers-light":m[80],"rain-showers":m[81],"rain-showers-heavy":m[82],"snow-showers-light":m[85],"snow-showers":m[86],thunderstorm:m[95],"thunderstorm-hail":w(d({},m[96]),{overlay:"hail"}),"thunderstorm-hail-heavy":w(d({},m[99]),{overlay:"hail"})},Qt={tornado:{cloudCover:1,precipitation:60,windSpeed:75,visibility:.2,thunder:1,convection:1,precipitationType:"rain",overlay:"tornado",label:"Tornado"},waterspout:{cloudCover:.98,precipitation:45,windSpeed:55,visibility:.5,thunder:1,convection:.95,precipitationType:"rain",overlay:"tornado",label:"Waterspout"},hurricane:{cloudCover:1,precipitation:90,windSpeed:60,visibility:.2,thunder:.9,convection:1,precipitationType:"rain",overlay:"hurricane",label:"Hurricane"},"tropical-storm":{cloudCover:1,precipitation:45,windSpeed:35,visibility:.5,thunder:.7,convection:.8,precipitationType:"rain",overlay:"rain",label:"Tropical Storm"},derecho:{cloudCover:1,precipitation:40,windSpeed:50,visibility:1,thunder:1,convection:.95,precipitationType:"rain",overlay:"lightning",label:"Derecho"},squall:{cloudCover:.95,precipitation:25,windSpeed:30,visibility:2,thunder:.8,convection:.7,precipitationType:"rain",overlay:"rain",label:"Squall"},blizzard:{cloudCover:1,precipitation:20,windSpeed:28,visibility:.1,thunder:0,convection:0,precipitationType:"snow",overlay:"snow-blizzard",label:"Blizzard"},"ice-storm":{cloudCover:.95,precipitation:18,windSpeed:12,visibility:.5,thunder:0,convection:0,precipitationType:"rain",overlay:"ice",label:"Ice Storm"},sandstorm:{cloudCover:.95,precipitation:0,windSpeed:25,visibility:.05,thunder:0,convection:0,overlay:"sand",label:"Sandstorm"},"dust-storm":{cloudCover:.92,precipitation:0,windSpeed:20,visibility:.1,thunder:0,convection:0,overlay:"dust",label:"Dust Storm"},"volcanic-ash":{cloudCover:.95,precipitation:0,windSpeed:8,visibility:.3,thunder:0,convection:0,overlay:"ash",label:"Volcanic Ash"},"wildfire-smoke":{cloudCover:.9,precipitation:0,windSpeed:6,visibility:1,thunder:0,convection:0,overlay:"smoke",label:"Wildfire Smoke"},"forest-fire":{cloudCover:.88,precipitation:0,windSpeed:8,visibility:.5,thunder:0,convection:0,overlay:"fire",label:"Forest Fire"},smoke:{cloudCover:.8,precipitation:0,windSpeed:4,visibility:1.5,thunder:0,convection:0,overlay:"smoke",label:"Smoke"},ash:{cloudCover:.85,precipitation:0,windSpeed:5,visibility:.4,thunder:0,convection:0,overlay:"ash",label:"Ash"},haze:{cloudCover:.35,precipitation:0,windSpeed:3,visibility:5,thunder:0,convection:0,overlay:"haze",label:"Haze"},smog:{cloudCover:.55,precipitation:0,windSpeed:2,visibility:2,thunder:0,convection:0,overlay:"smoke",label:"Smog"},"acid-rain":{cloudCover:.8,precipitation:12,windSpeed:6,visibility:5,thunder:.2,convection:0,precipitationType:"rain",overlay:"acid-rain",label:"Acid Rain"},"flash-flood":{cloudCover:.85,precipitation:50,windSpeed:10,visibility:2,thunder:.4,convection:.5,precipitationType:"rain",overlay:"rain",label:"Flash Flood"},aurora:{cloudCover:.2,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"aurora",label:"Aurora"},eclipse:{cloudCover:.1,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"eclipse",label:"Solar Eclipse"},"eclipse-lunar":{cloudCover:.05,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"eclipse-lunar",label:"Lunar Eclipse"},"blood-moon":{cloudCover:.05,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"blood-moon",label:"Blood Moon"},rainbow:{cloudCover:.3,precipitation:0,windSpeed:4,visibility:35,thunder:0,convection:0,overlay:"rainbow",label:"Rainbow"},"meteor-shower":{cloudCover:.15,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"meteors",label:"Meteor Shower"},"meteor-impact":{cloudCover:.25,precipitation:0,windSpeed:6,visibility:30,thunder:.6,convection:0,overlay:"meteor-impact",label:"Meteor Impact"},"asteroid-impact":{cloudCover:.6,precipitation:0,windSpeed:20,visibility:10,thunder:1,convection:.5,overlay:"meteor-impact",label:"Asteroid Impact"},"close-approach":{cloudCover:.1,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"close-approach",label:"Asteroid Close Approach"},supermoon:{cloudCover:.05,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"supermoon",label:"Supermoon"},earthquake:{cloudCover:.5,precipitation:0,windSpeed:4,visibility:20,thunder:0,convection:0,overlay:"earthquake",label:"Earthquake"},tsunami:{cloudCover:.85,precipitation:0,windSpeed:15,visibility:2,thunder:.2,convection:0,overlay:"tsunami",label:"Tsunami"},"volcanic-eruption":{cloudCover:1,precipitation:0,windSpeed:12,visibility:.05,thunder:.8,convection:.9,overlay:"volcano",label:"Volcanic Eruption"},landslide:{cloudCover:.65,precipitation:5,windSpeed:8,visibility:2,thunder:0,convection:0,overlay:"landslide",label:"Landslide"},mudslide:{cloudCover:.7,precipitation:15,windSpeed:10,visibility:1,thunder:0,convection:0,overlay:"mudslide",label:"Mudslide"},avalanche:{cloudCover:.8,precipitation:8,windSpeed:12,visibility:.5,thunder:0,convection:0,precipitationType:"snow",overlay:"avalanche",label:"Avalanche"},rockfall:{cloudCover:.4,precipitation:0,windSpeed:6,visibility:5,thunder:0,convection:0,overlay:"rockfall",label:"Rockfall"},"geological-event":{cloudCover:.55,precipitation:0,windSpeed:5,visibility:10,thunder:0,convection:0,overlay:"earthquake",label:"Geological Event"},apocalypse:{cloudCover:1,precipitation:80,windSpeed:40,visibility:.05,thunder:1,convection:1,precipitationType:"rain",overlay:"tornado",label:"Apocalypse"}},Xt=d(d({},Jt),Qt),Me=class{constructor(e){this.canvas=document.createElement("canvas"),this.canvas.id="fx-overlay",this.canvas.style.cssText="position:absolute;inset:0;width:100%;height:100%;pointer-events:none;z-index:1",e.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),this.effect=null,this.t=0,this.w=0,this.h=0,this.particles=[],this.lastTick=0,this.dpr=Math.min(typeof window!="undefined"&&window.devicePixelRatio||1,1.5)*.5,this.fps=20,this.resize(),window.addEventListener("resize",()=>this.resize()),this._tick()}resize(){this.w=this.canvas.clientWidth||window.innerWidth,this.h=this.canvas.clientHeight||window.innerHeight,this.canvas.width=Math.floor(this.w*this.dpr),this.canvas.height=Math.floor(this.h*this.dpr),this.ctx.setTransform(this.dpr,0,0,this.dpr,0,0)}setEffect(e){if(this.effect=e||null,this.t=0,this.particles=[],e&&["clear-day","clear-night","sand","dust","ash","smoke","haze","snow-blizzard","volcano","landslide","mudslide","avalanche","rockfall","earthquake","tsunami","acid-rain","fire","hail"].includes(e)){let i={"clear-day":35,"clear-night":60,sand:300,dust:250,ash:200,smoke:150,haze:100,"snow-blizzard":400,volcano:300,landslide:250,mudslide:300,avalanche:400,rockfall:200,earthquake:250,tsunami:0,"acid-rain":120,fire:150,hail:100}[e]||300;for(let a=0;a<i;a++)this.particles.push(this._newParticle(e))}let o=document.querySelector(".ww");o&&(o.style.transition="none",o.style.transform="")}_rand(e,o){return e+Math.random()*(o-e)}_newParticle(e){let o=this.w,i=this.h;switch(e){case"clear-day":return{x:this._rand(0,o),y:this._rand(0,i),r:this._rand(.8,2.2),v:this._rand(.2,.6),vy:this._rand(-.1,.1),op:this._rand(.15,.35),life:this._rand(120,240),type:"clear-day"};case"clear-night":return{x:this._rand(0,o),y:this._rand(0,i*.6),r:this._rand(.6,1.6),v:this._rand(.05,.15),vy:this._rand(-.03,.03),op:this._rand(.25,.7),life:this._rand(80,180),twinkle:this._rand(.5,1.2),phase:this._rand(0,Math.PI*2),type:"clear-night"};case"sand":case"dust":return{x:this._rand(-o,o),y:this._rand(0,i),r:this._rand(1,3),v:this._rand(12,25),vy:this._rand(-1,1),op:this._rand(.4,.9)};case"ash":return{x:this._rand(0,o),y:this._rand(-i,0),r:this._rand(1,4),v:this._rand(2,6),vy:this._rand(2,8),op:this._rand(.3,.8)};case"smoke":case"haze":return{x:this._rand(-o,o),y:this._rand(0,i),r:this._rand(20,80),v:this._rand(4,10),vy:this._rand(-.5,.5),op:this._rand(.05,.2),grow:this._rand(.2,.8)};case"snow-blizzard":return{x:this._rand(0,o),y:this._rand(-i,i),r:this._rand(1,3),v:this._rand(18,35),vy:this._rand(4,10),op:this._rand(.5,.95)};case"volcano":return{x:this._rand(o*.45,o*.55),y:this._rand(i*.55,i*.75),r:this._rand(2,6),v:this._rand(-2,6),vy:this._rand(-6,-1),op:this._rand(.4,.9),life:this._rand(20,80)};case"landslide":case"mudslide":return{x:this._rand(-100,o),y:this._rand(-50,i*.6),r:this._rand(3,10),v:this._rand(3,10),vy:this._rand(2,8),op:this._rand(.5,.9)};case"avalanche":return{x:this._rand(0,o),y:this._rand(-i,0),r:this._rand(2,6),v:this._rand(10,25),vy:this._rand(8,18),op:this._rand(.5,.95)};case"rockfall":return{x:this._rand(-50,o+50),y:this._rand(-i*.5,0),r:this._rand(3,12),v:this._rand(-2,4),vy:this._rand(4,14),op:this._rand(.5,.9),rot:this._rand(0,Math.PI*2),rotv:this._rand(-.2,.2)};case"earthquake":return{x:this._rand(0,o),y:this._rand(i*.6,i),r:this._rand(1,4),v:this._rand(-1,1),vy:this._rand(-1,-3),op:this._rand(.3,.7),life:this._rand(10,50)};case"acid-rain":return{x:this._rand(0,o),y:this._rand(0,i),len:this._rand(14,28),v:this._rand(9,16),op:this._rand(.35,.75)};case"hail":return{x:this._rand(0,o),y:this._rand(-i,0),r:this._rand(2,6),v:this._rand(6,16),vy:this._rand(18,32),op:this._rand(.55,.9),rot:this._rand(0,Math.PI*2),rotv:this._rand(-.3,.3)};case"fire":return{x:this._rand(0,o),y:this._rand(i*.55,i),r:this._rand(2,7),v:this._rand(-1,2),vy:this._rand(-3,-.5),op:this._rand(.4,.9),life:this._rand(20,70)};default:return{}}}_tick(e){let o=e||performance.now(),i=1e3/this.fps;if(o-this.lastTick<i){requestAnimationFrame(n=>this._tick(n));return}this.lastTick=o-(o-this.lastTick)%i,this.t++;let{ctx:a,w:s,h:r}=this;a.clearRect(0,0,s,r),this.effect==="tornado"?this._drawTornado(a,s,r):this.effect==="hurricane"?this._drawHurricane(a,s,r):this.effect==="lightning"?this._drawLightningBolts(a,s,r):this.effect==="hail"?this._drawHail(a,s,r):this.effect==="ice"?this._drawIce(a,s,r):this.effect==="aurora"?this._drawAurora(a,s,r):this.effect==="eclipse"?this._drawEclipse(a,s,r):this.effect==="eclipse-lunar"?this._drawLunarEclipse(a,s,r):this.effect==="blood-moon"?this._drawBloodMoon(a,s,r):this.effect==="supermoon"?this._drawSupermoon(a,s,r):this.effect==="close-approach"?this._drawCloseApproach(a,s,r):this.effect==="rainbow"?this._drawRainbow(a,s,r):this.effect==="meteors"?this._drawMeteors(a,s,r):this.effect==="meteor-impact"?this._drawMeteorImpact(a,s,r):this.effect==="earthquake"?this._drawEarthquake(a,s,r):this.effect==="tsunami"?this._drawTsunami(a,s,r):this.effect==="volcano"?this._drawVolcano(a,s,r):this.effect==="landslide"?this._drawLandslide(a,s,r):this.effect==="mudslide"?this._drawMudslide(a,s,r):this.effect==="avalanche"?this._drawAvalanche(a,s,r):this.effect==="rockfall"?this._drawRockfall(a,s,r):this.effect==="acid-rain"?this._drawAcidRain(a,s,r):this.effect==="fire"?this._drawFire(a,s,r):this.effect==="fog-bank"?this._drawFogBank(a,s,r):this.effect==="clear-day"?this._drawClearDay(a,s,r):this.effect==="clear-night"?this._drawClearNight(a,s,r):this.particles.length&&this._drawParticles(a,s,r),requestAnimationFrame(n=>this._tick(n))}_drawTornado(e,o,i){let a=o*.5,s=i*.95,r=this.t*.04;e.save(),e.globalCompositeOperation="source-over";let n=e.createLinearGradient(a,s,a,0);n.addColorStop(0,"rgba(20,20,25,0.9)"),n.addColorStop(.45,"rgba(60,60,70,0.5)"),n.addColorStop(1,"rgba(120,120,130,0)"),e.fillStyle=n,e.beginPath();for(let l=i;l>=0;l-=4){let h=1-l/i,u=140*(1-h)+12*h,c=Math.sin(r+l*.03)*(10*(1-h)+2);e.lineTo(a+c+u*.5,l)}for(let l=0;l<=i;l+=4){let h=l/i,u=140*h+12*(1-h),c=Math.sin(r+l*.03)*(10*h+2);e.lineTo(a+c-u*.5,l)}e.closePath(),e.fill(),e.globalCompositeOperation="screen";for(let l=0;l<40;l++){let h=r+l*.35,u=80+Math.sin(this.t*.1+l)*20,c=a+Math.cos(h)*u,v=s-20+Math.sin(h)*10;e.fillStyle=`rgba(180,170,160,${.3+Math.random()*.3})`,e.beginPath(),e.arc(c,v,1.5+Math.random()*2,0,Math.PI*2),e.fill()}e.restore()}_drawHurricane(e,o,i){let a=o*.5,s=i*.45,r=this.t*.015;e.save(),e.globalCompositeOperation="source-over";for(let l=0;l<4;l++){let h=r+l*(Math.PI/2);e.strokeStyle="rgba(60,60,70,0.35)",e.lineWidth=18,e.beginPath();for(let u=40;u<Math.max(o,i)*.8;u+=8){let c=h+u*.018,v=a+Math.cos(c)*u,f=s+Math.sin(c)*u;u===40?e.moveTo(v,f):e.lineTo(v,f)}e.stroke()}let n=e.createRadialGradient(a,s,5,a,s,45);n.addColorStop(0,"rgba(200,190,170,0.9)"),n.addColorStop(.6,"rgba(90,85,80,0.6)"),n.addColorStop(1,"rgba(40,40,45,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,45,0,Math.PI*2),e.fill(),e.restore()}_drawLightningBolts(e,o,i){if(Math.random()>.03)return;e.save(),e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,250,220,0.95)",e.lineWidth=2+Math.random()*3,e.shadowColor="#fff8c5",e.shadowBlur=20;let a=this._rand(o*.2,o*.8);e.beginPath(),e.moveTo(a,0);let s=a,r=0;for(;r<i*.6;)s+=this._rand(-30,30),r+=this._rand(15,40),e.lineTo(s,r);e.stroke(),e.restore()}_drawIce(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let a=0;a<30;a++){let s=(this.t*.5+a*137)%(o+60)-30,r=a*79%(i+40)-20,n=8+a%7;e.strokeStyle=`rgba(200,230,255,${.15+a%5*.05})`,e.lineWidth=1,e.beginPath();for(let l=0;l<6;l++){let h=l*Math.PI/3+this.t*.02+a,u=n*.5,c=n;e.moveTo(s+Math.cos(h)*u,r+Math.sin(h)*u),e.lineTo(s+Math.cos(h)*c,r+Math.sin(h)*c)}e.stroke()}e.restore()}_drawHail(e,o,i){e.save(),e.globalCompositeOperation="source-over",e.shadowBlur=2,e.shadowColor="rgba(160, 190, 220, 0.35)";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,a.rot+=a.rotv,a.y>i+a.r&&(a.y=this._rand(-30,-10),a.x=this._rand(0,o),a.v=this._rand(6,16),a.vy=this._rand(18,32)),e.globalAlpha=a.op,e.fillStyle="#e8f0f8",e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.restore()}_drawAurora(e,o,i){e.save(),e.globalCompositeOperation="screen";let a=[{hue:140,baseY:.16,amp:55,speed:.015,thickness:110},{hue:165,baseY:.26,amp:70,speed:.011,thickness:130},{hue:195,baseY:.36,amp:50,speed:.02,thickness:90}];for(let s of a){let r=i*s.baseY,n=10;for(let l=0;l<=o;l+=n){let h=r+Math.sin(l*.012+this.t*s.speed)*s.amp+Math.sin(l*.004+this.t*s.speed*.6)*s.amp*.6,u=.55+.45*Math.sin(l*.05+this.t*.08),c=e.createLinearGradient(0,h-s.thickness*.5,0,h+s.thickness*.5);c.addColorStop(0,`hsla(${s.hue}, 85%, 65%, 0)`),c.addColorStop(.5,`hsla(${s.hue}, 85%, 65%, ${.22*u})`),c.addColorStop(1,`hsla(${s.hue}, 85%, 65%, 0)`),e.fillStyle=c,e.fillRect(l,h-s.thickness*.5,n+2,s.thickness)}}e.restore()}_drawEclipse(e,o,i){let a=o*.5,s=i*.25,r=Math.min(o,i)*.12;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.9,a,s,r*1.6);n.addColorStop(0,"rgba(255,240,200,0.9)"),n.addColorStop(.5,"rgba(255,220,120,0.4)"),n.addColorStop(1,"rgba(255,200,80,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*1.6,0,Math.PI*2),e.fill(),e.fillStyle="rgba(10,10,12,0.85)",e.beginPath(),e.arc(a+r*.15,s,r,0,Math.PI*2),e.fill(),e.restore()}_drawLunarEclipse(e,o,i){let a=o*.5,s=i*.28,r=Math.min(o,i)*.11;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.8,a,s,r*2.2);n.addColorStop(0,"rgba(226,232,240,0.35)"),n.addColorStop(1,"rgba(226,232,240,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*2.2,0,Math.PI*2),e.fill(),e.fillStyle="#e8edf4",e.beginPath(),e.arc(a,s,r,0,Math.PI*2),e.fill();let l=.5+.5*Math.sin(this.t*.01);e.globalAlpha=.82,e.fillStyle="#1e293b",e.beginPath(),e.arc(a+r*(.55+.25*l),s-r*.1,r*1.05,0,Math.PI*2),e.fill(),e.restore()}_drawBloodMoon(e,o,i){let a=o*.5,s=i*.28,r=Math.min(o,i)*.11;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.7,a,s,r*2.6);n.addColorStop(0,"rgba(220,38,38,0.30)"),n.addColorStop(1,"rgba(220,38,38,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*2.6,0,Math.PI*2),e.fill();let l=e.createRadialGradient(a-r*.3,s-r*.3,r*.1,a,s,r);l.addColorStop(0,"#c2410c"),l.addColorStop(.55,"#9a3412"),l.addColorStop(1,"#5c1a0a"),e.fillStyle=l,e.beginPath(),e.arc(a,s,r,0,Math.PI*2),e.fill(),e.globalAlpha=.35,e.fillStyle="#7c2d12",e.beginPath(),e.arc(a-r*.25,s-r*.15,r*.28,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(a+r*.3,s+r*.3,r*.2,0,Math.PI*2),e.fill(),e.restore()}_drawSupermoon(e,o,i){let a=o*.5,s=i*.3,r=Math.min(o,i)*.16;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.9,a,s,r*2.4);n.addColorStop(0,"rgba(255,250,230,0.45)"),n.addColorStop(1,"rgba(255,250,230,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*2.4,0,Math.PI*2),e.fill();let l=e.createRadialGradient(a-r*.3,s-r*.3,r*.1,a,s,r);l.addColorStop(0,"#fffdf2"),l.addColorStop(1,"#f3ecd0"),e.fillStyle=l,e.beginPath(),e.arc(a,s,r,0,Math.PI*2),e.fill(),e.globalAlpha=.18,e.fillStyle="#c9c0a0",e.beginPath(),e.arc(a-r*.28,s-r*.2,r*.22,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(a+r*.32,s+r*.15,r*.16,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(a+r*.05,s-r*.4,r*.12,0,Math.PI*2),e.fill(),e.restore()}_drawCloseApproach(e,o,i){let a=o*(.15+.7*(this.t*.0025%1)),s=i*(.15+.1*Math.sin(this.t*.01));e.save(),e.globalCompositeOperation="screen";let r=e.createRadialGradient(a,s,0,a,s,5);r.addColorStop(0,"rgba(226,232,240,0.9)"),r.addColorStop(1,"rgba(226,232,240,0)"),e.fillStyle=r,e.beginPath(),e.arc(a,s,5,0,Math.PI*2),e.fill(),e.fillStyle="#e2e8f0",e.beginPath(),e.arc(a,s,1.3,0,Math.PI*2),e.fill(),e.restore()}_drawRainbow(e,o,i){let a=o*.5,s=i*.95,r=Math.min(o,i)*.75;e.save(),e.globalCompositeOperation="screen";let n=["#ff0000","#ff7f00","#ffff00","#00ff00","#0000ff","#4b0082","#9400d3"];for(let l=0;l<n.length;l++){let h=r-l*8;e.strokeStyle=n[l],e.lineWidth=7,e.globalAlpha=.55,e.beginPath(),e.arc(a,s,h,Math.PI,0),e.stroke()}e.restore()}_drawFogBank(e,o,i){e.save(),e.globalCompositeOperation="source-over";let a=5;for(let r=0;r<a;r++){let n=i*(.25+r*.16),l=Math.sin(this.t*.006+r*1.7)*40,h=Math.sin(this.t*.01+r)*12,u=e.createLinearGradient(0,n-60+h,0,n+60+h);u.addColorStop(0,"rgba(235,238,242,0)"),u.addColorStop(.5,`rgba(235,238,242,${.22-r*.02})`),u.addColorStop(1,"rgba(235,238,242,0)"),e.fillStyle=u,e.fillRect(l-100,0,o+200,i)}let s=e.createLinearGradient(0,0,0,i);s.addColorStop(0,"rgba(240,242,246,0.06)"),s.addColorStop(1,"rgba(240,242,246,0.28)"),e.fillStyle=s,e.fillRect(0,0,o,i),e.restore()}_drawParticles(e,o,i){let a=this.effect;if(e.save(),a==="sand"||a==="dust"){e.fillStyle=a==="sand"?"rgba(194,160,120,":"rgba(160,150,130,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.x>o+50&&(s.x=-50,s.y=this._rand(0,i)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.globalAlpha=a==="sand"?.25:.18,e.fillStyle=a==="sand"?"#c2a078":"#a69b8a",e.fillRect(0,0,o,i)}else if(a==="ash"){e.fillStyle="rgba(60,55,55,";for(let s of this.particles)s.x+=Math.sin(this.t*.02+s.y*.01)*.5,s.y+=s.vy,s.y>i+10&&(s.y=-10,s.x=this._rand(0,o)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.globalAlpha=.15,e.fillStyle="#6b2e1d",e.fillRect(0,0,o,i)}else if(a==="smoke"||a==="haze")for(let s of this.particles){s.x+=s.v,s.y+=s.vy,s.r+=s.grow,s.x>o+s.r&&(s.x=-s.r,s.y=this._rand(0,i),s.r=this._rand(20,80));let r=a==="smoke"?"80,70,60":"120,110,100";e.fillStyle=`rgba(${r},${s.op})`,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill()}else if(a==="snow-blizzard"){e.fillStyle="rgba(255,250,240,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.x>o+20&&(s.x=-20,s.y=this._rand(0,i)),s.y>i+20&&(s.y=-20,s.x=this._rand(0,o)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill()}e.restore()}_drawMeteors(e,o,i){e.save(),e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,255,240,0.9)",e.lineWidth=2,e.shadowColor="#fff",e.shadowBlur=6;for(let a=0;a<5;a++){if(Math.random()>.25)continue;let s=this._rand(o*.1,o*.9),r=this._rand(0,i*.4),n=this._rand(40,120),l=this._rand(Math.PI*.2,Math.PI*.8);e.beginPath(),e.moveTo(s,r),e.lineTo(s+Math.cos(l)*n,r+Math.sin(l)*n),e.stroke()}e.restore()}_drawMeteorImpact(e,o,i){e.save();let a=this.t;a<40&&(e.globalCompositeOperation="screen",e.fillStyle=`rgba(255,240,200,${Math.max(0,.9-a/40)})`,e.fillRect(0,0,o,i));let s=a*3%300;e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,220,160,0.4)",e.lineWidth=3,e.beginPath(),e.arc(o*.5,i*.3,s,0,Math.PI*2),e.stroke(),e.strokeStyle="rgba(255,160,60,0.85)",e.lineWidth=4,e.shadowColor="#ff8a00",e.shadowBlur=15;let r=o*.5+a*.4,n=i*.3+a*.9;e.beginPath(),e.moveTo(r,n),e.lineTo(r-40,n-90),e.stroke(),e.restore()}_drawEarthquake(e,o,i){let a=document.querySelector(".ww");if(a){let s=(Math.random()-.5)*6,r=(Math.random()-.5)*4;a.style.transform=`translate(${s}px, ${r}px)`}e.save(),e.fillStyle="rgba(120,110,100,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.life--,s.life<=0&&(s.x=this._rand(0,o),s.y=this._rand(i*.7,i),s.life=this._rand(10,50)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.strokeStyle="rgba(30,25,20,0.6)",e.lineWidth=2,e.beginPath(),e.moveTo(o*.2,i),e.lineTo(o*.35,i*.82),e.lineTo(o*.5,i*.88),e.lineTo(o*.8,i),e.stroke(),e.restore()}_drawTsunami(e,o,i){e.save(),e.globalCompositeOperation="source-over",e.fillStyle="rgba(10,25,40,0.35)",e.fillRect(0,0,o,i);let a=i*.55+Math.sin(this.t*.03)*20,s=e.createLinearGradient(0,i-a,0,i);s.addColorStop(0,"rgba(20,60,90,0.7)"),s.addColorStop(.6,"rgba(10,40,70,0.9)"),s.addColorStop(1,"rgba(5,25,50,0.95)"),e.fillStyle=s,e.beginPath(),e.moveTo(0,i);for(let r=0;r<=o;r+=20){let n=i-a+Math.sin(r*.02+this.t*.06)*25;e.lineTo(r,n)}e.lineTo(o,i),e.closePath(),e.fill(),e.strokeStyle="rgba(220,240,255,0.6)",e.lineWidth=5,e.beginPath();for(let r=0;r<=o;r+=20){let n=i-a+Math.sin(r*.02+this.t*.06)*25;r===0?e.moveTo(r,n):e.lineTo(r,n)}e.stroke(),e.restore()}_drawVolcano(e,o,i){e.save();let a=o*.5,s=i*.62;e.fillStyle="rgba(20,15,12,0.95)",e.beginPath(),e.moveTo(0,i),e.lineTo(a,s),e.lineTo(o,i),e.closePath(),e.fill();let r=e.createRadialGradient(a,s,4,a,s-120,90);r.addColorStop(0,"rgba(60,55,50,0.95)"),r.addColorStop(.5,"rgba(90,80,70,0.7)"),r.addColorStop(1,"rgba(120,110,100,0)"),e.fillStyle=r,e.beginPath(),e.arc(a,s-60,100+Math.sin(this.t*.05)*20,0,Math.PI*2),e.fill(),e.globalCompositeOperation="screen";for(let n of this.particles)n.x+=n.v,n.y+=n.vy,n.vy+=.15,(n.y>i||n.life--<=0)&&(n.x=this._rand(o*.48,o*.52),n.y=this._rand(i*.58,i*.65),n.vy=this._rand(-6,-1),n.v=this._rand(-2,4),n.life=this._rand(20,80)),e.fillStyle=`rgba(255,${Math.floor(80+Math.random()*80)},30,${n.op})`,e.shadowColor="#ff4500",e.shadowBlur=8,e.beginPath(),e.arc(n.x,n.y,n.r,0,Math.PI*2),e.fill();e.globalCompositeOperation="source-over",e.fillStyle="rgba(80,70,65,0.18)",e.fillRect(0,0,o,i),e.restore()}_drawLandslide(e,o,i){e.save(),e.fillStyle="rgba(90,75,55,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,(a.x>o+50||a.y>i+50)&&(a.x=this._rand(-100,o),a.y=this._rand(-50,i*.5)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.25,e.fillStyle="#5c4a35",e.beginPath(),e.moveTo(0,i*.45),e.lineTo(o,i*.35),e.lineTo(o,i),e.lineTo(0,i),e.closePath(),e.fill(),e.restore()}_drawMudslide(e,o,i){e.save(),e.fillStyle="rgba(75,60,45,";for(let a of this.particles)a.x+=a.v*1.2,a.y+=a.vy*1.2,(a.x>o+50||a.y>i+50)&&(a.x=this._rand(-100,o),a.y=this._rand(-50,i*.5)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.35,e.fillStyle="#4a3b2a",e.fillRect(0,i*.5,o,i*.5),e.restore()}_drawAvalanche(e,o,i){e.save(),e.fillStyle="rgba(245,245,255,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,a.y>i+20&&(a.y=this._rand(-i,0),a.x=this._rand(0,o)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.3,e.fillStyle="#e8eef5",e.beginPath(),e.moveTo(0,0),e.lineTo(o,0),e.lineTo(o,i*.55),e.lineTo(0,i*.65),e.closePath(),e.fill(),e.restore()}_drawRockfall(e,o,i){e.save(),e.fillStyle="rgba(90,85,80,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,a.rot+=a.rotv,a.vy+=.2,a.y>i+20&&(a.y=this._rand(-i*.5,0),a.x=this._rand(-50,o+50),a.vy=this._rand(4,14)),e.globalAlpha=a.op,e.save(),e.translate(a.x,a.y),e.rotate(a.rot),e.fillRect(-a.r,-a.r,a.r*2,a.r*2),e.restore();e.restore()}_drawAcidRain(e,o,i){e.save(),e.globalCompositeOperation="source-over",e.fillStyle="rgba(160,180,60,0.15)",e.fillRect(0,0,o,i);for(let a of this.particles)a.y+=a.v,a.y>i+20&&(a.y=-10,a.x=this._rand(0,o)),e.strokeStyle=`rgba(200,230,80,${a.op})`,e.lineWidth=2,e.lineCap="round",e.beginPath(),e.moveTo(a.x,a.y),e.lineTo(a.x-2,a.y+a.len),e.stroke();e.restore()}_drawFire(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.vy+=.05,a.life--,(a.life<=0||a.y<i*.3)&&(a.x=this._rand(o*.1,o*.9),a.y=this._rand(i*.7,i),a.vy=this._rand(-3,-.5),a.v=this._rand(-1,1),a.life=this._rand(20,70));let s=a.r*(a.life/70);e.fillStyle=`rgba(255,${Math.floor(100+Math.random()*100)},30,${a.op})`,e.shadowColor="#ff6b00",e.shadowBlur=10,e.beginPath(),e.arc(a.x,a.y,s,0,Math.PI*2),e.fill()}e.globalCompositeOperation="source-over",e.fillStyle="rgba(60,55,50,0.2)",e.fillRect(0,0,o,i),e.restore()}_drawClearDay(e,o,i){e.save(),e.globalCompositeOperation="source-over";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.life--,(a.x>o+20||a.y<-20||a.life<=0)&&(a.x=this._rand(-20,o),a.y=this._rand(i*.2,i),a.v=this._rand(.3,.8),a.vy=this._rand(-.12,.12),a.life=this._rand(180,360));let s=.7+.3*Math.sin(this.t*.05+a.x*.01);e.globalAlpha=a.op*s,e.fillStyle="#ffffff",e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill(),e.globalAlpha=1}e.restore()}_drawClearNight(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.life--;let s=.5+.5*Math.sin(this.t*a.twinkle+a.phase);(a.life<=0||a.y<-10||a.x>o+10)&&(a.x=this._rand(0,o),a.y=this._rand(i*.1,i*.7),a.v=this._rand(.05,.15),a.vy=this._rand(-.05,.05),a.life=this._rand(150,320),a.twinkle=this._rand(.08,.18),a.phase=this._rand(0,Math.PI*2)),e.fillStyle=`rgba(255,245,220,${a.op*s})`,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill()}if(Math.random()<.012){let a=this._rand(o*.1,o*.9),s=this._rand(0,i*.4),r=this._rand(20,60),n=this._rand(Math.PI*.25,Math.PI*.55);e.strokeStyle="rgba(255,245,220,0.8)",e.lineWidth=1.5,e.beginPath(),e.moveTo(a,s),e.lineTo(a-Math.cos(n)*r,s+Math.sin(n)*r),e.stroke()}e.restore()}},K=class{constructor(e,o={},i={}){this.canvas=e,this.colors=o,this.location=i.location||Kt,this.timeOffsetMs=0,this.forceDay=i.forceDay||!1,this.forceNight=i.forceNight||!1,this.currentKey=null,this.currentParams=null,this.overlayEffect=null;let a=e.parentElement;a&&!a.querySelector("#fx-overlay")&&(this.overlay=new Me(a));try{this.sky=new Ye(e,{time:this._now(),location:this.location,weather:m[0],resolutionScale:.55,fps:24,colorSpace:"srgb",celestial:{bortle:6,milkyWay:0,meteors:0}})}catch(s){console.error("Atmosphere initialization failed",s),this.sky=null}}_now(){let e=new Date(Date.now()+this.timeOffsetMs);if(!this.forceDay&&!this.forceNight)return e;let o=new Date(e.getFullYear(),e.getMonth(),e.getDate(),12,0,0),i=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0);return this.forceDay?o:i}setSunState(e,o){this.sky&&(this.timeOffsetMs=0,this.sky.set({time:this._now()}))}setCondition(e){this.currentKey=e||"clear-day";let o=Xt[this.currentKey]||m[0];this.currentParams=d({},o),this.currentKey.includes("night")&&this.currentParams.isNightAdjusted,this.currentParams.precipitation>0&&!this.currentParams.precipitationType&&(this.currentParams.precipitationType="rain"),this.sky&&this.sky.set({time:this._now(),weather:{cloudCover:this.currentParams.cloudCover,precipitation:this.currentParams.precipitation,precipitationType:this.currentParams.precipitationType,windSpeed:this.currentParams.windSpeed,visibility:this.currentParams.visibility,thunder:this.currentParams.thunder||0,convection:this.currentParams.convection||0}}),this.overlayEffect=this.currentParams.overlay||null,this.overlay&&this.overlay.setEffect(this.overlayEffect)}setWeatherData(e){e=e||{};let o=this.currentParams||{},i=e.cloudCover,a=e.precipitation,s=e.windSpeed,r=e.visibility,n=e.thunder,l=e.precipitationType;this.sky&&this.sky.set({time:this._now(),weather:{cloudCover:i!=null?i:o.cloudCover!=null?o.cloudCover:0,precipitation:a!=null?a:o.precipitation!=null?o.precipitation:0,windSpeed:s!=null?s:o.windSpeed!=null?o.windSpeed:2,visibility:r!=null?r:o.visibility!=null?o.visibility:45,thunder:n!=null?n:o.thunder!=null?o.thunder:0,precipitationType:l!=null?l:o.precipitationType!=null?o.precipitationType:"rain"}})}dispose(){this.sky&&(this.sky.stop&&this.sky.stop(),this.sky.dispose&&this.sky.dispose()),this.overlay&&this.overlay.canvas.remove()}};window.WeatherAtmosphere=K;var H=37.8991768,q=-122.4949685,E="America/Los_Angeles",ea=900*1e3;var U=document.documentElement.getAttribute("data-theme")||"day",ue=new URLSearchParams(location.search).get("scene");function k(t){return getComputedStyle(document.documentElement).getPropertyValue(t).trim()}function Ke(t){let e=parseInt(t.slice(1),16);return[e>>16&255,e>>8&255,e&255]}function ta([t,e,o]){return"#"+[t,e,o].map(i=>Math.round(Math.max(0,Math.min(255,i))).toString(16).padStart(2,"0")).join("")}function Ce(t,e,o){let i=Ke(t),a=Ke(e);return ta([i[0]+(a[0]-i[0])*o,i[1]+(a[1]-i[1])*o,i[2]+(a[2]-i[2])*o])}var aa=[[0,"#7fa8cf","#ffcf9e","#fff6ea"],[.25,"#5b9bda","#bfe0f0","#eef7fa"],[.55,"#4a90d9","#8ec9ee","#eaf6fc"],[1,"#3f86d4","#8ec9ee","#e8f4fb"]],oa=[[0,"#140a1e","#3a2210","#0d0800"],[-.15,"#0a0614","#20120a","#050301"],[-.45,"#050308","#0f0803","#000000"],[-1,"#020104","#080402","#000000"]];function ia(t){let e=U==="night"?oa:aa,o=U==="night"?-Math.abs(t):Math.abs(t),i=e[0],a=e[e.length-1];for(let n=0;n<e.length-1;n++){let l=e[n],h=e[n+1];if(U==="night"?o<=l[0]&&o>=h[0]:o>=l[0]&&o<=h[0]){i=l,a=h;break}}let s=a[0]-i[0],r=s!==0?(o-i[0])/s:0;return{top:Ce(i[1],a[1],Math.max(0,Math.min(1,r))),mid:Ce(i[2],a[2],Math.max(0,Math.min(1,r))),bottom:Ce(i[3],a[3],Math.max(0,Math.min(1,r)))}}var S=1;function B(t,e){let o=new Date(t.endsWith("Z")?t:t+"Z"),i=new Date(o.toLocaleString("en-US",{timeZone:e})),s=new Date(o.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-i.getTime();return new Date(o.getTime()+s)}function Ae(t){let e=new Date,o=B(t.sunrise[S],E),i=B(t.sunset[S],E),a;if(e>=o&&e<=i){let n=(e-o)/(i-o);a={frac:n,elevation:Math.sin(Math.PI*n)}}else if(e<o){let n=B(t.sunset[S-1],E),l=Math.max(0,Math.min(1,(e-n)/(o-n)));a={frac:l,elevation:-Math.sin(Math.PI*l)}}else{let n=t.sunrise[S+1]?B(t.sunrise[S+1],E):new Date(i.getTime()+432e5),l=Math.max(0,Math.min(1,(e-i)/(n-i)));a={frac:l,elevation:-Math.sin(Math.PI*l)}}let s=ia(a.elevation),r=document.documentElement;return r.style.setProperty("--sky-top",s.top),r.style.setProperty("--sky-mid",s.mid),r.style.setProperty("--sky-bottom",s.bottom),a}function Te(t){return`${Math.round(t)}\xB0`}function sa(t){return t==null?{label:"\u2014",color:"var(--fg3)",desc:"Air quality data is unavailable right now."}:t<=50?{label:"Good",color:"var(--good)",desc:"Air quality is good. Enjoy your usual outdoor activities."}:t<=100?{label:"Moderate",color:"var(--warn)",desc:"Air quality is acceptable, though there may be a risk for sensitive groups."}:t<=150?{label:"Unhealthy (SG)",color:"var(--warn)",desc:"Sensitive groups may experience health effects. Others are unlikely to be affected."}:t<=200?{label:"Unhealthy",color:"var(--bad)",desc:"Everyone may begin to experience health effects; sensitive groups more so."}:t<=300?{label:"Very Unhealthy",color:"var(--bad)",desc:"Health alert: everyone may experience more serious health effects."}:{label:"Hazardous",color:"var(--bad)",desc:"Health warning of emergency conditions. Everyone is at risk."}}function ra(t){return["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round(t/22.5)%16]}function na(t,e){return`<svg viewBox="0 0 100 100">
  ...
  </svg>`}function la(t,e){let i=new Date(t).getHours(),a=i>=12?"PM":"AM";return i=i%12,i===0&&(i=12),e?`${i}${a}`:"NOW"}function ha(t,e){if(!e)return"NOW";let o=new Date(t),i=o.getHours(),a=o.getMinutes().toString().padStart(2,"0"),s=i>=12?"PM":"AM";return i=i%12,i===0&&(i=12),`${i}:${a}`}function ua(t,e){return e===0?"Today":new Date(t+"T00:00:00").toLocaleDateString("en-US",{weekday:"short"})}function da(){return L(this,null,function*(){let e=`https://api.open-meteo.com/v1/forecast?${`latitude=${H}&longitude=${q}&cell_selection=land&elevation=4`}&current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,weather_code,cloud_cover,wind_speed_10m,wind_direction_10m,precipitation&minutely_15=temperature_2m,weather_code,precipitation_probability,is_day,cloud_cover&hourly=temperature_2m,weather_code,precipitation_probability,visibility,is_day,cloud_cover&daily=weather_code,temperature_2m_max,temperature_2m_min,precipitation_probability_max,sunrise,sunset,uv_index_max&temperature_unit=fahrenheit&wind_speed_unit=mph&precipitation_unit=inch&timezone=${encodeURIComponent(E)}&forecast_days=7&past_days=1`,o=`https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${H}&longitude=${q}&current=us_aqi&timezone=${encodeURIComponent(E)}`,[i,a,s]=yield Promise.all([fetch(e).then(r=>r.json()),fetch(o).then(r=>r.json()).catch(()=>null),_a()]);return{weather:i,aq:a,skyCoverIntervals:s}})}var Q=null,Le=null,Pe=null,ca=`https://api.weather.gov/alerts/active?status=actual&point=${H},${q}`,fa=`https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&latitude=${H}&longitude=${q}&maxradiuskm=200&minmagnitude=4.0&starttime=`,ma="https://noaa-storm-proxy.iamflying29-sketch.deno.net",pa="https://services.swpc.noaa.gov/products/noaa-planetary-k-index.json",va="https://services.swpc.noaa.gov/json/ovation_aurora_latest.json",ga="https://api.nasa.gov/neo/rest/v1/feed",ya="DEMO_KEY",wa="https://api.weather.gov/gridpoints/MTR/83,111";function ba(t){let e=/^P(?:(\d+)D)?T(?:(\d+)H)?(?:(\d+)M)?/.exec(t||"");if(!e)return 0;let o=parseInt(e[1]||"0",10),i=parseInt(e[2]||"0",10),a=parseInt(e[3]||"0",10);return((o*24+i)*60+a)*60*1e3}function ka(t){return!t||!Array.isArray(t.values)?[]:t.values.map(e=>{let[o,i]=e.validTime.split("/"),a=new Date(o),s=new Date(a.getTime()+ba(i));return{start:a,end:s,value:e.value}})}function _a(){return L(this,null,function*(){try{let t=yield fetch(wa);if(!t.ok)return null;let e=yield t.json();return ka(e.properties&&e.properties.skyCover)}catch(t){return console.warn("NWS gridpoint skyCover fetch failed",t),null}})}function Ee(t,e){if(!t||!t.length)return null;for(let o of t)if(e>=o.start&&e<o.end)return o.value;return null}function Sa(t,e){if(!t||!t.length)return null;let o=[];for(let i=9;i<=18;i++){let a=B(`${e}T${String(i).padStart(2,"0")}:00:00`,E),s=Ee(t,a);s!=null&&o.push(s)}return o.length?o.reduce((i,a)=>i+a,0)/o.length:null}function Ma(t,e){if(!t||!t.time)return null;let o=new Map;for(let a=0;a<t.time.length;a++){if(t.time[a].slice(0,10)!==e)continue;let s=parseInt(t.time[a].slice(11,13),10);if(s<9||s>18)continue;let r=t.weather_code[a];o.set(r,(o.get(r)||0)+1)}if(!o.size)return null;let i=null;for(let[a,s]of o)(!i||s>i.n||s===i.n&&a>i.code)&&(i={code:a,n:s});return i.code}var Ca=[{re:/tornado/i,key:"tornado",label:"Tornado Warning",severity:5},{re:/tsunami/i,key:"tsunami",label:"Tsunami Warning",severity:5},{re:/hurricane/i,key:"hurricane",label:"Hurricane Warning",severity:4},{re:/tropical storm/i,key:"tropical-storm",label:"Tropical Storm Warning",severity:4},{re:/flash flood/i,key:"flash-flood",label:"Flash Flood Warning",severity:4},{re:/severe thunderstorm/i,key:"thunderstorm-hail",label:"Severe Thunderstorm Warning",severity:3},{re:/tornado watch|severe thunderstorm watch/i,key:"thunderstorm",label:"Severe Weather Watch",severity:2},{re:/fire weather|red flag/i,key:"wildfire-smoke",label:"Fire Weather Warning",severity:3},{re:/dust storm/i,key:"dust-storm",label:"Dust Storm Warning",severity:3},{re:/blizzard|winter storm/i,key:"blizzard",label:"Winter Storm Warning",severity:3},{re:/ice storm/i,key:"ice-storm",label:"Ice Storm Warning",severity:3},{re:/volcanic/i,key:"volcanic-eruption",label:"Volcanic Warning",severity:4}];function Ta(t){return{Extreme:4,Severe:3,Moderate:2,Minor:1,Unknown:0}[t]||0}function za(){return L(this,null,function*(){try{let t=yield fetch(ca);if(!t.ok)return[];let e=yield t.json();return Array.isArray(e.features)?e.features:[]}catch(t){return console.warn("NWS alerts fetch failed",t),[]}})}function Aa(){return L(this,null,function*(){try{let t=new Date(Date.now()-864e5).toISOString(),e=yield fetch(fa+encodeURIComponent(t));if(!e.ok)return null;let o=yield e.json();if(!o.features||!o.features.length)return null;let i=o.features[0];return{magnitude:i.properties.mag,place:i.properties.place,time:i.properties.time}}catch(t){return console.warn("USGS earthquake fetch failed",t),null}})}function La(){return L(this,null,function*(){try{let t=yield fetch(`${ma}?v=1`);return t.ok?yield t.json():null}catch(t){return console.warn("NOAA/NHC storm fetch failed",t),null}})}function Pa(){return L(this,null,function*(){try{let[t,e]=yield Promise.all([fetch(pa).then(a=>a.ok?a.json():null).catch(()=>null),fetch(va).then(a=>a.ok?a.json():null).catch(()=>null)]),o=null;if(Array.isArray(t)&&t.length){let a=t[t.length-1];o=a&&a.Kp!=null?Number(a.Kp):null}let i=null;if(e&&Array.isArray(e.coordinates)){let a=(360+q)%360,s=null;for(let r of e.coordinates){let n=Math.abs(r[0]-a)+Math.abs(r[1]-H);(!s||n<s.dist)&&(s={val:r[2],dist:n})}i=s?s.val:null}return o==null&&i==null?null:{kp:o,ovationValue:i}}catch(t){return console.warn("Aurora data fetch failed",t),null}})}function Ea(){return L(this,null,function*(){let t="neoCloseApproachCacheV1",e=new Date().toISOString().slice(0,10),o=null;try{o=JSON.parse(localStorage.getItem(t)||"null")}catch(i){o=null}if(o&&o.date===e)return o.result;try{let i=`${ga}?start_date=${e}&end_date=${e}&api_key=${ya}`,a=yield fetch(i);if(!a.ok)return o?o.result:null;let s=yield a.json(),r=null,n=s.near_earth_objects||{};for(let l of Object.keys(n))for(let h of n[l]){let u=h.estimated_diameter&&h.estimated_diameter.meters?h.estimated_diameter.meters.estimated_diameter_max:0;for(let c of h.close_approach_data||[]){let v=c.miss_distance?Number(c.miss_distance.kilometers):NaN;u>=100&&v&&v<=384400&&(r={name:(h.name||"").replace(/[()]/g,""),diameter:Math.round(u),distKm:Math.round(v)})}}try{localStorage.setItem(t,JSON.stringify({date:e,result:r}))}catch(l){}return r}catch(i){return console.warn("NASA NEO fetch failed",i),o?o.result:null}})}function Fa(t,e,o){let i=null;for(let a of t){let s=a.properties.event||"",r=Ta(a.properties.severity);for(let n of Ca)if(n.re.test(s)){let l=n.severity*10+r;(!i||l>i.score)&&(i=w(d({},n),{score:l}))}}return i?{key:i.key,label:i.label,source:"NWS"}:e?{key:"earthquake",label:`Earthquake M${e.magnitude}`,source:"USGS"}:null}var Xe=[{penumbral:["2026-03-03T08:44:00Z","2026-03-03T14:23:00Z"],umbral:["2026-03-03T09:50:00Z","2026-03-03T13:17:00Z"],total:["2026-03-03T11:04:00Z","2026-03-03T12:03:00Z"]},{penumbral:["2026-08-28T01:23:00Z","2026-08-28T07:02:00Z"],umbral:["2026-08-28T02:33:00Z","2026-08-28T05:52:00Z"],bloodAtMax:!0,maxWindow:["2026-08-28T03:43:00Z","2026-08-28T04:43:00Z"]},{penumbral:["2028-01-12T02:00:00Z","2028-01-12T06:30:00Z"],umbral:["2028-01-12T03:46:00Z","2028-01-12T04:42:00Z"]},{penumbral:["2028-12-31T14:20:00Z","2028-12-31T19:25:00Z"],umbral:["2028-12-31T15:05:00Z","2028-12-31T18:40:00Z"],total:["2028-12-31T16:17:00Z","2028-12-31T17:29:00Z"]},{penumbral:["2029-06-26T00:50:00Z","2029-06-26T05:55:00Z"],umbral:["2029-06-26T01:33:00Z","2029-06-26T05:13:00Z"],total:["2029-06-26T02:32:00Z","2029-06-26T04:14:00Z"]},{penumbral:["2029-12-20T19:30:00Z","2029-12-21T01:55:00Z"],umbral:["2029-12-20T20:45:00Z","2029-12-21T00:40:00Z"],total:["2029-12-20T21:53:00Z","2029-12-20T23:32:00Z"]}],et=[{window:["2028-01-26T17:03:00Z","2028-01-26T18:41:00Z"]},{window:["2029-01-14T15:10:00Z","2029-01-14T17:44:00Z"]},{window:["2031-11-14T21:07:00Z","2031-11-14T21:40:00Z"]}];(function(){let o=[].concat(Xe.map(i=>(i.penumbral||i.umbral||i.total)[1])).concat(et.map(i=>i.window[1])).map(i=>new Date(i).getTime()).reduce((i,a)=>Math.max(i,a),0);Date.now()>o-365*24*3600*1e3&&console.warn("LUNAR_ECLIPSES/SOLAR_ECLIPSES in weather.js only cover eclipses through "+new Date(o).toISOString().slice(0,10)+" -- fewer than a year of cataloged eclipses remain. Add more entries (see eclipse.gsfc.nasa.gov/lunar.html and timeanddate.com/eclipse for the next ones, cross-checked for Tiburon/Bay Area visibility).")})();function J(t,e){return t>=new Date(e[0])&&t<=new Date(e[1])}function xa(t,e){if(e<=0)for(let o of Xe){if(o.total&&J(t,o.total))return{key:"blood-moon",label:"Blood Moon (Total Lunar Eclipse)",source:"NASA"};if(o.bloodAtMax&&o.maxWindow&&J(t,o.maxWindow))return{key:"blood-moon",label:"Blood Moon (Lunar Eclipse)",source:"NASA"};if(o.umbral&&J(t,o.umbral))return{key:"eclipse-lunar",label:"Partial Lunar Eclipse",source:"NASA"};if(o.penumbral&&J(t,o.penumbral))return{key:"eclipse-lunar",label:"Lunar Eclipse",source:"NASA"}}if(e>-.1){for(let o of et)if(J(t,o.window))return{key:"eclipse",label:"Solar Eclipse",source:"NASA"}}return null}function Ia(t,e){return!t||t.kp==null||t.ovationValue==null||e>-.15?null:t.kp>=7&&t.ovationValue>=10?{key:"aurora",label:"Aurora Borealis"}:null}var Da=[{name:"Quadrantid",raHours:15.33,decDeg:49.7,peakMonth:1,peakDay:3,windowDays:1},{name:"Lyrid",raHours:18.13,decDeg:33.3,peakMonth:4,peakDay:22,windowDays:1},{name:"Perseid",raHours:3.28,decDeg:58.1,peakMonth:8,peakDay:12,windowDays:1},{name:"Orionid",raHours:6.42,decDeg:15.8,peakMonth:10,peakDay:21,windowDays:2},{name:"Leonid",raHours:10.27,decDeg:21.8,peakMonth:11,peakDay:17,windowDays:1},{name:"Geminid",raHours:7.55,decDeg:32.4,peakMonth:12,peakDay:13,windowDays:1},{name:"Ursid",raHours:14.63,decDeg:75.3,peakMonth:12,peakDay:22,windowDays:1}];function Ra(t,e){return((((280.46061837+360.98564736629*(t.getTime()/864e5+24405875e-1-2451545))%360+360)%360+e)%360+360)%360}function Oa(t,e,o,i,a){let r=Ra(o,a)-t*15;r=((r+180)%360+360)%360-180;let n=r*Math.PI/180,l=e*Math.PI/180,h=i*Math.PI/180,u=Math.sin(l)*Math.sin(h)+Math.cos(l)*Math.cos(h)*Math.cos(n);return Math.asin(Math.max(-1,Math.min(1,u)))*180/Math.PI}var P=29.530588861,Na=24515501e-1;function tt(t){return t.getTime()/864e5+24405875e-1}function at(t){let e=(tt(t)-Na)%P;return e<0&&(e+=P),e}function Wa(t){return(1-Math.cos(2*Math.PI*at(t)/P))/2}function Ba(t,e,o,i){let a=t.getUTCFullYear();for(let s of[a-1,a,a+1]){let r=Date.UTC(s,e-1,o,12,0,0);if(Math.abs(t.getTime()-r)<=i*864e5)return!0}return!1}function Ua(t,e){if(e>-.15||Wa(t)>.65)return null;for(let o of Da)if(Ba(t,o.peakMonth,o.peakDay,o.windowDays)&&Oa(o.raHours,o.decDeg,t,H,q)>=15)return{key:"meteor-shower",label:`${o.name} Meteor Shower`};return null}var Ha=[{name:"Wolf Moon",peak:"2026-01-03T10:03:00Z"},{name:"Beaver Moon",peak:"2026-11-24T14:53:00Z"},{name:"Cold Moon",peak:"2026-12-24T01:28:00Z"},{name:"Supermoon",peak:"2027-01-22T12:17:00Z"},{name:"Supermoon",peak:"2028-01-12T04:02:00Z"},{name:"Supermoon",peak:"2028-02-10T15:03:00Z"},{name:"Supermoon",peak:"2028-03-11T01:05:00Z"},{name:"Supermoon",peak:"2029-02-28T17:10:00Z"},{name:"Supermoon",peak:"2029-03-30T02:26:00Z"},{name:"Supermoon",peak:"2029-04-28T10:36:00Z"}],qa=20,ze=27.554549878,Ga=2457707974e-3;function $a(t){let e=(tt(t)-Ga)%ze;return e<0&&(e+=ze),Math.min(e,ze-e)}function ja(t){let o=at(t)-P/2;return o>P/2&&(o-=P),o<-P/2&&(o+=P),Math.abs(o)>1?!1:$a(t)<=2.5}function Za(t,e){if(e>-.05)return null;for(let o of Ha)if(Math.abs(t.getTime()-new Date(o.peak).getTime())<=qa*3600*1e3)return{key:"supermoon",label:`Supermoon (${o.name})`};return ja(t)?{key:"supermoon",label:"Supermoon"}:null}function Va(t,e){return!t||e>-.05?null:{key:"close-approach",label:`Close Approach: ${t.name}`}}function Ya(t,e){if(!t||!t.is_day||e<=.02||e>=.7)return null;let o=Number(t.precipitation)||0,i=t.cloud_cover!=null?Number(t.cloud_cover):null;return o>0&&o<4&&i!=null&&i<85?{key:"rainbow",label:"Rainbow"}:null}function Ka(t,e){let{weather:o,aq:i,alerts:a,quake:s,noaaStorms:r,skyCoverIntervals:n,aurora:l,neo:h}=t,u=o.current,c=o.hourly,v=o.minutely_15,f=o.daily;Q=f;let b=Ae(f);e&&e.setSunState(b.frac,b.elevation);let T=!!u.is_day,G=Ee(n,new Date),F=G!=null?G:u.cloud_cover,z=wmoInfo(u.weather_code,T,F),A=ue||z.key;ue&&(z={key:A,label:labelForKey(A)});let D=ue?null:Fa(a||[],s,r);if(D)z={key:D.key,label:D.label},A=z.key;else if(!ue){let g=new Date,y=xa(g,b.elevation)||Ia(l,b.elevation)||Ua(g,b.elevation)||Za(g,b.elevation)||Va(h,b.elevation)||Ya(u,b.elevation);y&&(z={key:y.key,label:y.label},A=z.key)}let R={theme:U,"--sun-core":k("--sun-core"),"--moon-core":k("--moon-core"),"--cloud":k("--cloud"),"--cloud2":k("--cloud2"),"--rain":k("--rain"),"--snow":k("--snow"),"--fog":k("--fog"),"--bolt":k("--bolt"),"--fg":k("--fg")};document.getElementById("nowIcon").innerHTML=iconSvgFor(A,R),document.getElementById("nowTemp").textContent=Te(u.temperature_2m),document.getElementById("nowCond").textContent=z.label,document.getElementById("nowSub").textContent=`Feels like ${Te(u.apparent_temperature)}`,document.getElementById("hilo").textContent=`H:${Math.round(f.temperature_2m_max[S])}\xB0  L:${Math.round(f.temperature_2m_min[S])}\xB0`,Le=A,Pe=F,e&&e.setCondition(A),e&&F!=null&&e.setWeatherData({cloudCover:F/100});let Fe=v&&v.time&&v.time.length>0,M=Fe?v:c,ot=o.current.time.slice(0,16),$=M.time.findIndex(g=>g>=ot);$<0&&($=0);let xe=document.getElementById("hourly");xe.innerHTML="";for(let g=0;g<12;g++){let y=$+g;if(y>=M.time.length)break;let ce=M.is_day?!!M.is_day[y]:!0,ee=M.cloud_cover?M.cloud_cover[y]:null,te=Ee(n,B(M.time[y],E)),Z=wmoInfo(M.weather_code[y],ce,te!=null?te:ee),N=M.precipitation_probability?M.precipitation_probability[y]:null,V=document.createElement("div");V.className="ww-hour",V.innerHTML=`
      <div class="hh">${Fe?ha(M.time[y],g):la(M.time[y],g)}</div>
      ${iconSvgFor(Z.key,R)}
      <div class="ht">${Math.round(M.temperature_2m[y])}\xB0</div>
      <div class="hp">${N!=null&&N>=15?N+"%":""}</div>
    `,xe.appendChild(V)}let Ie=document.getElementById("daily");Ie.innerHTML="";let De=Math.min(...f.temperature_2m_min.slice(S,S+5)),it=Math.max(...f.temperature_2m_max.slice(S,S+5)),Re=Math.max(1,it-De);for(let g=0;g<5;g++){let y=S+g,ce=Sa(n,f.time[y]),ee=Ma(c,f.time[y]),te=wmoInfo(ee!=null?ee:f.weather_code[y],!0,ce),Z=f.temperature_2m_min[y],N=f.temperature_2m_max[y],V=(Z-De)/Re*100,ut=(N-Z)/Re*100,We=f.precipitation_probability_max[y],fe=document.createElement("div");fe.className="ww-day-row",fe.innerHTML=`
      <div class="dn">${ua(f.time[y],g)}</div>
      ${iconSvgFor(te.key,R)}
      <div class="ww-bar"><span style="left:${V}%;width:${ut}%"></span></div>
      <div class="dp">${We>=15?We+"%":""}</div>
      <div class="dlo">${Math.round(Z)}\xB0</div>
      <div class="dhi">${Math.round(N)}\xB0</div>
    `,Ie.appendChild(fe)}let j=i&&i.current?i.current.us_aqi:null,de=sa(j);document.getElementById("aqiVal").textContent=j!=null?Math.round(j):"\u2014",document.getElementById("aqiVal").style.color=de.color,document.getElementById("aqiCat").textContent=de.label,document.getElementById("aqiDesc").textContent=de.desc;let st=j!=null?Math.min(100,j/300*100):0;document.getElementById("aqiMarker").style.left=`${st}%`;let rt=new Date(f.sunrise[S]),nt=new Date(f.sunset[S]),Oe=g=>g.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),lt=c.visibility&&c.visibility[$]!=null?(c.visibility[$]/1609.34).toFixed(1):"\u2014",O=k("--fg"),ht=[{icon:WI.uv(O),label:"UV Index",value:Math.round(f.uv_index_max[S]),sub:Ja(f.uv_index_max[S])},{icon:WI.sunrise(O),label:"Sunrise",value:Oe(rt),sub:`Sunset ${Oe(nt)}`},{icon:"",label:"Wind",value:`${Math.round(u.wind_speed_10m)} mph`,sub:ra(u.wind_direction_10m),compass:u.wind_direction_10m},{icon:WI.drop(O),label:"Humidity",value:`${Math.round(u.relative_humidity_2m)}%`,sub:""},{icon:WI.eye(O),label:"Visibility",value:`${lt} mi`,sub:""},{icon:WI.thermo(O),label:"Feels Like",value:Te(u.apparent_temperature),sub:""}],Ne=document.getElementById("grid");Ne.innerHTML="";for(let g of ht){let y=document.createElement("div");y.className="ww-card",g.compass!==void 0?y.innerHTML=`<div class="cl">${g.label}</div><div class="ww-compass">${na(g.compass,O)}</div><div class="cv" style="font-size:16px">${g.value}</div><div class="cs">${g.sub}</div>`:y.innerHTML=`<div class="cl">${g.icon}${g.label}</div><div class="cv">${g.value}</div><div class="cs">${g.sub}</div>`,Ne.appendChild(y)}}function Ja(t){return t<3?"Low":t<6?"Moderate":t<8?"High":t<11?"Very High":"Extreme"}var X=null;window.fxEngine=null;function Je(){return L(this,null,function*(){try{let[t,e,o,i,a,s]=yield Promise.all([da(),za(),Aa(),La(),Pa(),Ea()]);Ka(w(d({},t),{alerts:e,quake:o,noaaStorms:i,aurora:a,neo:s}),X)}catch(t){console.error("Weather fetch failed",t)}})}function Qe(){Je(),setInterval(Je,ea),setInterval(()=>{if(Q){let t=Ae(Q);X&&X.setSunState(t.frac,t.elevation)}},60*1e3),setTimeout(()=>{try{let t=document.getElementById("fx"),e=new K(t,{sunCore:k("--sun-core"),sunGlow:k("--sun-glow"),moonCore:k("--moon-core"),moonGlow:k("--moon-glow"),cloud:k("--cloud"),cloud2:k("--cloud2"),rain:k("--rain"),snow:k("--snow"),fog:k("--fog"),bolt:k("--bolt")},{forceDay:U==="day",forceNight:U==="night"});if(X=e,window.fxEngine=e,Q){let o=Ae(Q);e.setSunState(o.frac,o.elevation)}Le&&(e.setCondition(Le),Pe!=null&&e.setWeatherData({cloudCover:Pe/100}))}catch(t){console.error("Atmosphere engine failed to start; continuing without it",t),X=null,window.fxEngine=null}},0)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Qe):Qe();})();
