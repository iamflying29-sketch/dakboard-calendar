(()=>{var Xe=Object.defineProperty,Je=Object.defineProperties;var et=Object.getOwnPropertyDescriptors;var Le=Object.getOwnPropertySymbols;var tt=Object.prototype.hasOwnProperty,at=Object.prototype.propertyIsEnumerable;var ne=(t,e,o)=>e in t?Xe(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,c=(t,e)=>{for(var o in e||(e={}))tt.call(e,o)&&ne(t,o,e[o]);if(Le)for(var o of Le(e))at.call(e,o)&&ne(t,o,e[o]);return t},w=(t,e)=>Je(t,et(e));var f=(t,e,o)=>ne(t,typeof e!="symbol"?e+"":e,o);var A=(t,e,o)=>new Promise((i,a)=>{var s=l=>{try{n(o.next(l))}catch(h){a(h)}},r=l=>{try{n(o.throw(l))}catch(h){a(h)}},n=l=>l.done?i(l.value):Promise.resolve(l.value).then(s,r);n((o=o.apply(t,e)).next())});var me={cirrus:{label:"Cirrus",alias:"Mare's tail",abbr:"Ci",level:"high",form:"filament",opacity:.15},cirrostratus:{label:"Cirrostratus",alias:"Veil cloud",abbr:"Cs",level:"high",form:"stratiform",opacity:.45},cirrocumulus:{label:"Cirrocumulus",alias:"Mackerel sky",abbr:"Cc",level:"high",form:"granular",opacity:.25},altostratus:{label:"Altostratus",alias:"Grey veil",abbr:"As",level:"mid",form:"stratiform",opacity:.9},altocumulus:{label:"Altocumulus",alias:"Sheep cloud",abbr:"Ac",level:"mid",form:"granular",opacity:.45},nimbostratus:{label:"Nimbostratus",alias:"Rain cloud",abbr:"Ns",level:"mid",form:"stratiform",opacity:1},stratus:{label:"Stratus",alias:"Fog cloud",abbr:"St",level:"low",form:"stratiform",opacity:.95},stratocumulus:{label:"Stratocumulus",alias:"Roll cloud",abbr:"Sc",level:"low",form:"granular",opacity:.75},cumulus:{label:"Cumulus",alias:"Cotton cloud",abbr:"Cu",level:"low",form:"convective",opacity:.4},cumulonimbus:{label:"Cumulonimbus",alias:"Thunderhead",abbr:"Cb",level:"low",form:"convective",opacity:.28}},pe=Object.keys(me),F=t=>t<0?0:t>1?1:t;function _(t,e,o){let i=F((t-e)/(o-e));return i*i*(3-2*i)}function it(t){let e=F(t);return{anvil:_(e,.68,1),velum:_(e,.22,.5)*(1-_(e,.68,.95))}}var V={cirrus:0,cirrostratus:0,cirrocumulus:0,altostratus:0,altocumulus:0,nimbostratus:0,stratus:0,stratocumulus:0,cumulus:0,cumulonimbus:0};function ot(t){var o;if(t==null)return c({},V);if(typeof t=="string")return w(c({},V),{[t]:1});if(Array.isArray(t)){let i=c({},V);for(let a of t)i[a]=1;return i}let e=c({},V);for(let i of pe)e[i]=F((o=t[i])!=null?o:0);return e}function st(t,e,o,i){let a=F(t),s=F(e),r=1-s,n=1-_(a,.45,.85),l=1-_(a,.5,.85);return{cirrus:_(a,.02,.45)*.7*n,cirrostratus:_(a,.1,.45)*.45*n,cirrocumulus:_(a,.14,.4)*.35*n*r,altostratus:_(a,.55,.9)*.85*r,altocumulus:_(a,.22,.55)*.7*(1-_(a,.7,.95))*r,nimbostratus:s*_(a,.5,.85),stratus:_(a,.5,.9)*i*.9,stratocumulus:_(a,.3,.75)*.85*(1-s*.7),cumulus:_(a,.03,.35)*l*r,cumulonimbus:F(o)*_(a,.02,.25)}}function rt(t){let e=1;for(let o of pe)e*=1-t[o]*me[o].opacity;return F(1-e)}var nt={tau:2.2,windBase:.006,windGust:.22,evoBase:.07,evoGust:.09,windPerHour:.25,evoPerHour:.06},lt=Math.PI*2;function Fe(t){return{filter:w(c({},t.filter),{tint:[t.filter.tint[0],t.filter.tint[1],t.filter.tint[2]]}),tone:c({},t.tone),polarizer:c({},t.polarizer),celestial:w(c({},t.celestial),{radiant:t.celestial.radiant?[t.celestial.radiant[0],t.celestial.radiant[1]]:null}),clouds:c({},t.clouds),features:c({},t.features)}}function le(t,e,o,i){let a=i/2,s=(e-t+i*1.5)%i-a;return(t+s*o+i)%i}var ht=class{constructor(t,e={}){f(this,"current");f(this,"windOff",41.7);f(this,"evoOff",7.3);f(this,"opts");this.current=c(c({},t),Fe(t)),this.opts=c(c({},nt),e)}get wind(){return this.windOff}get evolution(){return this.evoOff}jump(t){Object.assign(this.current,t,Fe(t))}step(t,e){let o=this.opts,i=this.current,a=1-Math.exp(-e/o.tau),s=i.timeOfDay;i.timeOfDay=le(i.timeOfDay,t.timeOfDay,a,24);let r=(i.timeOfDay-s+36)%24-12;i.sunElevation+=(t.sunElevation-i.sunElevation)*a,i.sunAzimuth=le(i.sunAzimuth,t.sunAzimuth,a,lt),i.cloudCover+=(t.cloudCover-i.cloudCover)*a;for(let M of pe)i.clouds[M]+=(t.clouds[M]-i.clouds[M])*a;i.features.anvil+=(t.features.anvil-i.features.anvil)*a,i.features.velum+=(t.features.velum-i.features.velum)*a,i.rain+=(t.rain-i.rain)*a,i.snow+=(t.snow-i.snow)*a,i.wind+=(t.wind-i.wind)*a,i.thunder+=(t.thunder-i.thunder)*a,i.haze+=(t.haze-i.haze)*a;let n=i.filter,l=t.filter;n.amount+=(l.amount-n.amount)*a,n.saturation+=(l.saturation-n.saturation)*a,n.lift+=(l.lift-n.lift)*a,n.tint=[n.tint[0]+(l.tint[0]-n.tint[0])*a,n.tint[1]+(l.tint[1]-n.tint[1])*a,n.tint[2]+(l.tint[2]-n.tint[2])*a];let h=i.tone,d=t.tone;h.exposure+=(d.exposure-h.exposure)*a,h.contrast+=(d.contrast-h.contrast)*a,h.knee+=(d.knee-h.knee)*a,h.bleach+=(d.bleach-h.bleach)*a;let u=i.polarizer,g=t.polarizer;u.strength+=(g.strength-u.strength)*a,u.saturation+=(g.saturation-u.saturation)*a,u.stopLoss+=(g.stopLoss-u.stopLoss)*a,u.angle=le(u.angle,g.angle,a,Math.PI);let b=i.celestial,C=t.celestial;b.bortle+=(C.bortle-b.bortle)*a,b.milkyWay+=(C.milkyWay-b.milkyWay)*a,b.meteors+=(C.meteors-b.meteors)*a,b.radiant=C.radiant?[C.radiant[0],C.radiant[1]]:null,this.windOff+=(o.windBase+i.wind*o.windGust)*e+Math.abs(r)*o.windPerHour,this.evoOff+=(o.evoBase+i.wind*o.evoGust)*e+Math.abs(r)*o.evoPerHour}},ut=[.82246197,.17753803,0,.0331942,.9668058,0,.01708263,.07239744,.91051993];function dt(t){let e=o=>[t[o],t[o+3],t[o+6]].map(i=>i.toFixed(8)).join(", ");return`mat3(${e(0)},
       ${e(1)},
       ${e(2)})`}var ct=[1.05,.79],ft=[.98,1.48],fe={"dark-sky":{label:"Dark sky",bortle:2,milkyWay:1,meteors:5,radiant:null},rural:{label:"Rural",bortle:4,milkyWay:.45,meteors:5,radiant:null},suburban:{label:"Suburban",bortle:6,milkyWay:0,meteors:0,radiant:null},city:{label:"City",bortle:8,milkyWay:0,meteors:0,radiant:null},perseids:{label:"Perseids",bortle:3,milkyWay:.75,meteors:100,radiant:ct},geminids:{label:"Geminids",bortle:3,milkyWay:.75,meteors:150,radiant:ft}},va=Object.keys(fe);var Y={bortle:6,milkyWay:0,meteors:0,radiant:null};function mt(t){return Math.min(1,Math.max(0,(5.5-t)/3.5))}function he(t){return{bortle:t.bortle,milkyWay:t.milkyWay,meteors:t.meteors,radiant:t.radiant?[t.radiant[0],t.radiant[1]]:null}}var Pe=(t,e,o)=>Math.min(o,Math.max(e,t));function pt(t){var i,a,s,r,n;if(t==null)return he(Y);if(typeof t=="string")return he((i=fe[t])!=null?i:Y);let e=t.id&&(a=fe[t.id])!=null?a:Y,o=Pe((s=t.bortle)!=null?s:e.bortle,1,9);return he({bortle:o,milkyWay:Pe((r=t.milkyWay)!=null?r:t.id?e.milkyWay:mt(o),0,1),meteors:Math.max(0,(n=t.meteors)!=null?n:e.meteors),radiant:t.radiant!==void 0?t.radiant:e.radiant})}var D={none:{label:"None",amount:0,tint:[1,1,1],saturation:1,lift:0},sepia:{label:"Sepia",amount:1,tint:[1.07,.93,.72],saturation:.1,lift:.02},mono:{label:"Monochrome",amount:1,tint:[1,1,1],saturation:0,lift:0},faded:{label:"Faded",amount:1,tint:[1.02,.99,.94],saturation:.35,lift:.06},cyanotype:{label:"Cyanotype",amount:1,tint:[.72,.9,1.12],saturation:.08,lift:.03},gold:{label:"Gold",amount:1,tint:[1.15,.95,.6],saturation:.45,lift:.02},ash:{label:"Ash",amount:1,tint:[.92,.95,1],saturation:.2,lift:.04}},ga=Object.keys(D);var ue=D.none;function K(t){return{amount:t.amount,tint:[t.tint[0],t.tint[1],t.tint[2]],saturation:t.saturation,lift:t.lift}}function vt(t){var o,i,a,s,r,n;if(t==null||t===!1)return K(ue);if(t===!0)return K(D.sepia);if(typeof t=="string")return K((o=D[t])!=null?o:ue);let e=t.id?(i=D[t.id])!=null?i:ue:{amount:1,tint:[1,1,1],saturation:0,lift:0};return K({amount:(a=t.amount)!=null?a:e.amount,tint:(s=t.tint)!=null?s:e.tint,saturation:(r=t.saturation)!=null?r:e.saturation,lift:(n=t.lift)!=null?n:e.lift})}var H={none:{label:"None",strength:0,angle:0,saturation:0,stopLoss:0},light:{label:"Light CPL",strength:.45,angle:0,saturation:.2,stopLoss:0},strong:{label:"Strong CPL",strength:.85,angle:0,saturation:.4,stopLoss:0},crossed:{label:"Crossed CPL",strength:.85,angle:Math.PI/2,saturation:.1,stopLoss:0}},ya=Object.keys(H);var Z=H.none;function Q(t){return{strength:t.strength,angle:t.angle,saturation:t.saturation,stopLoss:t.stopLoss}}var de=t=>Math.min(1,Math.max(0,t));function gt(t){var o,i,a,s,r,n;if(t==null||t===!1)return Q(Z);if(t===!0)return Q(H.light);if(typeof t=="string")return Q((o=H[t])!=null?o:Z);let e=t.id&&(i=H[t.id])!=null?i:Z;return Q({strength:de((a=t.strength)!=null?a:e.strength),angle:(s=t.angle)!=null?s:e.angle,saturation:de((r=t.saturation)!=null?r:e.saturation),stopLoss:de((n=t.stopLoss)!=null?n:e.stopLoss)})}var L=Math.PI/180,yt=864e5,wt=2440588,bt=2451545,Ee=23.4397*L;function kt(t,e){let o=t.getTime()/yt-.5+wt-bt,i=L*(357.5291+.98560028*o),a=L*(1.9148*Math.sin(i)+.02*Math.sin(2*i)+3e-4*Math.sin(3*i)),s=i+a+L*102.9372+Math.PI,r=Math.asin(Math.sin(Ee)*Math.sin(s)),n=Math.atan2(Math.sin(s)*Math.cos(Ee),Math.cos(s)),l=L*-e.longitude,h=L*e.latitude,d=L*(280.16+360.9856235*o)-l-n,u=Math.asin(Math.sin(h)*Math.sin(r)+Math.cos(h)*Math.cos(r)*Math.cos(d)),g=Math.atan2(Math.sin(d),Math.cos(d)*Math.sin(h)-Math.tan(r)*Math.cos(h))+Math.PI;return{elevation:u,azimuth:(g%(2*Math.PI)+2*Math.PI)%(2*Math.PI)}}function _t(t){let e=(t-6)/12;return{elevation:Math.asin(Math.sin(e*Math.PI)*.72),azimuth:Math.PI/2+e*Math.PI}}function Oe(t){if(t instanceof Date)return Number.isNaN(t.getTime())?null:t;if(typeof t=="string"&&/\d{4}-\d{2}-\d{2}/.test(t)){let e=new Date(t);return Number.isNaN(e.getTime())?null:e}return null}function St(t){var o;if(typeof t=="number")return(t%24+24)%24;let e=Oe(t);if(e)return e.getHours()+e.getMinutes()/60+e.getSeconds()/3600;if(typeof t=="string"){let i=/^(\d{1,2})(?::(\d{2}))?/.exec(t.trim());if(i)return((Number(i[1])+Number((o=i[2])!=null?o:0)/60)%24+24)%24}return 12}var J={neutral:{label:"Neutral",exposure:0,contrast:1,knee:.8,bleach:0},flat:{label:"Flat",exposure:.15,contrast:.82,knee:.55,bleach:.25},punch:{label:"Punch",exposure:-.2,contrast:1.22,knee:.85,bleach:.1},filmic:{label:"Filmic",exposure:.1,contrast:1.08,knee:.42,bleach:.55},blown:{label:"Blown",exposure:.85,contrast:.95,knee:.7,bleach:.4}},wa=Object.keys(J);var X=J.neutral;function ce(t){return{exposure:t.exposure,contrast:t.contrast,knee:t.knee,bleach:t.bleach}}function Ct(t){var o,i,a,s,r,n;if(t==null)return ce(X);if(typeof t=="string")return ce((o=J[t])!=null?o:X);let e=t.id&&(i=J[t.id])!=null?i:X;return ce({exposure:(a=t.exposure)!=null?a:e.exposure,contrast:(s=t.contrast)!=null?s:e.contrast,knee:Math.min(.99,Math.max(.02,(r=t.knee)!=null?r:e.knee)),bleach:Math.min(1,Math.max(0,(n=t.bleach)!=null?n:e.bleach))})}var ee={clear:{label:"Clear",cloudCover:0,windSpeed:2,visibility:45},fair:{label:"Fair",cloudCover:.22,windSpeed:3,visibility:35},summer:{label:"Summer sky",cloudCover:.38,windSpeed:3,visibility:25,convection:.7},overcast:{label:"Overcast",cloudCover:.82,windSpeed:5,visibility:15},fog:{label:"Fog",cloudCover:.75,windSpeed:1,visibility:.6},rain:{label:"Rain",cloudCover:.95,windSpeed:7,visibility:8,precipitation:8,thunder:.08},thunderstorm:{label:"Thunderstorm",cloudCover:.97,windSpeed:12,visibility:5,precipitation:25,thunder:1,convection:.5},snow:{label:"Snow",cloudCover:.9,windSpeed:3,visibility:4,precipitation:3,precipitationType:"snow"},typhoon:{label:"Typhoon",cloudCover:1,windSpeed:30,visibility:6,precipitation:40,thunder:.5}},ba=Object.keys(ee);var z=t=>t<0?0:t>1?1:t;function Mt(t){return z(Math.pow(z(t/30),.55))}function zt(t){return z(Math.pow(z(t/33),.8))}function Tt(t){return z(Math.pow(z(t/5),.6))}function xt(t){return z(Math.pow(z((20-t)/20),2.6))}function At(t){var u,g,b,C,M,T,x,P,E,W,k;let e=typeof t=="string"?(u=ee[t])!=null?u:ee.clear:t!=null?t:{},o=(g=e.precipitation)!=null?g:0,i=e.precipitationType==="snow",a=i?0:Mt(o),s=i?Tt(o):0,r=xt((b=e.visibility)!=null?b:30),n=z((C=e.convection)!=null?C:0),l,h;e.clouds!=null?(l=ot(e.clouds),h=rt(l)):(h=z((M=e.cloudCover)!=null?M:0),l=st(h,Math.max(a,s),n,r));let d=it(l.cumulonimbus);return{clouds:l,features:{anvil:z((x=(T=e.features)==null?void 0:T.anvil)!=null?x:d.anvil),velum:z((E=(P=e.features)==null?void 0:P.velum)!=null?E:d.velum)},cloudCover:h,rain:a,snow:s,wind:zt((W=e.windSpeed)!=null?W:0),thunder:z((k=e.thunder)!=null?k:0),haze:r}}var We={yaw:Math.PI,pitch:.46,fov:.86},ka=[{yaw:Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:-Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:0,pitch:Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:-Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:0,fov:Math.PI/2},{yaw:Math.PI,pitch:0,fov:Math.PI/2}],Re={time:12,weather:"clear"};function Ie(t){var s,r;let e=(s=t.time)!=null?s:Re.time,o=St(e),i=Oe(e),a=t.location&&i?kt(i,t.location):_t(o);return w(c({timeOfDay:o,sunElevation:a.elevation,sunAzimuth:a.azimuth},At((r=t.weather)!=null?r:Re.weather)),{filter:vt(t.filter),tone:Ct(t.tone),polarizer:gt(t.polarizer),celestial:pt(t.celestial)})}function De(t){return c(c({},We),t)}var Lt=`
...
void main() {
  ...
  if (u_p3 > 0.5) {
    ...
    sky = mix(srgbToDisplayP3(sky), sky, clamp(wide, 0.0, 1.0) * ${Ft.toFixed(4)});
  }
...
`,Et=4096,Rt=["u_res","u_time","u_cam","u_sun","u_cover","u_high","u_mid","u_low","u_rain","u_snow","u_wind","u_thunder","u_haze","u_cbFeat","u_windOff","u_evo","u_filtAmt","u_filtTint","u_filtSat","u_filtLift","u_p3","u_headroom","u_tone","u_pol","u_sky","u_radiant"],It=class{constructor(t,e={}){f(this,"canvas");f(this,"opts");f(this,"gl",null);f(this,"program",null);f(this,"buffer",null);f(this,"u",{});f(this,"lost",!1);f(this,"p3",!1);f(this,"onLost",t=>{t.preventDefault(),this.lost=!0});f(this,"onRestored",()=>{this.lost=!1,this.init()});this.canvas=t,this.opts=e,t.addEventListener("webglcontextlost",this.onLost),t.addEventListener("webglcontextrestored",this.onRestored),this.init()}get available(){return this.gl!==null}get colorSpace(){return this.p3?"display-p3":"srgb"}init(){let t=this.canvas.getContext("webgl",{alpha:!1,antialias:!1,depth:!1,stencil:!1,powerPreference:"low-power"});if(!t){this.gl=null;return}this.gl=t,this.p3=!1,this.opts.colorSpace!=="srgb"&&"drawingBufferColorSpace"in t&&(t.drawingBufferColorSpace="display-p3",this.p3=t.drawingBufferColorSpace==="display-p3");let e=(r,n)=>{let l=t.createShader(r);return l?(t.shaderSource(l,n),t.compileShader(l),t.getShaderParameter(l,t.COMPILE_STATUS)?l:(console.error("atmosphere shader compile error:",t.getShaderInfoLog(l)),t.deleteShader(l),null)):null},o=e(t.VERTEX_SHADER,Lt),i=e(t.FRAGMENT_SHADER,Pt);if(!o||!i){this.gl=null;return}let a=t.createProgram();if(!a){this.gl=null;return}if(t.attachShader(a,o),t.attachShader(a,i),t.linkProgram(a),t.deleteShader(o),t.deleteShader(i),!t.getProgramParameter(a,t.LINK_STATUS)){console.error("atmosphere shader link error:",t.getProgramInfoLog(a)),this.gl=null;return}this.program=a,t.useProgram(a),this.buffer=t.createBuffer(),t.bindBuffer(t.ARRAY_BUFFER,this.buffer),t.bufferData(t.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),t.STATIC_DRAW);let s=t.getAttribLocation(a,"a_pos");t.enableVertexAttribArray(s),t.vertexAttribPointer(s,2,t.FLOAT,!1,0,0),this.u={};for(let r of Rt)this.u[r]=t.getUniformLocation(a,r)}resize(t,e){var o;this.canvas.width=t,this.canvas.height=e,(o=this.gl)==null||o.viewport(0,0,t,e)}render(t,e,o=We,i=0,a=0){var u,g,b,C,M;let s=this.gl;if(!s||this.lost||!this.program)return;s.useProgram(this.program);let r=this.u;s.uniform2f(r.u_res,this.canvas.width,this.canvas.height),s.uniform1f(r.u_time,t%Et),s.uniform3f(r.u_cam,o.yaw,o.pitch,o.fov),s.uniform2f(r.u_sun,e.sunElevation,e.sunAzimuth);let n=e.clouds;s.uniform1f(r.u_cover,e.cloudCover),s.uniform3f(r.u_high,n.cirrus,n.cirrostratus,n.cirrocumulus),s.uniform3f(r.u_mid,n.altostratus,n.altocumulus,n.nimbostratus),s.uniform4f(r.u_low,n.stratus,n.stratocumulus,n.cumulus,n.cumulonimbus),s.uniform1f(r.u_rain,e.rain),s.uniform1f(r.u_snow,e.snow),s.uniform1f(r.u_wind,e.wind),s.uniform1f(r.u_thunder,e.thunder),s.uniform1f(r.u_haze,e.haze),s.uniform2f(r.u_cbFeat,e.features.anvil,e.features.velum),s.uniform1f(r.u_windOff,i),s.uniform1f(r.u_evo,a),s.uniform1f(r.u_filtAmt,e.filter.amount),s.uniform3f(r.u_filtTint,e.filter.tint[0],e.filter.tint[1],e.filter.tint[2]),s.uniform1f(r.u_filtSat,e.filter.saturation),s.uniform1f(r.u_filtLift,e.filter.lift),s.uniform1f(r.u_p3,this.p3?1:0),s.uniform1f(r.u_headroom,Math.max(1,(u=this.opts.headroom)!=null?u:1));let l=e.tone;s.uniform4f(r.u_tone,l.exposure,l.contrast,l.knee,l.bleach);let h=e.polarizer;s.uniform4f(r.u_pol,h.strength,h.angle,h.saturation,h.stopLoss);let d=e.celestial;s.uniform4f(r.u_sky,d.bortle,d.milkyWay,d.meteors,d.radiant?1:0),s.uniform2f(r.u_radiant,(b=(g=d.radiant)==null?void 0:g[0])!=null?b:0,(M=(C=d.radiant)==null?void 0:C[1])!=null?M:0),s.drawArrays(s.TRIANGLES,0,3)}dispose(t={}){var o;let e=this.gl;this.canvas.removeEventListener("webglcontextlost",this.onLost),this.canvas.removeEventListener("webglcontextrestored",this.onRestored),e&&(this.program&&e.deleteProgram(this.program),this.buffer&&e.deleteBuffer(this.buffer),t.loseContext&&((o=e.getExtension("WEBGL_lose_context"))==null||o.loseContext())),this.gl=null,this.program=null,this.buffer=null}},Dt=()=>Math.min(typeof devicePixelRatio=="number"?devicePixelRatio:1,1.5)*.55,Be=class{constructor(t,e={}){f(this,"canvas");f(this,"renderer");f(this,"animator");f(this,"opts");f(this,"target");f(this,"conditions");f(this,"cam");f(this,"raf",0);f(this,"observer",null);f(this,"startedAt",0);f(this,"last",0);f(this,"lastDraw",0);f(this,"wantRunning",!1);f(this,"motionQuery",null);f(this,"onMotionChange",()=>{this.wantRunning&&(this.reducedMotion?(this.stopLoop(),this.jump()):this.startLoop())});this.canvas=t,this.opts=e,this.conditions={time:e.time,location:e.location,weather:e.weather,filter:e.filter,tone:e.tone,polarizer:e.polarizer,celestial:e.celestial,camera:e.camera},this.target=Ie(this.conditions),this.cam=De(e.camera),this.renderer=new It(t,{colorSpace:e.colorSpace}),this.animator=new ht(this.target,e.animator),this.resize(),typeof ResizeObserver!="undefined"&&(this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(t)),e.respectReducedMotion!==!1&&typeof matchMedia!="undefined"&&(this.motionQuery=matchMedia("(prefers-reduced-motion: reduce)"),this.motionQuery.addEventListener("change",this.onMotionChange)),e.autoStart!==!1&&this.start()}get reducedMotion(){var t,e;return(e=(t=this.motionQuery)==null?void 0:t.matches)!=null?e:!1}get available(){return this.renderer.available}get colorSpace(){return this.renderer.colorSpace}get state(){let t=this.animator.current;return w(c({},t),{clouds:c({},t.clouds),features:c({},t.features),filter:w(c({},t.filter),{tint:[...t.filter.tint]}),tone:c({},t.tone),polarizer:c({},t.polarizer),celestial:w(c({},t.celestial),{radiant:t.celestial.radiant?[t.celestial.radiant[0],t.celestial.radiant[1]]:null})})}get camera(){return this.cam}set(t){this.applyConditions(t),this.wantRunning&&!this.raf&&this.reducedMotion&&(this.animator.jump(this.target),this.draw(performance.now()))}jump(t={}){this.applyConditions(t),this.animator.jump(this.target),this.draw(performance.now())}applyConditions(t){this.conditions=c(c({},this.conditions),t),this.target=Ie(this.conditions),t.camera&&(this.cam=De(c(c({},this.cam),t.camera)))}resize(){var i;let t=(i=this.opts.resolutionScale)!=null?i:Dt(),e=this.canvas.clientWidth||this.canvas.width,o=this.canvas.clientHeight||this.canvas.height;this.renderer.resize(Math.max(1,Math.round(e*t)),Math.max(1,Math.round(o*t)))}start(){if(this.available){if(this.wantRunning=!0,this.reducedMotion){this.jump();return}this.startLoop()}}stop(){this.wantRunning=!1,this.stopLoop()}startLoop(){if(this.raf)return;let t=performance.now();this.startedAt||(this.startedAt=t),this.last=t;let e=o=>{var s;this.raf=requestAnimationFrame(e);let i=1e3/((s=this.opts.fps)!=null?s:30),a=o-this.lastDraw;a<i||(this.lastDraw=o-a%i,this.draw(o))};this.raf=requestAnimationFrame(e)}stopLoop(){this.raf&&(cancelAnimationFrame(this.raf),this.raf=0)}draw(t){this.startedAt||(this.startedAt=t,this.last=t);let e=Math.min(.2,(t-this.last)/1e3);this.last=t,this.animator.step(this.target,e),this.reducedMotion&&(this.animator.current.celestial.meteors=0),this.renderer.render((t-this.startedAt)/1e3,this.animator.current,this.cam,this.animator.wind,this.animator.evolution)}dispose(t={}){var e,o;this.stop(),(e=this.observer)==null||e.disconnect(),this.observer=null,(o=this.motionQuery)==null||o.removeEventListener("change",this.onMotionChange),this.motionQuery=null,this.renderer.dispose(t)}};function ve(t,e){let o={};for(let i of Object.keys(t))o[i]=e(t[i]);return o}var _a={en:ve(ee,t=>t.label),ja:{clear:"\u5FEB\u6674",fair:"\u6674\u308C",summer:"\u590F\u7A7A",overcast:"\u66C7\u308A",fog:"\u9727",rain:"\u96E8",thunderstorm:"\u96F7\u96E8",snow:"\u96EA",typhoon:"\u53F0\u98A8"}},Sa={en:ve(D,t=>t.label),ja:{none:"\u306A\u3057",sepia:"\u30BB\u30D4\u30A2",mono:"\u30E2\u30CE\u30AF\u30ED\u30FC\u30E0",faded:"\u892A\u8272",cyanotype:"\u9752\u306E\u8A18\u61B6",gold:"\u9EC4\u660F",ash:"\u7070"}},Ca={en:ve(me,t=>({label:t.label,alias:t.alias})),ja:{cirrus:{label:"\u5DFB\u96F2",alias:"\u3059\u3058\u96F2"},cirrostratus:{label:"\u5DFB\u5C64\u96F2",alias:"\u3046\u3059\u96F2"},cirrocumulus:{label:"\u5DFB\u7A4D\u96F2",alias:"\u3046\u308D\u3053\u96F2\u30FB\u3044\u308F\u3057\u96F2"},altostratus:{label:"\u9AD8\u5C64\u96F2",alias:"\u304A\u307C\u308D\u96F2"},altocumulus:{label:"\u9AD8\u7A4D\u96F2",alias:"\u3072\u3064\u3058\u96F2"},nimbostratus:{label:"\u4E71\u5C64\u96F2",alias:"\u3042\u307E\u96F2"},stratus:{label:"\u5C64\u96F2",alias:"\u304D\u308A\u96F2"},stratocumulus:{label:"\u5C64\u7A4D\u96F2",alias:"\u304F\u3082\u308A\u96F2"},cumulus:{label:"\u7A4D\u96F2",alias:"\u308F\u305F\u96F2"},cumulonimbus:{label:"\u7A4D\u4E71\u96F2",alias:"\u5165\u9053\u96F2"}}};var Ot={latitude:37.8991768,longitude:-122.4949685},p={0:{cloudCover:0,precipitation:0,windSpeed:2,visibility:45,thunder:0},1:{cloudCover:.22,precipitation:0,windSpeed:3,visibility:35,thunder:0},2:{cloudCover:.45,precipitation:0,windSpeed:4,visibility:30,thunder:0},3:{cloudCover:.92,precipitation:0,windSpeed:5,visibility:18,thunder:0},45:{cloudCover:.75,precipitation:0,windSpeed:1,visibility:.6,thunder:0},48:{cloudCover:.78,precipitation:0,windSpeed:1,visibility:.4,thunder:0},51:{cloudCover:.6,precipitation:1,windSpeed:3,visibility:8,thunder:0,precipitationType:"rain"},53:{cloudCover:.68,precipitation:3,windSpeed:4,visibility:6,thunder:0,precipitationType:"rain"},55:{cloudCover:.75,precipitation:6,windSpeed:5,visibility:4,thunder:0,precipitationType:"rain"},56:{cloudCover:.7,precipitation:2,windSpeed:3,visibility:3,thunder:0,precipitationType:"rain"},57:{cloudCover:.76,precipitation:5,windSpeed:4,visibility:2,thunder:0,precipitationType:"rain"},61:{cloudCover:.78,precipitation:4,windSpeed:5,visibility:8,thunder:0,precipitationType:"rain"},63:{cloudCover:.85,precipitation:10,windSpeed:6,visibility:6,thunder:0,precipitationType:"rain"},65:{cloudCover:.92,precipitation:22,windSpeed:8,visibility:4,thunder:0,precipitationType:"rain"},66:{cloudCover:.85,precipitation:6,windSpeed:5,visibility:2,thunder:0,precipitationType:"rain"},67:{cloudCover:.9,precipitation:14,windSpeed:7,visibility:1,thunder:0,precipitationType:"rain"},71:{cloudCover:.78,precipitation:1.5,windSpeed:4,visibility:3,thunder:0,precipitationType:"snow"},73:{cloudCover:.85,precipitation:4,windSpeed:5,visibility:2,thunder:0,precipitationType:"snow"},75:{cloudCover:.92,precipitation:10,windSpeed:7,visibility:1,thunder:0,precipitationType:"snow"},77:{cloudCover:.7,precipitation:.8,windSpeed:5,visibility:2,thunder:0,precipitationType:"snow"},80:{cloudCover:.55,precipitation:4,windSpeed:5,visibility:10,thunder:0,precipitationType:"rain"},81:{cloudCover:.65,precipitation:10,windSpeed:6,visibility:8,thunder:0,precipitationType:"rain"},82:{cloudCover:.75,precipitation:30,windSpeed:8,visibility:5,thunder:0,precipitationType:"rain"},85:{cloudCover:.55,precipitation:2,windSpeed:5,visibility:4,thunder:0,precipitationType:"snow"},86:{cloudCover:.7,precipitation:12,windSpeed:7,visibility:2,thunder:0,precipitationType:"snow"},95:{cloudCover:.96,precipitation:25,windSpeed:10,visibility:5,thunder:1,precipitationType:"rain"},96:{cloudCover:.97,precipitation:30,windSpeed:12,visibility:4,thunder:1,precipitationType:"rain",convection:.85},99:{cloudCover:.99,precipitation:45,windSpeed:15,visibility:3,thunder:1,precipitationType:"rain",convection:.95}},Wt={"clear-day":w(c({},p[0]),{overlay:"clear-day",cloudCover:.03,windSpeed:3}),"clear-night":w(c({},p[0]),{overlay:"clear-night",cloudCover:0,windSpeed:2}),"mostly-clear-day":w(c({},p[1]),{overlay:"clear-day",cloudCover:.15,windSpeed:3}),"mostly-clear-night":w(c({},p[1]),{overlay:"clear-night",cloudCover:.1,windSpeed:2}),"partly-cloudy-day":p[2],"partly-cloudy-night":p[2],"mostly-cloudy-day":w(c({},p[3]),{cloudCover:.78}),"mostly-cloudy-night":w(c({},p[3]),{cloudCover:.78}),overcast:p[3],fog:w(c({},p[45]),{overlay:"fog-bank"}),drizzle:p[53],rain:p[63],"rain-heavy":p[65],"freezing-rain":p[67],snow:p[73],"snow-heavy":p[75],"snow-grains":p[77],"rain-showers":p[81],"snow-showers":p[86],thunderstorm:p[95],"thunderstorm-hail":p[99]},Bt={tornado:{cloudCover:1,precipitation:60,windSpeed:75,visibility:.2,thunder:1,convection:1,precipitationType:"rain",overlay:"tornado",label:"Tornado"},waterspout:{cloudCover:.98,precipitation:45,windSpeed:55,visibility:.5,thunder:1,convection:.95,precipitationType:"rain",overlay:"tornado",label:"Waterspout"},hurricane:{cloudCover:1,precipitation:90,windSpeed:60,visibility:.2,thunder:.9,convection:1,precipitationType:"rain",overlay:"hurricane",label:"Hurricane"},"tropical-storm":{cloudCover:1,precipitation:45,windSpeed:35,visibility:.5,thunder:.7,convection:.8,precipitationType:"rain",overlay:"rain",label:"Tropical Storm"},derecho:{cloudCover:1,precipitation:40,windSpeed:50,visibility:1,thunder:1,convection:.95,precipitationType:"rain",overlay:"lightning",label:"Derecho"},squall:{cloudCover:.95,precipitation:25,windSpeed:30,visibility:2,thunder:.8,convection:.7,precipitationType:"rain",overlay:"rain",label:"Squall"},blizzard:{cloudCover:1,precipitation:20,windSpeed:28,visibility:.1,thunder:0,convection:0,precipitationType:"snow",overlay:"snow-blizzard",label:"Blizzard"},"ice-storm":{cloudCover:.95,precipitation:18,windSpeed:12,visibility:.5,thunder:0,convection:0,precipitationType:"rain",overlay:"ice",label:"Ice Storm"},sandstorm:{cloudCover:.95,precipitation:0,windSpeed:25,visibility:.05,thunder:0,convection:0,overlay:"sand",label:"Sandstorm"},"dust-storm":{cloudCover:.92,precipitation:0,windSpeed:20,visibility:.1,thunder:0,convection:0,overlay:"dust",label:"Dust Storm"},"volcanic-ash":{cloudCover:.95,precipitation:0,windSpeed:8,visibility:.3,thunder:0,convection:0,overlay:"ash",label:"Volcanic Ash"},"wildfire-smoke":{cloudCover:.9,precipitation:0,windSpeed:6,visibility:1,thunder:0,convection:0,overlay:"smoke",label:"Wildfire Smoke"},"forest-fire":{cloudCover:.88,precipitation:0,windSpeed:8,visibility:.5,thunder:0,convection:0,overlay:"fire",label:"Forest Fire"},smoke:{cloudCover:.8,precipitation:0,windSpeed:4,visibility:1.5,thunder:0,convection:0,overlay:"smoke",label:"Smoke"},ash:{cloudCover:.85,precipitation:0,windSpeed:5,visibility:.4,thunder:0,convection:0,overlay:"ash",label:"Ash"},haze:{cloudCover:.35,precipitation:0,windSpeed:3,visibility:5,thunder:0,convection:0,overlay:"haze",label:"Haze"},smog:{cloudCover:.55,precipitation:0,windSpeed:2,visibility:2,thunder:0,convection:0,overlay:"smoke",label:"Smog"},"acid-rain":{cloudCover:.8,precipitation:12,windSpeed:6,visibility:5,thunder:.2,convection:0,precipitationType:"rain",overlay:"acid-rain",label:"Acid Rain"},"flash-flood":{cloudCover:.85,precipitation:50,windSpeed:10,visibility:2,thunder:.4,convection:.5,precipitationType:"rain",overlay:"rain",label:"Flash Flood"},aurora:{cloudCover:.2,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"aurora",label:"Aurora"},eclipse:{cloudCover:.1,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"eclipse",label:"Solar Eclipse"},rainbow:{cloudCover:.3,precipitation:0,windSpeed:4,visibility:35,thunder:0,convection:0,overlay:"rainbow",label:"Rainbow"},"meteor-shower":{cloudCover:.15,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"meteors",label:"Meteor Shower"},"meteor-impact":{cloudCover:.25,precipitation:0,windSpeed:6,visibility:30,thunder:.6,convection:0,overlay:"meteor-impact",label:"Meteor Impact"},"asteroid-impact":{cloudCover:.6,precipitation:0,windSpeed:20,visibility:10,thunder:1,convection:.5,overlay:"meteor-impact",label:"Asteroid Impact"},earthquake:{cloudCover:.5,precipitation:0,windSpeed:4,visibility:20,thunder:0,convection:0,overlay:"earthquake",label:"Earthquake"},tsunami:{cloudCover:.85,precipitation:0,windSpeed:15,visibility:2,thunder:.2,convection:0,overlay:"tsunami",label:"Tsunami"},"volcanic-eruption":{cloudCover:1,precipitation:0,windSpeed:12,visibility:.05,thunder:.8,convection:.9,overlay:"volcano",label:"Volcanic Eruption"},landslide:{cloudCover:.65,precipitation:5,windSpeed:8,visibility:2,thunder:0,convection:0,overlay:"landslide",label:"Landslide"},mudslide:{cloudCover:.7,precipitation:15,windSpeed:10,visibility:1,thunder:0,convection:0,overlay:"mudslide",label:"Mudslide"},avalanche:{cloudCover:.8,precipitation:8,windSpeed:12,visibility:.5,thunder:0,convection:0,precipitationType:"snow",overlay:"avalanche",label:"Avalanche"},rockfall:{cloudCover:.4,precipitation:0,windSpeed:6,visibility:5,thunder:0,convection:0,overlay:"rockfall",label:"Rockfall"},"geological-event":{cloudCover:.55,precipitation:0,windSpeed:5,visibility:10,thunder:0,convection:0,overlay:"earthquake",label:"Geological Event"},apocalypse:{cloudCover:1,precipitation:80,windSpeed:40,visibility:.05,thunder:1,convection:1,precipitationType:"rain",overlay:"tornado",label:"Apocalypse"}},Nt=c(c({},Wt),Bt),ge=class{constructor(e){this.canvas=document.createElement("canvas"),this.canvas.id="fx-overlay",this.canvas.style.cssText="position:absolute;inset:0;width:100%;height:100%;pointer-events:none;z-index:1",e.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),this.effect=null,this.t=0,this.w=0,this.h=0,this.particles=[],this.lastTick=0,this.dpr=Math.min(typeof window!="undefined"&&window.devicePixelRatio||1,1.5)*.5,this.fps=20,this.resize(),window.addEventListener("resize",()=>this.resize()),this._tick()}resize(){this.w=this.canvas.clientWidth||window.innerWidth,this.h=this.canvas.clientHeight||window.innerHeight,this.canvas.width=Math.floor(this.w*this.dpr),this.canvas.height=Math.floor(this.h*this.dpr),this.ctx.setTransform(this.dpr,0,0,this.dpr,0,0)}setEffect(e){if(this.effect=e||null,this.t=0,this.particles=[],e&&["clear-day","clear-night","sand","dust","ash","smoke","haze","snow-blizzard","volcano","landslide","mudslide","avalanche","rockfall","earthquake","tsunami","acid-rain","fire"].includes(e)){let i={"clear-day":35,"clear-night":60,sand:300,dust:250,ash:200,smoke:150,haze:100,"snow-blizzard":400,volcano:300,landslide:250,mudslide:300,avalanche:400,rockfall:200,earthquake:250,tsunami:0,"acid-rain":120,fire:150}[e]||300;for(let a=0;a<i;a++)this.particles.push(this._newParticle(e))}let o=document.querySelector(".ww");o&&(o.style.transition="none",o.style.transform="")}_rand(e,o){return e+Math.random()*(o-e)}_newParticle(e){let o=this.w,i=this.h;switch(e){case"clear-day":return{x:this._rand(0,o),y:this._rand(0,i),r:this._rand(.8,2.2),v:this._rand(.2,.6),vy:this._rand(-.1,.1),op:this._rand(.15,.35),life:this._rand(120,240),type:"clear-day"};case"clear-night":return{x:this._rand(0,o),y:this._rand(0,i*.6),r:this._rand(.6,1.6),v:this._rand(.05,.15),vy:this._rand(-.03,.03),op:this._rand(.25,.7),life:this._rand(80,180),twinkle:this._rand(.5,1.2),phase:this._rand(0,Math.PI*2),type:"clear-night"};case"sand":case"dust":return{x:this._rand(-o,o),y:this._rand(0,i),r:this._rand(1,3),v:this._rand(12,25),vy:this._rand(-1,1),op:this._rand(.4,.9)};case"ash":return{x:this._rand(0,o),y:this._rand(-i,0),r:this._rand(1,4),v:this._rand(2,6),vy:this._rand(2,8),op:this._rand(.3,.8)};case"smoke":case"haze":return{x:this._rand(-o,o),y:this._rand(0,i),r:this._rand(20,80),v:this._rand(4,10),vy:this._rand(-.5,.5),op:this._rand(.05,.2),grow:this._rand(.2,.8)};case"snow-blizzard":return{x:this._rand(0,o),y:this._rand(-i,i),r:this._rand(1,3),v:this._rand(18,35),vy:this._rand(4,10),op:this._rand(.5,.95)};case"volcano":return{x:this._rand(o*.45,o*.55),y:this._rand(i*.55,i*.75),r:this._rand(2,6),v:this._rand(-2,6),vy:this._rand(-6,-1),op:this._rand(.4,.9),life:this._rand(20,80)};case"landslide":case"mudslide":return{x:this._rand(-100,o),y:this._rand(-50,i*.6),r:this._rand(3,10),v:this._rand(3,10),vy:this._rand(2,8),op:this._rand(.5,.9)};case"avalanche":return{x:this._rand(0,o),y:this._rand(-i,0),r:this._rand(2,6),v:this._rand(10,25),vy:this._rand(8,18),op:this._rand(.5,.95)};case"rockfall":return{x:this._rand(-50,o+50),y:this._rand(-i*.5,0),r:this._rand(3,12),v:this._rand(-2,4),vy:this._rand(4,14),op:this._rand(.5,.9),rot:this._rand(0,Math.PI*2),rotv:this._rand(-.2,.2)};case"earthquake":return{x:this._rand(0,o),y:this._rand(i*.6,i),r:this._rand(1,4),v:this._rand(-1,1),vy:this._rand(-1,-3),op:this._rand(.3,.7),life:this._rand(10,50)};case"acid-rain":return{x:this._rand(0,o),y:this._rand(0,i),len:this._rand(14,28),v:this._rand(9,16),op:this._rand(.35,.75)};case"fire":return{x:this._rand(0,o),y:this._rand(i*.55,i),r:this._rand(2,7),v:this._rand(-1,2),vy:this._rand(-3,-.5),op:this._rand(.4,.9),life:this._rand(20,70)};default:return{}}}_tick(e){let o=e||performance.now(),i=1e3/this.fps;if(o-this.lastTick<i){requestAnimationFrame(n=>this._tick(n));return}this.lastTick=o-(o-this.lastTick)%i,this.t++;let{ctx:a,w:s,h:r}=this;a.clearRect(0,0,s,r),this.effect==="tornado"?this._drawTornado(a,s,r):this.effect==="hurricane"?this._drawHurricane(a,s,r):this.effect==="lightning"?this._drawLightningBolts(a,s,r):this.effect==="ice"?this._drawIce(a,s,r):this.effect==="aurora"?this._drawAurora(a,s,r):this.effect==="eclipse"?this._drawEclipse(a,s,r):this.effect==="rainbow"?this._drawRainbow(a,s,r):this.effect==="meteors"?this._drawMeteors(a,s,r):this.effect==="meteor-impact"?this._drawMeteorImpact(a,s,r):this.effect==="earthquake"?this._drawEarthquake(a,s,r):this.effect==="tsunami"?this._drawTsunami(a,s,r):this.effect==="volcano"?this._drawVolcano(a,s,r):this.effect==="landslide"?this._drawLandslide(a,s,r):this.effect==="mudslide"?this._drawMudslide(a,s,r):this.effect==="avalanche"?this._drawAvalanche(a,s,r):this.effect==="rockfall"?this._drawRockfall(a,s,r):this.effect==="acid-rain"?this._drawAcidRain(a,s,r):this.effect==="fire"?this._drawFire(a,s,r):this.effect==="fog-bank"?this._drawFogBank(a,s,r):this.effect==="clear-day"?this._drawClearDay(a,s,r):this.effect==="clear-night"?this._drawClearNight(a,s,r):this.particles.length&&this._drawParticles(a,s,r),requestAnimationFrame(n=>this._tick(n))}_drawTornado(e,o,i){let a=o*.5,s=i*.95,r=this.t*.04;e.save(),e.globalCompositeOperation="source-over";let n=e.createLinearGradient(a,s,a,0);n.addColorStop(0,"rgba(20,20,25,0.9)"),n.addColorStop(.45,"rgba(60,60,70,0.5)"),n.addColorStop(1,"rgba(120,120,130,0)"),e.fillStyle=n,e.beginPath();for(let l=i;l>=0;l-=4){let h=1-l/i,d=140*(1-h)+12*h,u=Math.sin(r+l*.03)*(10*(1-h)+2);e.lineTo(a+u+d*.5,l)}for(let l=0;l<=i;l+=4){let h=l/i,d=140*h+12*(1-h),u=Math.sin(r+l*.03)*(10*h+2);e.lineTo(a+u-d*.5,l)}e.closePath(),e.fill(),e.globalCompositeOperation="screen";for(let l=0;l<40;l++){let h=r+l*.35,d=80+Math.sin(this.t*.1+l)*20,u=a+Math.cos(h)*d,g=s-20+Math.sin(h)*10;e.fillStyle=`rgba(180,170,160,${.3+Math.random()*.3})`,e.beginPath(),e.arc(u,g,1.5+Math.random()*2,0,Math.PI*2),e.fill()}e.restore()}_drawHurricane(e,o,i){let a=o*.5,s=i*.45,r=this.t*.015;e.save(),e.globalCompositeOperation="source-over";for(let l=0;l<4;l++){let h=r+l*(Math.PI/2);e.strokeStyle="rgba(60,60,70,0.35)",e.lineWidth=18,e.beginPath();for(let d=40;d<Math.max(o,i)*.8;d+=8){let u=h+d*.018,g=a+Math.cos(u)*d,b=s+Math.sin(u)*d;d===40?e.moveTo(g,b):e.lineTo(g,b)}e.stroke()}let n=e.createRadialGradient(a,s,5,a,s,45);n.addColorStop(0,"rgba(200,190,170,0.9)"),n.addColorStop(.6,"rgba(90,85,80,0.6)"),n.addColorStop(1,"rgba(40,40,45,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,45,0,Math.PI*2),e.fill(),e.restore()}_drawLightningBolts(e,o,i){if(Math.random()>.03)return;e.save(),e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,250,220,0.95)",e.lineWidth=2+Math.random()*3,e.shadowColor="#fff8c5",e.shadowBlur=20;let a=this._rand(o*.2,o*.8);e.beginPath(),e.moveTo(a,0);let s=a,r=0;for(;r<i*.6;)s+=this._rand(-30,30),r+=this._rand(15,40),e.lineTo(s,r);e.stroke(),e.restore()}_drawIce(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let a=0;a<30;a++){let s=(this.t*.5+a*137)%(o+60)-30,r=a*79%(i+40)-20,n=8+a%7;e.strokeStyle=`rgba(200,230,255,${.15+a%5*.05})`,e.lineWidth=1,e.beginPath();for(let l=0;l<6;l++){let h=l*Math.PI/3+this.t*.02+a,d=n*.5,u=n;e.moveTo(s+Math.cos(h)*d,r+Math.sin(h)*d),e.lineTo(s+Math.cos(h)*u,r+Math.sin(h)*u)}e.stroke()}e.restore()}_drawAurora(e,o,i){e.save(),e.globalCompositeOperation="screen";let a=[{hue:140,baseY:.16,amp:55,speed:.015,thickness:110},{hue:165,baseY:.26,amp:70,speed:.011,thickness:130},{hue:195,baseY:.36,amp:50,speed:.02,thickness:90}];for(let s of a){let r=i*s.baseY,n=10;for(let l=0;l<=o;l+=n){let h=r+Math.sin(l*.012+this.t*s.speed)*s.amp+Math.sin(l*.004+this.t*s.speed*.6)*s.amp*.6,d=.55+.45*Math.sin(l*.05+this.t*.08),u=e.createLinearGradient(0,h-s.thickness*.5,0,h+s.thickness*.5);u.addColorStop(0,`hsla(${s.hue}, 85%, 65%, 0)`),u.addColorStop(.5,`hsla(${s.hue}, 85%, 65%, ${.22*d})`),u.addColorStop(1,`hsla(${s.hue}, 85%, 65%, 0)`),e.fillStyle=u,e.fillRect(l,h-s.thickness*.5,n+2,s.thickness)}}e.restore()}_drawEclipse(e,o,i){let a=o*.5,s=i*.25,r=Math.min(o,i)*.12;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.9,a,s,r*1.6);n.addColorStop(0,"rgba(255,240,200,0.9)"),n.addColorStop(.5,"rgba(255,220,120,0.4)"),n.addColorStop(1,"rgba(255,200,80,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*1.6,0,Math.PI*2),e.fill(),e.fillStyle="rgba(10,10,12,0.85)",e.beginPath(),e.arc(a+r*.15,s,r,0,Math.PI*2),e.fill(),e.restore()}_drawRainbow(e,o,i){let a=o*.5,s=i*.95,r=Math.min(o,i)*.75;e.save(),e.globalCompositeOperation="screen";let n=["#ff0000","#ff7f00","#ffff00","#00ff00","#0000ff","#4b0082","#9400d3"];for(let l=0;l<n.length;l++){let h=r-l*8;e.strokeStyle=n[l],e.lineWidth=7,e.globalAlpha=.55,e.beginPath(),e.arc(a,s,h,Math.PI,0),e.stroke()}e.restore()}_drawFogBank(e,o,i){e.save(),e.globalCompositeOperation="source-over";let a=5;for(let r=0;r<a;r++){let n=i*(.25+r*.16),l=Math.sin(this.t*.006+r*1.7)*40,h=Math.sin(this.t*.01+r)*12,d=e.createLinearGradient(0,n-60+h,0,n+60+h);d.addColorStop(0,"rgba(235,238,242,0)"),d.addColorStop(.5,`rgba(235,238,242,${.22-r*.02})`),d.addColorStop(1,"rgba(235,238,242,0)"),e.fillStyle=d,e.fillRect(l-100,0,o+200,i)}let s=e.createLinearGradient(0,0,0,i);s.addColorStop(0,"rgba(240,242,246,0.06)"),s.addColorStop(1,"rgba(240,242,246,0.28)"),e.fillStyle=s,e.fillRect(0,0,o,i),e.restore()}_drawParticles(e,o,i){let a=this.effect;if(e.save(),a==="sand"||a==="dust"){e.fillStyle=a==="sand"?"rgba(194,160,120,":"rgba(160,150,130,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.x>o+50&&(s.x=-50,s.y=this._rand(0,i)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.globalAlpha=a==="sand"?.25:.18,e.fillStyle=a==="sand"?"#c2a078":"#a69b8a",e.fillRect(0,0,o,i)}else if(a==="ash"){e.fillStyle="rgba(60,55,55,";for(let s of this.particles)s.x+=Math.sin(this.t*.02+s.y*.01)*.5,s.y+=s.vy,s.y>i+10&&(s.y=-10,s.x=this._rand(0,o)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.globalAlpha=.15,e.fillStyle="#6b2e1d",e.fillRect(0,0,o,i)}else if(a==="smoke"||a==="haze")for(let s of this.particles){s.x+=s.v,s.y+=s.vy,s.r+=s.grow,s.x>o+s.r&&(s.x=-s.r,s.y=this._rand(0,i),s.r=this._rand(20,80));let r=a==="smoke"?"80,70,60":"120,110,100";e.fillStyle=`rgba(${r},${s.op})`,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill()}else if(a==="snow-blizzard"){e.fillStyle="rgba(255,250,240,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.x>o+20&&(s.x=-20,s.y=this._rand(0,i)),s.y>i+20&&(s.y=-20,s.x=this._rand(0,o)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill()}e.restore()}_drawMeteors(e,o,i){e.save(),e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,255,240,0.9)",e.lineWidth=2,e.shadowColor="#fff",e.shadowBlur=6;for(let a=0;a<5;a++){if(Math.random()>.25)continue;let s=this._rand(o*.1,o*.9),r=this._rand(0,i*.4),n=this._rand(40,120),l=this._rand(Math.PI*.2,Math.PI*.8);e.beginPath(),e.moveTo(s,r),e.lineTo(s+Math.cos(l)*n,r+Math.sin(l)*n),e.stroke()}e.restore()}_drawMeteorImpact(e,o,i){e.save();let a=this.t;a<40&&(e.globalCompositeOperation="screen",e.fillStyle=`rgba(255,240,200,${Math.max(0,.9-a/40)})`,e.fillRect(0,0,o,i));let s=a*3%300;e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,220,160,0.4)",e.lineWidth=3,e.beginPath(),e.arc(o*.5,i*.3,s,0,Math.PI*2),e.stroke(),e.strokeStyle="rgba(255,160,60,0.85)",e.lineWidth=4,e.shadowColor="#ff8a00",e.shadowBlur=15;let r=o*.5+a*.4,n=i*.3+a*.9;e.beginPath(),e.moveTo(r,n),e.lineTo(r-40,n-90),e.stroke(),e.restore()}_drawEarthquake(e,o,i){let a=document.querySelector(".ww");if(a){let s=(Math.random()-.5)*6,r=(Math.random()-.5)*4;a.style.transform=`translate(${s}px, ${r}px)`}e.save(),e.fillStyle="rgba(120,110,100,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.life--,s.life<=0&&(s.x=this._rand(0,o),s.y=this._rand(i*.7,i),s.life=this._rand(10,50)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.strokeStyle="rgba(30,25,20,0.6)",e.lineWidth=2,e.beginPath(),e.moveTo(o*.2,i),e.lineTo(o*.35,i*.82),e.lineTo(o*.5,i*.88),e.lineTo(o*.8,i),e.stroke(),e.restore()}_drawTsunami(e,o,i){e.save(),e.globalCompositeOperation="source-over",e.fillStyle="rgba(10,25,40,0.35)",e.fillRect(0,0,o,i);let a=i*.55+Math.sin(this.t*.03)*20,s=e.createLinearGradient(0,i-a,0,i);s.addColorStop(0,"rgba(20,60,90,0.7)"),s.addColorStop(.6,"rgba(10,40,70,0.9)"),s.addColorStop(1,"rgba(5,25,50,0.95)"),e.fillStyle=s,e.beginPath(),e.moveTo(0,i);for(let r=0;r<=o;r+=20){let n=i-a+Math.sin(r*.02+this.t*.06)*25;e.lineTo(r,n)}e.lineTo(o,i),e.closePath(),e.fill(),e.strokeStyle="rgba(220,240,255,0.6)",e.lineWidth=5,e.beginPath();for(let r=0;r<=o;r+=20){let n=i-a+Math.sin(r*.02+this.t*.06)*25;r===0?e.moveTo(r,n):e.lineTo(r,n)}e.stroke(),e.restore()}_drawVolcano(e,o,i){e.save();let a=o*.5,s=i*.62;e.fillStyle="rgba(20,15,12,0.95)",e.beginPath(),e.moveTo(0,i),e.lineTo(a,s),e.lineTo(o,i),e.closePath(),e.fill();let r=e.createRadialGradient(a,s,4,a,s-120,90);r.addColorStop(0,"rgba(60,55,50,0.95)"),r.addColorStop(.5,"rgba(90,80,70,0.7)"),r.addColorStop(1,"rgba(120,110,100,0)"),e.fillStyle=r,e.beginPath(),e.arc(a,s-60,100+Math.sin(this.t*.05)*20,0,Math.PI*2),e.fill(),e.globalCompositeOperation="screen";for(let n of this.particles)n.x+=n.v,n.y+=n.vy,n.vy+=.15,(n.y>i||n.life--<=0)&&(n.x=this._rand(o*.48,o*.52),n.y=this._rand(i*.58,i*.65),n.vy=this._rand(-6,-1),n.v=this._rand(-2,4),n.life=this._rand(20,80)),e.fillStyle=`rgba(255,${Math.floor(80+Math.random()*80)},30,${n.op})`,e.shadowColor="#ff4500",e.shadowBlur=8,e.beginPath(),e.arc(n.x,n.y,n.r,0,Math.PI*2),e.fill();e.globalCompositeOperation="source-over",e.fillStyle="rgba(80,70,65,0.18)",e.fillRect(0,0,o,i),e.restore()}_drawLandslide(e,o,i){e.save(),e.fillStyle="rgba(90,75,55,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,(a.x>o+50||a.y>i+50)&&(a.x=this._rand(-100,o),a.y=this._rand(-50,i*.5)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.25,e.fillStyle="#5c4a35",e.beginPath(),e.moveTo(0,i*.45),e.lineTo(o,i*.35),e.lineTo(o,i),e.lineTo(0,i),e.closePath(),e.fill(),e.restore()}_drawMudslide(e,o,i){e.save(),e.fillStyle="rgba(75,60,45,";for(let a of this.particles)a.x+=a.v*1.2,a.y+=a.vy*1.2,(a.x>o+50||a.y>i+50)&&(a.x=this._rand(-100,o),a.y=this._rand(-50,i*.5)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.35,e.fillStyle="#4a3b2a",e.fillRect(0,i*.5,o,i*.5),e.restore()}_drawAvalanche(e,o,i){e.save(),e.fillStyle="rgba(245,245,255,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,a.y>i+20&&(a.y=this._rand(-i,0),a.x=this._rand(0,o)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.3,e.fillStyle="#e8eef5",e.beginPath(),e.moveTo(0,0),e.lineTo(o,0),e.lineTo(o,i*.55),e.lineTo(0,i*.65),e.closePath(),e.fill(),e.restore()}_drawRockfall(e,o,i){e.save(),e.fillStyle="rgba(90,85,80,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,a.rot+=a.rotv,a.vy+=.2,a.y>i+20&&(a.y=this._rand(-i*.5,0),a.x=this._rand(-50,o+50),a.vy=this._rand(4,14)),e.globalAlpha=a.op,e.save(),e.translate(a.x,a.y),e.rotate(a.rot),e.fillRect(-a.r,-a.r,a.r*2,a.r*2),e.restore();e.restore()}_drawAcidRain(e,o,i){e.save(),e.globalCompositeOperation="source-over",e.fillStyle="rgba(160,180,60,0.15)",e.fillRect(0,0,o,i);for(let a of this.particles)a.y+=a.v,a.y>i+20&&(a.y=-10,a.x=this._rand(0,o)),e.strokeStyle=`rgba(200,230,80,${a.op})`,e.lineWidth=2,e.lineCap="round",e.beginPath(),e.moveTo(a.x,a.y),e.lineTo(a.x-2,a.y+a.len),e.stroke();e.restore()}_drawFire(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.vy+=.05,a.life--,(a.life<=0||a.y<i*.3)&&(a.x=this._rand(o*.1,o*.9),a.y=this._rand(i*.7,i),a.vy=this._rand(-3,-.5),a.v=this._rand(-1,1),a.life=this._rand(20,70));let s=a.r*(a.life/70);e.fillStyle=`rgba(255,${Math.floor(100+Math.random()*100)},30,${a.op})`,e.shadowColor="#ff6b00",e.shadowBlur=10,e.beginPath(),e.arc(a.x,a.y,s,0,Math.PI*2),e.fill()}e.globalCompositeOperation="source-over",e.fillStyle="rgba(60,55,50,0.2)",e.fillRect(0,0,o,i),e.restore()}_drawClearDay(e,o,i){e.save(),e.globalCompositeOperation="source-over";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.life--,(a.x>o+20||a.y<-20||a.life<=0)&&(a.x=this._rand(-20,o),a.y=this._rand(i*.2,i),a.v=this._rand(.3,.8),a.vy=this._rand(-.12,.12),a.life=this._rand(180,360));let s=.7+.3*Math.sin(this.t*.05+a.x*.01);e.globalAlpha=a.op*s,e.fillStyle="#ffffff",e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill(),e.globalAlpha=1}e.restore()}_drawClearNight(e,o,i){e.save(),e.globalCompositeOperation="screen";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.life--;let s=.5+.5*Math.sin(this.t*a.twinkle+a.phase);(a.life<=0||a.y<-10||a.x>o+10)&&(a.x=this._rand(0,o),a.y=this._rand(i*.1,i*.7),a.v=this._rand(.05,.15),a.vy=this._rand(-.05,.05),a.life=this._rand(150,320),a.twinkle=this._rand(.08,.18),a.phase=this._rand(0,Math.PI*2)),e.fillStyle=`rgba(255,245,220,${a.op*s})`,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill()}if(Math.random()<.012){let a=this._rand(o*.1,o*.9),s=this._rand(0,i*.4),r=this._rand(20,60),n=this._rand(Math.PI*.25,Math.PI*.55);e.strokeStyle="rgba(255,245,220,0.8)",e.lineWidth=1.5,e.beginPath(),e.moveTo(a,s),e.lineTo(a-Math.cos(n)*r,s+Math.sin(n)*r),e.stroke()}e.restore()}},G=class{constructor(e,o={},i={}){this.canvas=e,this.colors=o,this.location=i.location||Ot,this.timeOffsetMs=0,this.forceDay=i.forceDay||!1,this.forceNight=i.forceNight||!1,this.currentKey=null,this.currentParams=null,this.overlayEffect=null;let a=e.parentElement;a&&!a.querySelector("#fx-overlay")&&(this.overlay=new ge(a));try{this.sky=new Be(e,{time:this._now(),location:this.location,weather:p[0],resolutionScale:.55,fps:24,colorSpace:"srgb",celestial:{bortle:6,milkyWay:0,meteors:0}})}catch(s){console.error("Atmosphere initialization failed",s),this.sky=null}}_now(){let e=new Date(Date.now()+this.timeOffsetMs);if(!this.forceDay&&!this.forceNight)return e;let o=new Date(e.getFullYear(),e.getMonth(),e.getDate(),12,0,0),i=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0);return this.forceDay?o:i}setSunState(e,o){this.sky&&(this.timeOffsetMs=0,this.sky.set({time:this._now()}))}setCondition(e){this.currentKey=e||"clear-day";let o=Nt[this.currentKey]||p[0];this.currentParams=c({},o),this.currentKey.includes("night")&&this.currentParams.isNightAdjusted,this.currentParams.precipitation>0&&!this.currentParams.precipitationType&&(this.currentParams.precipitationType="rain"),this.sky&&this.sky.set({time:this._now(),weather:{cloudCover:this.currentParams.cloudCover,precipitation:this.currentParams.precipitation,precipitationType:this.currentParams.precipitationType,windSpeed:this.currentParams.windSpeed,visibility:this.currentParams.visibility,thunder:this.currentParams.thunder||0,convection:this.currentParams.convection||0}}),this.overlayEffect=this.currentParams.overlay||null,this.overlay&&this.overlay.setEffect(this.overlayEffect)}setWeatherData(e){e=e||{};let o=this.currentParams||{},i=e.cloudCover,a=e.precipitation,s=e.windSpeed,r=e.visibility,n=e.thunder,l=e.precipitationType;this.sky&&this.sky.set({time:this._now(),weather:{cloudCover:i!=null?i:o.cloudCover!=null?o.cloudCover:0,precipitation:a!=null?a:o.precipitation!=null?o.precipitation:0,windSpeed:s!=null?s:o.windSpeed!=null?o.windSpeed:2,visibility:r!=null?r:o.visibility!=null?o.visibility:45,thunder:n!=null?n:o.thunder!=null?o.thunder:0,precipitationType:l!=null?l:o.precipitationType!=null?o.precipitationType:"rain"}})}dispose(){this.sky&&(this.sky.stop&&this.sky.stop(),this.sky.dispose&&this.sky.dispose()),this.overlay&&this.overlay.canvas.remove()}};window.WeatherAtmosphere=G;var te=37.8991768,ae=-122.4949685,Ne="America/Los_Angeles",Ut=900*1e3;var O=document.documentElement.getAttribute("data-theme")||"day",ye=new URLSearchParams(location.search).get("scene");function y(t){return getComputedStyle(document.documentElement).getPropertyValue(t).trim()}function Ue(t){let e=parseInt(t.slice(1),16);return[e>>16&255,e>>8&255,e&255]}function qt([t,e,o]){return"#"+[t,e,o].map(i=>Math.round(Math.max(0,Math.min(255,i))).toString(16).padStart(2,"0")).join("")}function we(t,e,o){let i=Ue(t),a=Ue(e);return qt([i[0]+(a[0]-i[0])*o,i[1]+(a[1]-i[1])*o,i[2]+(a[2]-i[2])*o])}var Ht=[[0,"#7fa8cf","#ffcf9e","#fff6ea"],[.25,"#5b9bda","#bfe0f0","#eef7fa"],[.55,"#4a90d9","#8ec9ee","#eaf6fc"],[1,"#3f86d4","#8ec9ee","#e8f4fb"]],Gt=[[0,"#140a1e","#3a2210","#0d0800"],[-.15,"#0a0614","#20120a","#050301"],[-.45,"#050308","#0f0803","#000000"],[-1,"#020104","#080402","#000000"]];function $t(t){let e=O==="night"?Gt:Ht,o=O==="night"?-Math.abs(t):Math.abs(t),i=e[0],a=e[e.length-1];for(let n=0;n<e.length-1;n++){let l=e[n],h=e[n+1];if(O==="night"?o<=l[0]&&o>=h[0]:o>=l[0]&&o<=h[0]){i=l,a=h;break}}let s=a[0]-i[0],r=s!==0?(o-i[0])/s:0;return{top:we(i[1],a[1],Math.max(0,Math.min(1,r))),mid:we(i[2],a[2],Math.max(0,Math.min(1,r))),bottom:we(i[3],a[3],Math.max(0,Math.min(1,r)))}}var S=1;function Ge(t){let e=new Date,o=new Date(t.sunrise[S]),i=new Date(t.sunset[S]),a;if(e>=o&&e<=i){let n=(e-o)/(i-o);a={frac:n,elevation:Math.sin(Math.PI*n)}}else if(e<o){let n=new Date(t.sunset[S-1]),l=Math.max(0,Math.min(1,(e-n)/(o-n)));a={frac:l,elevation:-Math.sin(Math.PI*l)}}else{let n=t.sunrise[S+1]?new Date(t.sunrise[S+1]):new Date(i.getTime()+432e5),l=Math.max(0,Math.min(1,(e-i)/(n-i)));a={frac:l,elevation:-Math.sin(Math.PI*l)}}let s=$t(a.elevation),r=document.documentElement;return r.style.setProperty("--sky-top",s.top),r.style.setProperty("--sky-mid",s.mid),r.style.setProperty("--sky-bottom",s.bottom),a}function be(t){return`${Math.round(t)}\xB0`}function jt(t){return t==null?{label:"\u2014",color:"var(--fg3)",desc:"Air quality data is unavailable right now."}:t<=50?{label:"Good",color:"var(--good)",desc:"Air quality is good. Enjoy your usual outdoor activities."}:t<=100?{label:"Moderate",color:"var(--warn)",desc:"Air quality is acceptable, though there may be a risk for sensitive groups."}:t<=150?{label:"Unhealthy (SG)",color:"var(--warn)",desc:"Sensitive groups may experience health effects. Others are unlikely to be affected."}:t<=200?{label:"Unhealthy",color:"var(--bad)",desc:"Everyone may begin to experience health effects; sensitive groups more so."}:t<=300?{label:"Very Unhealthy",color:"var(--bad)",desc:"Health alert: everyone may experience more serious health effects."}:{label:"Hazardous",color:"var(--bad)",desc:"Health warning of emergency conditions. Everyone is at risk."}}function Vt(t){return["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round(t/22.5)%16]}function Yt(t,e){return`<svg viewBox="0 0 100 100">
  ...
  </svg>`}function Kt(t,e){let i=new Date(t).getHours(),a=i>=12?"PM":"AM";return i=i%12,i===0&&(i=12),e?`${i}${a}`:"NOW"}function Zt(t,e){if(!e)return"NOW";let o=new Date(t),i=o.getHours(),a=o.getMinutes().toString().padStart(2,"0"),s=i>=12?"PM":"AM";return i=i%12,i===0&&(i=12),`${i}:${a}`}function Qt(t,e){return e===0?"Today":new Date(t+"T00:00:00").toLocaleDateString("en-US",{weekday:"short"})}function Xt(){return A(this,null,function*(){let e=`https://api.open-meteo.com/v1/forecast?${`latitude=${te}&longitude=${ae}&cell_selection=land&elevation=4`}&current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,weather_code,cloud_cover,wind_speed_10m,wind_direction_10m&minutely_15=temperature_2m,weather_code,precipitation_probability,is_day,cloud_cover&hourly=temperature_2m,weather_code,precipitation_probability,visibility,is_day,cloud_cover&daily=weather_code,temperature_2m_max,temperature_2m_min,precipitation_probability_max,sunrise,sunset,uv_index_max&temperature_unit=fahrenheit&wind_speed_unit=mph&precipitation_unit=inch&timezone=${encodeURIComponent(Ne)}&forecast_days=7&past_days=1`,o=`https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${te}&longitude=${ae}&current=us_aqi&timezone=${encodeURIComponent(Ne)}`,[i,a,s]=yield Promise.all([fetch(e).then(r=>r.json()),fetch(o).then(r=>r.json()).catch(()=>null),sa()]);return{weather:i,aq:a,skyCoverIntervals:s}})}var ke=null,Jt=`https://api.weather.gov/alerts/active?status=actual&point=${te},${ae}`,ea=`https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&latitude=${te}&longitude=${ae}&maxradiuskm=200&minmagnitude=4.0&starttime=`,ta="https://noaa-storm-proxy.iamflying29-sketch.deno.net",aa="https://api.weather.gov/gridpoints/MTR/83,111";function ia(t){let e=/^P(?:(\d+)D)?T(?:(\d+)H)?(?:(\d+)M)?/.exec(t||"");if(!e)return 0;let o=parseInt(e[1]||"0",10),i=parseInt(e[2]||"0",10),a=parseInt(e[3]||"0",10);return((o*24+i)*60+a)*60*1e3}function oa(t){return!t||!Array.isArray(t.values)?[]:t.values.map(e=>{let[o,i]=e.validTime.split("/"),a=new Date(o),s=new Date(a.getTime()+ia(i));return{start:a,end:s,value:e.value}})}function sa(){return A(this,null,function*(){try{let t=yield fetch(aa);if(!t.ok)return null;let e=yield t.json();return oa(e.properties&&e.properties.skyCover)}catch(t){return console.warn("NWS gridpoint skyCover fetch failed",t),null}})}function _e(t,e){if(!t||!t.length)return null;for(let o of t)if(e>=o.start&&e<o.end)return o.value;return null}function ra(t,e){if(!t||!t.length)return null;let o=[];for(let i=9;i<=18;i++){let a=new Date(`${e}T${String(i).padStart(2,"0")}:00:00`),s=_e(t,a);s!=null&&o.push(s)}return o.length?o.reduce((i,a)=>i+a,0)/o.length:null}var na=[{re:/tornado/i,key:"tornado",label:"Tornado Warning",severity:5},{re:/tsunami/i,key:"tsunami",label:"Tsunami Warning",severity:5},{re:/hurricane/i,key:"hurricane",label:"Hurricane Warning",severity:4},{re:/tropical storm/i,key:"tropical-storm",label:"Tropical Storm Warning",severity:4},{re:/flash flood/i,key:"flash-flood",label:"Flash Flood Warning",severity:4},{re:/severe thunderstorm/i,key:"thunderstorm-hail",label:"Severe Thunderstorm Warning",severity:3},{re:/tornado watch|severe thunderstorm watch/i,key:"thunderstorm",label:"Severe Weather Watch",severity:2},{re:/fire weather|red flag/i,key:"wildfire-smoke",label:"Fire Weather Warning",severity:3},{re:/dust storm/i,key:"dust-storm",label:"Dust Storm Warning",severity:3},{re:/blizzard|winter storm/i,key:"blizzard",label:"Winter Storm Warning",severity:3},{re:/ice storm/i,key:"ice-storm",label:"Ice Storm Warning",severity:3},{re:/volcanic/i,key:"volcanic-eruption",label:"Volcanic Warning",severity:4}];function la(t){return{Extreme:4,Severe:3,Moderate:2,Minor:1,Unknown:0}[t]||0}function ha(){return A(this,null,function*(){try{let t=yield fetch(Jt);if(!t.ok)return[];let e=yield t.json();return Array.isArray(e.features)?e.features:[]}catch(t){return console.warn("NWS alerts fetch failed",t),[]}})}function ua(){return A(this,null,function*(){try{let t=new Date(Date.now()-864e5).toISOString(),e=yield fetch(ea+encodeURIComponent(t));if(!e.ok)return null;let o=yield e.json();if(!o.features||!o.features.length)return null;let i=o.features[0];return{magnitude:i.properties.mag,place:i.properties.place,time:i.properties.time}}catch(t){return console.warn("USGS earthquake fetch failed",t),null}})}function da(){return A(this,null,function*(){try{let t=yield fetch(`${ta}?v=1`);return t.ok?yield t.json():null}catch(t){return console.warn("NOAA/NHC storm fetch failed",t),null}})}function ca(t,e,o){let i=null;for(let a of t){let s=a.properties.event||"",r=la(a.properties.severity);for(let n of na)if(n.re.test(s)){let l=n.severity*10+r;(!i||l>i.score)&&(i=w(c({},n),{score:l}))}}return i?{key:i.key,label:i.label,source:"NWS"}:e?{key:"earthquake",label:`Earthquake M${e.magnitude}`,source:"USGS"}:null}function fa(t,e){let{weather:o,aq:i,alerts:a,quake:s,noaaStorms:r,skyCoverIntervals:n}=t,l=o.current,h=o.hourly,d=o.minutely_15,u=o.daily;ke=u;let g=Ge(u);e&&e.setSunState(g.frac,g.elevation);let b=!!l.is_day,C=_e(n,new Date),M=C!=null?C:l.cloud_cover,T=wmoInfo(l.weather_code,b,M),x=ye||T.key;ye&&(T={key:x,label:labelForKey(x)});let P=ye?null:ca(a||[],s,r);P&&(T={key:P.key,label:P.label},x=T.key);let E={theme:O,"--sun-core":y("--sun-core"),"--moon-core":y("--moon-core"),"--cloud":y("--cloud"),"--cloud2":y("--cloud2"),"--rain":y("--rain"),"--snow":y("--snow"),"--fog":y("--fog"),"--bolt":y("--bolt"),"--fg":y("--fg")};document.getElementById("nowIcon").innerHTML=iconSvgFor(x,E),document.getElementById("nowTemp").textContent=be(l.temperature_2m),document.getElementById("nowCond").textContent=T.label,document.getElementById("nowSub").textContent=`Feels like ${be(l.apparent_temperature)}`,document.getElementById("hilo").textContent=`H:${Math.round(u.temperature_2m_max[S])}\xB0  L:${Math.round(u.temperature_2m_min[S])}\xB0`,e&&e.setCondition(x),e&&M!=null&&e.setWeatherData({cloudCover:M/100});let W=d&&d.time&&d.time.length>0,k=W?d:h,$e=o.current.time.slice(0,16),B=k.time.findIndex(m=>m>=$e);B<0&&(B=0);let Se=document.getElementById("hourly");Se.innerHTML="";for(let m=0;m<12;m++){let v=B+m;if(v>=k.time.length)break;let oe=k.is_day?!!k.is_day[v]:!0,se=k.cloud_cover?k.cloud_cover[v]:null,I=_e(n,new Date(k.time[v])),j=wmoInfo(k.weather_code[v],oe,I!=null?I:se),U=k.precipitation_probability?k.precipitation_probability[v]:null,q=document.createElement("div");q.className="ww-hour",q.innerHTML=`
      <div class="hh">${W?Zt(k.time[v],m):Kt(k.time[v],m)}</div>
      ${iconSvgFor(j.key,E)}
      <div class="ht">${Math.round(k.temperature_2m[v])}\xB0</div>
      <div class="hp">${U!=null&&U>=15?U+"%":""}</div>
    `,Se.appendChild(q)}let Ce=document.getElementById("daily");Ce.innerHTML="";let Me=Math.min(...u.temperature_2m_min.slice(S,S+5)),je=Math.max(...u.temperature_2m_max.slice(S,S+5)),ze=Math.max(1,je-Me);for(let m=0;m<5;m++){let v=S+m,oe=ra(n,u.time[v]),se=wmoInfo(u.weather_code[v],!0,oe),I=u.temperature_2m_min[v],j=u.temperature_2m_max[v],U=(I-Me)/ze*100,q=(j-I)/ze*100,Ae=u.precipitation_probability_max[v],re=document.createElement("div");re.className="ww-day-row",re.innerHTML=`
      <div class="dn">${Qt(u.time[v],m)}</div>
      ${iconSvgFor(se.key,E)}
      <div class="ww-bar"><span style="left:${U}%;width:${q}%"></span></div>
      <div class="dp">${Ae>=15?Ae+"%":""}</div>
      <div class="dlo">${Math.round(I)}\xB0</div>
      <div class="dhi">${Math.round(j)}\xB0</div>
    `,Ce.appendChild(re)}let N=i&&i.current?i.current.us_aqi:null,ie=jt(N);document.getElementById("aqiVal").textContent=N!=null?Math.round(N):"\u2014",document.getElementById("aqiVal").style.color=ie.color,document.getElementById("aqiCat").textContent=ie.label,document.getElementById("aqiDesc").textContent=ie.desc;let Ve=N!=null?Math.min(100,N/300*100):0;document.getElementById("aqiMarker").style.left=`${Ve}%`;let Ye=new Date(u.sunrise[S]),Ke=new Date(u.sunset[S]),Te=m=>m.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),Ze=h.visibility&&h.visibility[B]!=null?(h.visibility[B]/1609.34).toFixed(1):"\u2014",R=y("--fg"),Qe=[{icon:WI.uv(R),label:"UV Index",value:Math.round(u.uv_index_max[S]),sub:ma(u.uv_index_max[S])},{icon:WI.sunrise(R),label:"Sunrise",value:Te(Ye),sub:`Sunset ${Te(Ke)}`},{icon:"",label:"Wind",value:`${Math.round(l.wind_speed_10m)} mph`,sub:Vt(l.wind_direction_10m),compass:l.wind_direction_10m},{icon:WI.drop(R),label:"Humidity",value:`${Math.round(l.relative_humidity_2m)}%`,sub:""},{icon:WI.eye(R),label:"Visibility",value:`${Ze} mi`,sub:""},{icon:WI.thermo(R),label:"Feels Like",value:be(l.apparent_temperature),sub:""}],xe=document.getElementById("grid");xe.innerHTML="";for(let m of Qe){let v=document.createElement("div");v.className="ww-card",m.compass!==void 0?v.innerHTML=`<div class="cl">${m.label}</div><div class="ww-compass">${Yt(m.compass,R)}</div><div class="cv" style="font-size:16px">${m.value}</div><div class="cs">${m.sub}</div>`:v.innerHTML=`<div class="cl">${m.icon}${m.label}</div><div class="cv">${m.value}</div><div class="cs">${m.sub}</div>`,xe.appendChild(v)}}function ma(t){return t<3?"Low":t<6?"Moderate":t<8?"High":t<11?"Very High":"Extreme"}var $=null;window.fxEngine=null;function qe(){return A(this,null,function*(){try{let[t,e,o,i]=yield Promise.all([Xt(),ha(),ua(),da()]);fa(w(c({},t),{alerts:e,quake:o,noaaStorms:i}),$)}catch(t){console.error("Weather fetch failed",t)}})}function He(){let t=document.getElementById("fx");$=new G(t,{sunCore:y("--sun-core"),sunGlow:y("--sun-glow"),moonCore:y("--moon-core"),moonGlow:y("--moon-glow"),cloud:y("--cloud"),cloud2:y("--cloud2"),rain:y("--rain"),snow:y("--snow"),fog:y("--fog"),bolt:y("--bolt")},{forceDay:O==="day",forceNight:O==="night"}),window.fxEngine=$,qe(),setInterval(qe,Ut),setInterval(()=>{if(ke){let e=Ge(ke);$&&$.setSunState(e.frac,e.elevation)}},60*1e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",He):He();})();
