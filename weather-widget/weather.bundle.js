(()=>{var Nt=Object.defineProperty,Bt=Object.defineProperties;var Wt=Object.getOwnPropertyDescriptors;var st=Object.getOwnPropertySymbols;var Ut=Object.prototype.hasOwnProperty,Ht=Object.prototype.propertyIsEnumerable;var Me=(t,e,o)=>e in t?Nt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,d=(t,e)=>{for(var o in e||(e={}))Ut.call(e,o)&&Me(t,o,e[o]);if(st)for(var o of st(e))Ht.call(e,o)&&Me(t,o,e[o]);return t},w=(t,e)=>Bt(t,Wt(e));var y=(t,e,o)=>Me(t,typeof e!="symbol"?e+"":e,o);var P=(t,e,o)=>new Promise((i,a)=>{var s=l=>{try{r(o.next(l))}catch(h){a(h)}},n=l=>{try{r(o.throw(l))}catch(h){a(h)}},r=l=>l.done?i(l.value):Promise.resolve(l.value).then(s,n);r((o=o.apply(t,e)).next())});var Fe={cirrus:{label:"Cirrus",alias:"Mare's tail",abbr:"Ci",level:"high",form:"filament",opacity:.15},cirrostratus:{label:"Cirrostratus",alias:"Veil cloud",abbr:"Cs",level:"high",form:"stratiform",opacity:.45},cirrocumulus:{label:"Cirrocumulus",alias:"Mackerel sky",abbr:"Cc",level:"high",form:"granular",opacity:.25},altostratus:{label:"Altostratus",alias:"Grey veil",abbr:"As",level:"mid",form:"stratiform",opacity:.9},altocumulus:{label:"Altocumulus",alias:"Sheep cloud",abbr:"Ac",level:"mid",form:"granular",opacity:.45},nimbostratus:{label:"Nimbostratus",alias:"Rain cloud",abbr:"Ns",level:"mid",form:"stratiform",opacity:1},stratus:{label:"Stratus",alias:"Fog cloud",abbr:"St",level:"low",form:"stratiform",opacity:.95},stratocumulus:{label:"Stratocumulus",alias:"Roll cloud",abbr:"Sc",level:"low",form:"granular",opacity:.75},cumulus:{label:"Cumulus",alias:"Cotton cloud",abbr:"Cu",level:"low",form:"convective",opacity:.4},cumulonimbus:{label:"Cumulonimbus",alias:"Thunderhead",abbr:"Cb",level:"low",form:"convective",opacity:.28}},Ie=Object.keys(Fe),U=t=>t<0?0:t>1?1:t;function M(t,e,o){let i=U((t-e)/(o-e));return i*i*(3-2*i)}function $t(t){let e=U(t);return{anvil:M(e,.68,1),velum:M(e,.22,.5)*(1-M(e,.68,.95))}}var ue={cirrus:0,cirrostratus:0,cirrocumulus:0,altostratus:0,altocumulus:0,nimbostratus:0,stratus:0,stratocumulus:0,cumulus:0,cumulonimbus:0};function qt(t){var o;if(t==null)return d({},ue);if(typeof t=="string")return w(d({},ue),{[t]:1});if(Array.isArray(t)){let i=d({},ue);for(let a of t)i[a]=1;return i}let e=d({},ue);for(let i of Ie)e[i]=U((o=t[i])!=null?o:0);return e}function Gt(t,e,o,i){let a=U(t),s=U(e),n=1-s,r=1-M(a,.28,.72),l=1-M(a,.45,.85),h=a>=.15&&a<.52,u=a>=.52&&a<.85,c=a>=.85,g=s>.05;return{cirrus:M(a,.05,.55)*.42*r,cirrostratus:M(a,.1,.55)*.25*r,cirrocumulus:M(a,.14,.45)*(h?.22:.14)*r*n,altostratus:M(a,.45,.82)*(g?.85:.55)*(1-M(a,.82,.98))*n,altocumulus:M(a,.22,.55)*(h?.35:u?.62:.45)*(1-M(a,.72,.95))*n,nimbostratus:s*M(a,.55,.88),stratus:c?M(a,.65,.95)*.85*(1-s*.4):i>.1?i*.45:0,stratocumulus:M(a,.28,.78)*(h?.38:u?.82:.85)*(1-s*.6)*n,cumulus:M(a,.08,.48)*(h?.42:.28)*l*n,cumulonimbus:U(o)*M(a,.12,.45)}}function Zt(t){let e=1;for(let o of Ie)e*=1-t[o]*Fe[o].opacity;return U(1-e)}var jt={tau:2.2,windBase:.006,windGust:.22,evoBase:.07,evoGust:.09,windPerHour:.25,evoPerHour:.06},Vt=Math.PI*2;function nt(t){return{filter:w(d({},t.filter),{tint:[t.filter.tint[0],t.filter.tint[1],t.filter.tint[2]]}),tone:d({},t.tone),polarizer:d({},t.polarizer),celestial:w(d({},t.celestial),{radiant:t.celestial.radiant?[t.celestial.radiant[0],t.celestial.radiant[1]]:null}),clouds:d({},t.clouds),features:d({},t.features)}}function Te(t,e,o,i){let a=i/2,s=(e-t+i*1.5)%i-a;return(t+s*o+i)%i}var Yt=class{constructor(t,e={}){y(this,"current");y(this,"windOff",41.7);y(this,"evoOff",7.3);y(this,"opts");this.current=d(d({},t),nt(t)),this.opts=d(d({},jt),e)}get wind(){return this.windOff}get evolution(){return this.evoOff}jump(t){Object.assign(this.current,t,nt(t))}step(t,e){let o=this.opts,i=this.current,a=1-Math.exp(-e/o.tau),s=i.timeOfDay;i.timeOfDay=Te(i.timeOfDay,t.timeOfDay,a,24);let n=(i.timeOfDay-s+36)%24-12;i.sunElevation+=(t.sunElevation-i.sunElevation)*a,i.sunAzimuth=Te(i.sunAzimuth,t.sunAzimuth,a,Vt),i.cloudCover+=(t.cloudCover-i.cloudCover)*a;for(let _ of Ie)i.clouds[_]+=(t.clouds[_]-i.clouds[_])*a;i.features.anvil+=(t.features.anvil-i.features.anvil)*a,i.features.velum+=(t.features.velum-i.features.velum)*a,i.rain+=(t.rain-i.rain)*a,i.snow+=(t.snow-i.snow)*a,i.wind+=(t.wind-i.wind)*a,i.thunder+=(t.thunder-i.thunder)*a,i.haze+=(t.haze-i.haze)*a;let r=i.filter,l=t.filter;r.amount+=(l.amount-r.amount)*a,r.saturation+=(l.saturation-r.saturation)*a,r.lift+=(l.lift-r.lift)*a,r.tint=[r.tint[0]+(l.tint[0]-r.tint[0])*a,r.tint[1]+(l.tint[1]-r.tint[1])*a,r.tint[2]+(l.tint[2]-r.tint[2])*a];let h=i.tone,u=t.tone;h.exposure+=(u.exposure-h.exposure)*a,h.contrast+=(u.contrast-h.contrast)*a,h.knee+=(u.knee-h.knee)*a,h.bleach+=(u.bleach-h.bleach)*a;let c=i.polarizer,g=t.polarizer;c.strength+=(g.strength-c.strength)*a,c.saturation+=(g.saturation-c.saturation)*a,c.stopLoss+=(g.stopLoss-c.stopLoss)*a,c.angle=Te(c.angle,g.angle,a,Math.PI);let b=i.celestial,m=t.celestial;b.bortle+=(m.bortle-b.bortle)*a,b.milkyWay+=(m.milkyWay-b.milkyWay)*a,b.meteors+=(m.meteors-b.meteors)*a,b.radiant=m.radiant?[m.radiant[0],m.radiant[1]]:null,this.windOff+=(o.windBase+i.wind*o.windGust)*e+Math.abs(n)*o.windPerHour,this.evoOff+=(o.evoBase+i.wind*o.evoGust)*e+Math.abs(n)*o.evoPerHour}},Kt=[.82246197,.17753803,0,.0331942,.9668058,0,.01708263,.07239744,.91051993];function Jt(t){let e=o=>[t[o],t[o+3],t[o+6]].map(i=>i.toFixed(8)).join(", ");return`mat3(${e(0)},
       ${e(1)},
       ${e(2)})`}var Qt=[1.05,.79],Xt=[.98,1.48],Pe={"dark-sky":{label:"Dark sky",bortle:2,milkyWay:1,meteors:5,radiant:null},rural:{label:"Rural",bortle:4,milkyWay:.45,meteors:5,radiant:null},suburban:{label:"Suburban",bortle:6,milkyWay:0,meteors:0,radiant:null},city:{label:"City",bortle:8,milkyWay:0,meteors:0,radiant:null},perseids:{label:"Perseids",bortle:3,milkyWay:.75,meteors:100,radiant:Qt},geminids:{label:"Geminids",bortle:3,milkyWay:.75,meteors:150,radiant:Xt}},Zo=Object.keys(Pe);var ce={bortle:6,milkyWay:0,meteors:0,radiant:null};function ea(t){return Math.min(1,Math.max(0,(5.5-t)/3.5))}function Ae(t){return{bortle:t.bortle,milkyWay:t.milkyWay,meteors:t.meteors,radiant:t.radiant?[t.radiant[0],t.radiant[1]]:null}}var rt=(t,e,o)=>Math.min(o,Math.max(e,t));function ta(t){var i,a,s,n,r;if(t==null)return Ae(ce);if(typeof t=="string")return Ae((i=Pe[t])!=null?i:ce);let e=t.id&&(a=Pe[t.id])!=null?a:ce,o=rt((s=t.bortle)!=null?s:e.bortle,1,9);return Ae({bortle:o,milkyWay:rt((n=t.milkyWay)!=null?n:t.id?e.milkyWay:ea(o),0,1),meteors:Math.max(0,(r=t.meteors)!=null?r:e.meteors),radiant:t.radiant!==void 0?t.radiant:e.radiant})}var j={none:{label:"None",amount:0,tint:[1,1,1],saturation:1,lift:0},sepia:{label:"Sepia",amount:1,tint:[1.07,.93,.72],saturation:.1,lift:.02},mono:{label:"Monochrome",amount:1,tint:[1,1,1],saturation:0,lift:0},faded:{label:"Faded",amount:1,tint:[1.02,.99,.94],saturation:.35,lift:.06},cyanotype:{label:"Cyanotype",amount:1,tint:[.72,.9,1.12],saturation:.08,lift:.03},gold:{label:"Gold",amount:1,tint:[1.15,.95,.6],saturation:.45,lift:.02},ash:{label:"Ash",amount:1,tint:[.92,.95,1],saturation:.2,lift:.04}},jo=Object.keys(j);var ze=j.none;function de(t){return{amount:t.amount,tint:[t.tint[0],t.tint[1],t.tint[2]],saturation:t.saturation,lift:t.lift}}function aa(t){var o,i,a,s,n,r;if(t==null||t===!1)return de(ze);if(t===!0)return de(j.sepia);if(typeof t=="string")return de((o=j[t])!=null?o:ze);let e=t.id?(i=j[t.id])!=null?i:ze:{amount:1,tint:[1,1,1],saturation:0,lift:0};return de({amount:(a=t.amount)!=null?a:e.amount,tint:(s=t.tint)!=null?s:e.tint,saturation:(n=t.saturation)!=null?n:e.saturation,lift:(r=t.lift)!=null?r:e.lift})}var te={none:{label:"None",strength:0,angle:0,saturation:0,stopLoss:0},light:{label:"Light CPL",strength:.45,angle:0,saturation:.2,stopLoss:0},strong:{label:"Strong CPL",strength:.85,angle:0,saturation:.4,stopLoss:0},crossed:{label:"Crossed CPL",strength:.85,angle:Math.PI/2,saturation:.1,stopLoss:0}},Vo=Object.keys(te);var fe=te.none;function me(t){return{strength:t.strength,angle:t.angle,saturation:t.saturation,stopLoss:t.stopLoss}}var Le=t=>Math.min(1,Math.max(0,t));function oa(t){var o,i,a,s,n,r;if(t==null||t===!1)return me(fe);if(t===!0)return me(te.light);if(typeof t=="string")return me((o=te[t])!=null?o:fe);let e=t.id&&(i=te[t.id])!=null?i:fe;return me({strength:Le((a=t.strength)!=null?a:e.strength),angle:(s=t.angle)!=null?s:e.angle,saturation:Le((n=t.saturation)!=null?n:e.saturation),stopLoss:Le((r=t.stopLoss)!=null?r:e.stopLoss)})}var W=Math.PI/180,ia=864e5,sa=2440588,na=2451545,lt=23.4397*W;function ra(t,e){let o=t.getTime()/ia-.5+sa-na,i=W*(357.5291+.98560028*o),a=W*(1.9148*Math.sin(i)+.02*Math.sin(2*i)+3e-4*Math.sin(3*i)),s=i+a+W*102.9372+Math.PI,n=Math.asin(Math.sin(lt)*Math.sin(s)),r=Math.atan2(Math.sin(s)*Math.cos(lt),Math.cos(s)),l=W*-e.longitude,h=W*e.latitude,u=W*(280.16+360.9856235*o)-l-r,c=Math.asin(Math.sin(h)*Math.sin(n)+Math.cos(h)*Math.cos(n)*Math.cos(u)),g=Math.atan2(Math.sin(u),Math.cos(u)*Math.sin(h)-Math.tan(n)*Math.cos(h))+Math.PI;return{elevation:c,azimuth:(g%(2*Math.PI)+2*Math.PI)%(2*Math.PI)}}function la(t){let e=(t-6)/12;return{elevation:Math.asin(Math.sin(e*Math.PI)*.72),azimuth:Math.PI/2+e*Math.PI}}function dt(t){if(t instanceof Date)return Number.isNaN(t.getTime())?null:t;if(typeof t=="string"&&/\d{4}-\d{2}-\d{2}/.test(t)){let e=new Date(t);return Number.isNaN(e.getTime())?null:e}return null}function ha(t){var o;if(typeof t=="number")return(t%24+24)%24;let e=dt(t);if(e)return e.getHours()+e.getMinutes()/60+e.getSeconds()/3600;if(typeof t=="string"){let i=/^(\d{1,2})(?::(\d{2}))?/.exec(t.trim());if(i)return((Number(i[1])+Number((o=i[2])!=null?o:0)/60)%24+24)%24}return 12}var ve={neutral:{label:"Neutral",exposure:0,contrast:1,knee:.8,bleach:0},flat:{label:"Flat",exposure:.15,contrast:.82,knee:.55,bleach:.25},punch:{label:"Punch",exposure:-.2,contrast:1.22,knee:.85,bleach:.1},filmic:{label:"Filmic",exposure:.1,contrast:1.08,knee:.42,bleach:.55},blown:{label:"Blown",exposure:.85,contrast:.95,knee:.7,bleach:.4}},Yo=Object.keys(ve);var pe=ve.neutral;function Ee(t){return{exposure:t.exposure,contrast:t.contrast,knee:t.knee,bleach:t.bleach}}function ua(t){var o,i,a,s,n,r;if(t==null)return Ee(pe);if(typeof t=="string")return Ee((o=ve[t])!=null?o:pe);let e=t.id&&(i=ve[t.id])!=null?i:pe;return Ee({exposure:(a=t.exposure)!=null?a:e.exposure,contrast:(s=t.contrast)!=null?s:e.contrast,knee:Math.min(.99,Math.max(.02,(n=t.knee)!=null?n:e.knee)),bleach:Math.min(1,Math.max(0,(r=t.bleach)!=null?r:e.bleach))})}var ye={clear:{label:"Clear",cloudCover:0,windSpeed:2,visibility:45},fair:{label:"Fair",cloudCover:.22,windSpeed:3,visibility:35},summer:{label:"Summer sky",cloudCover:.38,windSpeed:3,visibility:25,convection:.7},overcast:{label:"Overcast",cloudCover:.82,windSpeed:5,visibility:15},fog:{label:"Fog",cloudCover:.75,windSpeed:1,visibility:.6},rain:{label:"Rain",cloudCover:.95,windSpeed:7,visibility:8,precipitation:8,thunder:.08},thunderstorm:{label:"Thunderstorm",cloudCover:.97,windSpeed:12,visibility:5,precipitation:25,thunder:1,convection:.5},snow:{label:"Snow",cloudCover:.9,windSpeed:3,visibility:4,precipitation:3,precipitationType:"snow"},typhoon:{label:"Typhoon",cloudCover:1,windSpeed:30,visibility:6,precipitation:40,thunder:.5}},Ko=Object.keys(ye);var z=t=>t<0?0:t>1?1:t;function ca(t){return z(Math.pow(z(t/30),.55))}function da(t){return z(Math.pow(z(t/33),.8))}function fa(t){return z(Math.pow(z(t/5),.6))}function ma(t){return z(Math.pow(z((20-t)/20),2.6))}function pa(t){var c,g,b,m,_,N,S,Q,x,R,F;let e=typeof t=="string"?(c=ye[t])!=null?c:ye.clear:t!=null?t:{},o=(g=e.precipitation)!=null?g:0,i=e.precipitationType==="snow",a=i?0:ca(o),s=i?fa(o):0,n=ma((b=e.visibility)!=null?b:30),r=z((m=e.convection)!=null?m:0),l,h;e.clouds!=null?(l=qt(e.clouds),h=Zt(l)):(h=z((_=e.cloudCover)!=null?_:0),l=Gt(h,Math.max(a,s),r,n));let u=$t(l.cumulonimbus);return{clouds:l,features:{anvil:z((S=(N=e.features)==null?void 0:N.anvil)!=null?S:u.anvil),velum:z((x=(Q=e.features)==null?void 0:Q.velum)!=null?x:u.velum)},cloudCover:h,rain:a,snow:s,wind:da((R=e.windSpeed)!=null?R:0),thunder:z((F=e.thunder)!=null?F:0),haze:n}}var ft={yaw:Math.PI,pitch:.46,fov:.86},Jo=[{yaw:Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:-Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:0,pitch:Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:-Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:0,fov:Math.PI/2},{yaw:Math.PI,pitch:0,fov:Math.PI/2}],ht={time:12,weather:"clear"};function ut(t){var s,n;let e=(s=t.time)!=null?s:ht.time,o=ha(e),i=dt(e),a=t.location&&i?ra(i,t.location):la(o);return w(d({timeOfDay:o,sunElevation:a.elevation,sunAzimuth:a.azimuth},pa((n=t.weather)!=null?n:ht.weather)),{filter:aa(t.filter),tone:ua(t.tone),polarizer:oa(t.polarizer),celestial:ta(t.celestial)})}function ct(t){return d(d({},ft),t)}var va=`
