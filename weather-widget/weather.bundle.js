(()=>{var ct=Object.defineProperty,ft=Object.defineProperties;var mt=Object.getOwnPropertyDescriptors;var qe=Object.getOwnPropertySymbols;var pt=Object.prototype.hasOwnProperty,vt=Object.prototype.propertyIsEnumerable;var pe=(t,e,i)=>e in t?ct(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,d=(t,e)=>{for(var i in e||(e={}))pt.call(e,i)&&pe(t,i,e[i]);if(qe)for(var i of qe(e))vt.call(e,i)&&pe(t,i,e[i]);return t},w=(t,e)=>ft(t,mt(e));var p=(t,e,i)=>pe(t,typeof e!="symbol"?e+"":e,i);var P=(t,e,i)=>new Promise((o,a)=>{var s=l=>{try{n(i.next(l))}catch(h){a(h)}},r=l=>{try{n(i.throw(l))}catch(h){a(h)}},n=l=>l.done?o(l.value):Promise.resolve(l.value).then(s,r);n((i=i.apply(t,e)).next())});var _e={cirrus:{label:"Cirrus",alias:"Mare's tail",abbr:"Ci",level:"high",form:"filament",opacity:.15},cirrostratus:{label:"Cirrostratus",alias:"Veil cloud",abbr:"Cs",level:"high",form:"stratiform",opacity:.45},cirrocumulus:{label:"Cirrocumulus",alias:"Mackerel sky",abbr:"Cc",level:"high",form:"granular",opacity:.25},altostratus:{label:"Altostratus",alias:"Grey veil",abbr:"As",level:"mid",form:"stratiform",opacity:.9},altocumulus:{label:"Altocumulus",alias:"Sheep cloud",abbr:"Ac",level:"mid",form:"granular",opacity:.45},nimbostratus:{label:"Nimbostratus",alias:"Rain cloud",abbr:"Ns",level:"mid",form:"stratiform",opacity:1},stratus:{label:"Stratus",alias:"Fog cloud",abbr:"St",level:"low",form:"stratiform",opacity:.95},stratocumulus:{label:"Stratocumulus",alias:"Roll cloud",abbr:"Sc",level:"low",form:"granular",opacity:.75},cumulus:{label:"Cumulus",alias:"Cotton cloud",abbr:"Cu",level:"low",form:"convective",opacity:.4},cumulonimbus:{label:"Cumulonimbus",alias:"Thunderhead",abbr:"Cb",level:"low",form:"convective",opacity:.28}},Se=Object.keys(_e),I=t=>t<0?0:t>1?1:t;function _(t,e,i){let o=I((t-e)/(i-e));return o*o*(3-2*o)}function gt(t){let e=I(t);return{anvil:_(e,.68,1),velum:_(e,.22,.5)*(1-_(e,.68,.95))}}var ie={cirrus:0,cirrostratus:0,cirrocumulus:0,altostratus:0,altocumulus:0,nimbostratus:0,stratus:0,stratocumulus:0,cumulus:0,cumulonimbus:0};function yt(t){var i;if(t==null)return d({},ie);if(typeof t=="string")return w(d({},ie),{[t]:1});if(Array.isArray(t)){let o=d({},ie);for(let a of t)o[a]=1;return o}let e=d({},ie);for(let o of Se)e[o]=I((i=t[o])!=null?i:0);return e}function wt(t,e,i,o){let a=I(t),s=I(e),r=1-s,n=1-_(a,.28,.72),l=1-_(a,.45,.85),h=a>=.15&&a<.52,u=a>=.52&&a<.85,c=a>=.85,v=s>.05;return{cirrus:_(a,.05,.55)*.42*n,cirrostratus:_(a,.1,.55)*.25*n,cirrocumulus:_(a,.14,.45)*(h?.22:.14)*n*r,altostratus:_(a,.45,.82)*(v?.85:.55)*(1-_(a,.82,.98))*r,altocumulus:_(a,.22,.55)*(h?.35:u?.62:.45)*(1-_(a,.72,.95))*r,nimbostratus:s*_(a,.55,.88),stratus:c?_(a,.65,.95)*.85*(1-s*.4):o>.1?o*.45:0,stratocumulus:_(a,.28,.78)*(h?.38:u?.82:.85)*(1-s*.6)*r,cumulus:_(a,.08,.48)*(h?.42:.28)*l*r,cumulonimbus:I(i)*_(a,.12,.45)}}function bt(t){let e=1;for(let i of Se)e*=1-t[i]*_e[i].opacity;return I(1-e)}var kt={tau:2.2,windBase:.006,windGust:.22,evoBase:.07,evoGust:.09,windPerHour:.25,evoPerHour:.06},_t=Math.PI*2;function Ge(t){return{filter:w(d({},t.filter),{tint:[t.filter.tint[0],t.filter.tint[1],t.filter.tint[2]]}),tone:d({},t.tone),polarizer:d({},t.polarizer),celestial:w(d({},t.celestial),{radiant:t.celestial.radiant?[t.celestial.radiant[0],t.celestial.radiant[1]]:null}),clouds:d({},t.clouds),features:d({},t.features)}}function ve(t,e,i,o){let a=o/2,s=(e-t+o*1.5)%o-a;return(t+s*i+o)%o}var St=class{constructor(t,e={}){p(this,"current");p(this,"windOff",41.7);p(this,"evoOff",7.3);p(this,"opts");this.current=d(d({},t),Ge(t)),this.opts=d(d({},kt),e)}get wind(){return this.windOff}get evolution(){return this.evoOff}jump(t){Object.assign(this.current,t,Ge(t))}step(t,e){let i=this.opts,o=this.current,a=1-Math.exp(-e/i.tau),s=o.timeOfDay;o.timeOfDay=ve(o.timeOfDay,t.timeOfDay,a,24);let r=(o.timeOfDay-s+36)%24-12;o.sunElevation+=(t.sunElevation-o.sunElevation)*a,o.sunAzimuth=ve(o.sunAzimuth,t.sunAzimuth,a,_t),o.cloudCover+=(t.cloudCover-o.cloudCover)*a;for(let A of Se)o.clouds[A]+=(t.clouds[A]-o.clouds[A])*a;o.features.anvil+=(t.features.anvil-o.features.anvil)*a,o.features.velum+=(t.features.velum-o.features.velum)*a,o.rain+=(t.rain-o.rain)*a,o.snow+=(t.snow-o.snow)*a,o.wind+=(t.wind-o.wind)*a,o.thunder+=(t.thunder-o.thunder)*a,o.haze+=(t.haze-o.haze)*a;let n=o.filter,l=t.filter;n.amount+=(l.amount-n.amount)*a,n.saturation+=(l.saturation-n.saturation)*a,n.lift+=(l.lift-n.lift)*a,n.tint=[n.tint[0]+(l.tint[0]-n.tint[0])*a,n.tint[1]+(l.tint[1]-n.tint[1])*a,n.tint[2]+(l.tint[2]-n.tint[2])*a];let h=o.tone,u=t.tone;h.exposure+=(u.exposure-h.exposure)*a,h.contrast+=(u.contrast-h.contrast)*a,h.knee+=(u.knee-h.knee)*a,h.bleach+=(u.bleach-h.bleach)*a;let c=o.polarizer,v=t.polarizer;c.strength+=(v.strength-c.strength)*a,c.saturation+=(v.saturation-c.saturation)*a,c.stopLoss+=(v.stopLoss-c.stopLoss)*a,c.angle=ve(c.angle,v.angle,a,Math.PI);let f=o.celestial,b=t.celestial;f.bortle+=(b.bortle-f.bortle)*a,f.milkyWay+=(b.milkyWay-f.milkyWay)*a,f.meteors+=(b.meteors-f.meteors)*a,f.radiant=b.radiant?[b.radiant[0],b.radiant[1]]:null,this.windOff+=(i.windBase+o.wind*i.windGust)*e+Math.abs(r)*i.windPerHour,this.evoOff+=(i.evoBase+o.wind*i.evoGust)*e+Math.abs(r)*i.evoPerHour}},Mt=[.82246197,.17753803,0,.0331942,.9668058,0,.01708263,.07239744,.91051993];function Ct(t){let e=i=>[t[i],t[i+3],t[i+6]].map(o=>o.toFixed(8)).join(", ");return`mat3(${e(0)},
       ${e(1)},
       ${e(2)})`}var Tt=[1.05,.79],At=[.98,1.48],ke={"dark-sky":{label:"Dark sky",bortle:2,milkyWay:1,meteors:5,radiant:null},rural:{label:"Rural",bortle:4,milkyWay:.45,meteors:5,radiant:null},suburban:{label:"Suburban",bortle:6,milkyWay:0,meteors:0,radiant:null},city:{label:"City",bortle:8,milkyWay:0,meteors:0,radiant:null},perseids:{label:"Perseids",bortle:3,milkyWay:.75,meteors:100,radiant:Tt},geminids:{label:"Geminids",bortle:3,milkyWay:.75,meteors:150,radiant:At}},oi=Object.keys(ke);var oe={bortle:6,milkyWay:0,meteors:0,radiant:null};function zt(t){return Math.min(1,Math.max(0,(5.5-t)/3.5))}function ge(t){return{bortle:t.bortle,milkyWay:t.milkyWay,meteors:t.meteors,radiant:t.radiant?[t.radiant[0],t.radiant[1]]:null}}var $e=(t,e,i)=>Math.min(i,Math.max(e,t));function Lt(t){var o,a,s,r,n;if(t==null)return ge(oe);if(typeof t=="string")return ge((o=ke[t])!=null?o:oe);let e=t.id&&(a=ke[t.id])!=null?a:oe,i=$e((s=t.bortle)!=null?s:e.bortle,1,9);return ge({bortle:i,milkyWay:$e((r=t.milkyWay)!=null?r:t.id?e.milkyWay:zt(i),0,1),meteors:Math.max(0,(n=t.meteors)!=null?n:e.meteors),radiant:t.radiant!==void 0?t.radiant:e.radiant})}var B={none:{label:"None",amount:0,tint:[1,1,1],saturation:1,lift:0},sepia:{label:"Sepia",amount:1,tint:[1.07,.93,.72],saturation:.1,lift:.02},mono:{label:"Monochrome",amount:1,tint:[1,1,1],saturation:0,lift:0},faded:{label:"Faded",amount:1,tint:[1.02,.99,.94],saturation:.35,lift:.06},cyanotype:{label:"Cyanotype",amount:1,tint:[.72,.9,1.12],saturation:.08,lift:.03},gold:{label:"Gold",amount:1,tint:[1.15,.95,.6],saturation:.45,lift:.02},ash:{label:"Ash",amount:1,tint:[.92,.95,1],saturation:.2,lift:.04}},si=Object.keys(B);var ye=B.none;function se(t){return{amount:t.amount,tint:[t.tint[0],t.tint[1],t.tint[2]],saturation:t.saturation,lift:t.lift}}function Pt(t){var i,o,a,s,r,n;if(t==null||t===!1)return se(ye);if(t===!0)return se(B.sepia);if(typeof t=="string")return se((i=B[t])!=null?i:ye);let e=t.id?(o=B[t.id])!=null?o:ye:{amount:1,tint:[1,1,1],saturation:0,lift:0};return se({amount:(a=t.amount)!=null?a:e.amount,tint:(s=t.tint)!=null?s:e.tint,saturation:(r=t.saturation)!=null?r:e.saturation,lift:(n=t.lift)!=null?n:e.lift})}var K={none:{label:"None",strength:0,angle:0,saturation:0,stopLoss:0},light:{label:"Light CPL",strength:.45,angle:0,saturation:.2,stopLoss:0},strong:{label:"Strong CPL",strength:.85,angle:0,saturation:.4,stopLoss:0},crossed:{label:"Crossed CPL",strength:.85,angle:Math.PI/2,saturation:.1,stopLoss:0}},ri=Object.keys(K);var re=K.none;function ne(t){return{strength:t.strength,angle:t.angle,saturation:t.saturation,stopLoss:t.stopLoss}}var we=t=>Math.min(1,Math.max(0,t));function Et(t){var i,o,a,s,r,n;if(t==null||t===!1)return ne(re);if(t===!0)return ne(K.light);if(typeof t=="string")return ne((i=K[t])!=null?i:re);let e=t.id&&(o=K[t.id])!=null?o:re;return ne({strength:we((a=t.strength)!=null?a:e.strength),angle:(s=t.angle)!=null?s:e.angle,saturation:we((r=t.saturation)!=null?r:e.saturation),stopLoss:we((n=t.stopLoss)!=null?n:e.stopLoss)})}var D=Math.PI/180,Ft=864e5,xt=2440588,Dt=2451545,je=23.4397*D;function It(t,e){let i=t.getTime()/Ft-.5+xt-Dt,o=D*(357.5291+.98560028*i),a=D*(1.9148*Math.sin(o)+.02*Math.sin(2*o)+3e-4*Math.sin(3*o)),s=o+a+D*102.9372+Math.PI,r=Math.asin(Math.sin(je)*Math.sin(s)),n=Math.atan2(Math.sin(s)*Math.cos(je),Math.cos(s)),l=D*-e.longitude,h=D*e.latitude,u=D*(280.16+360.9856235*i)-l-n,c=Math.asin(Math.sin(h)*Math.sin(r)+Math.cos(h)*Math.cos(r)*Math.cos(u)),v=Math.atan2(Math.sin(u),Math.cos(u)*Math.sin(h)-Math.tan(r)*Math.cos(h))+Math.PI;return{elevation:c,azimuth:(v%(2*Math.PI)+2*Math.PI)%(2*Math.PI)}}function Rt(t){let e=(t-6)/12;return{elevation:Math.asin(Math.sin(e*Math.PI)*.72),azimuth:Math.PI/2+e*Math.PI}}function Ke(t){if(t instanceof Date)return Number.isNaN(t.getTime())?null:t;if(typeof t=="string"&&/\d{4}-\d{2}-\d{2}/.test(t)){let e=new Date(t);return Number.isNaN(e.getTime())?null:e}return null}function Ot(t){var i;if(typeof t=="number")return(t%24+24)%24;let e=Ke(t);if(e)return e.getHours()+e.getMinutes()/60+e.getSeconds()/3600;if(typeof t=="string"){let o=/^(\d{1,2})(?::(\d{2}))?/.exec(t.trim());if(o)return((Number(o[1])+Number((i=o[2])!=null?i:0)/60)%24+24)%24}return 12}var he={neutral:{label:"Neutral",exposure:0,contrast:1,knee:.8,bleach:0},flat:{label:"Flat",exposure:.15,contrast:.82,knee:.55,bleach:.25},punch:{label:"Punch",exposure:-.2,contrast:1.22,knee:.85,bleach:.1},filmic:{label:"Filmic",exposure:.1,contrast:1.08,knee:.42,bleach:.55},blown:{label:"Blown",exposure:.85,contrast:.95,knee:.7,bleach:.4}},ni=Object.keys(he);var le=he.neutral;function be(t){return{exposure:t.exposure,contrast:t.contrast,knee:t.knee,bleach:t.bleach}}function Nt(t){var i,o,a,s,r,n;if(t==null)return be(le);if(typeof t=="string")return be((i=he[t])!=null?i:le);let e=t.id&&(o=he[t.id])!=null?o:le;return be({exposure:(a=t.exposure)!=null?a:e.exposure,contrast:(s=t.contrast)!=null?s:e.contrast,knee:Math.min(.99,Math.max(.02,(r=t.knee)!=null?r:e.knee)),bleach:Math.min(1,Math.max(0,(n=t.bleach)!=null?n:e.bleach))})}var ue={clear:{label:"Clear",cloudCover:0,windSpeed:2,visibility:45},fair:{label:"Fair",cloudCover:.22,windSpeed:3,visibility:35},summer:{label:"Summer sky",cloudCover:.38,windSpeed:3,visibility:25,convection:.7},overcast:{label:"Overcast",cloudCover:.82,windSpeed:5,visibility:15},fog:{label:"Fog",cloudCover:.75,windSpeed:1,visibility:.6},rain:{label:"Rain",cloudCover:.95,windSpeed:7,visibility:8,precipitation:8,thunder:.08},thunderstorm:{label:"Thunderstorm",cloudCover:.97,windSpeed:12,visibility:5,precipitation:25,thunder:1,convection:.5},snow:{label:"Snow",cloudCover:.9,windSpeed:3,visibility:4,precipitation:3,precipitationType:"snow"},typhoon:{label:"Typhoon",cloudCover:1,windSpeed:30,visibility:6,precipitation:40,thunder:.5}},li=Object.keys(ue);var C=t=>t<0?0:t>1?1:t;function Wt(t){return C(Math.pow(C(t/30),.55))}function Bt(t){return C(Math.pow(C(t/33),.8))}function Ut(t){return C(Math.pow(C(t/5),.6))}function Ht(t){return C(Math.pow(C((20-t)/20),2.6))}function qt(t){var c,v,f,b,A,$,x,z,L,R,O;let e=typeof t=="string"?(c=ue[t])!=null?c:ue.clear:t!=null?t:{},i=(v=e.precipitation)!=null?v:0,o=e.precipitationType==="snow",a=o?0:Wt(i),s=o?Ut(i):0,r=Ht((f=e.visibility)!=null?f:30),n=C((b=e.convection)!=null?b:0),l,h;e.clouds!=null?(l=yt(e.clouds),h=bt(l)):(h=C((A=e.cloudCover)!=null?A:0),l=wt(h,Math.max(a,s),n,r));let u=gt(l.cumulonimbus);return{clouds:l,features:{anvil:C((x=($=e.features)==null?void 0:$.anvil)!=null?x:u.anvil),velum:C((L=(z=e.features)==null?void 0:z.velum)!=null?L:u.velum)},cloudCover:h,rain:a,snow:s,wind:Bt((R=e.windSpeed)!=null?R:0),thunder:C((O=e.thunder)!=null?O:0),haze:r}}var Qe={yaw:Math.PI,pitch:.46,fov:.86},hi=[{yaw:Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:-Math.PI/2,pitch:0,fov:Math.PI/2},{yaw:0,pitch:Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:-Math.PI/2,fov:Math.PI/2},{yaw:0,pitch:0,fov:Math.PI/2},{yaw:Math.PI,pitch:0,fov:Math.PI/2}],Ze={time:12,weather:"clear"};function Ve(t){var s,r;let e=(s=t.time)!=null?s:Ze.time,i=Ot(e),o=Ke(e),a=t.location&&o?It(o,t.location):Rt(i);return w(d({timeOfDay:i,sunElevation:a.elevation,sunAzimuth:a.azimuth},qt((r=t.weather)!=null?r:Ze.weather)),{filter:Pt(t.filter),tone:Nt(t.tone),polarizer:Et(t.polarizer),celestial:Lt(t.celestial)})}function Ye(t){return d(d({},Qe),t)}var Gt=`
...
void main() {
  ...
  if (u_p3 > 0.5) {
    ...
    sky = mix(srgbToDisplayP3(sky), sky, clamp(wide, 0.0, 1.0) * ${$t.toFixed(4)});
  }
...
`,Zt=4096,Vt=["u_res","u_time","u_cam","u_sun","u_cover","u_high","u_mid","u_low","u_rain","u_snow","u_wind","u_thunder","u_haze","u_cbFeat","u_windOff","u_evo","u_filtAmt","u_filtTint","u_filtSat","u_filtLift","u_p3","u_headroom","u_tone","u_pol","u_sky","u_radiant"],Yt=class{constructor(t,e={}){p(this,"canvas");p(this,"opts");p(this,"gl",null);p(this,"program",null);p(this,"buffer",null);p(this,"u",{});p(this,"lost",!1);p(this,"p3",!1);p(this,"onLost",t=>{t.preventDefault(),this.lost=!0});p(this,"onRestored",()=>{this.lost=!1,this.init()});this.canvas=t,this.opts=e,t.addEventListener("webglcontextlost",this.onLost),t.addEventListener("webglcontextrestored",this.onRestored),this.init()}get available(){return this.gl!==null}get colorSpace(){return this.p3?"display-p3":"srgb"}init(){let t=this.canvas.getContext("webgl",{alpha:!1,antialias:!1,depth:!1,stencil:!1,powerPreference:"low-power"});if(!t){this.gl=null;return}this.gl=t,this.p3=!1,this.opts.colorSpace!=="srgb"&&"drawingBufferColorSpace"in t&&(t.drawingBufferColorSpace="display-p3",this.p3=t.drawingBufferColorSpace==="display-p3");let e=(r,n)=>{let l=t.createShader(r);return l?(t.shaderSource(l,n),t.compileShader(l),t.getShaderParameter(l,t.COMPILE_STATUS)?l:(console.error("atmosphere shader compile error:",t.getShaderInfoLog(l)),t.deleteShader(l),null)):null},i=e(t.VERTEX_SHADER,Gt),o=e(t.FRAGMENT_SHADER,jt);if(!i||!o){this.gl=null;return}let a=t.createProgram();if(!a){this.gl=null;return}if(t.attachShader(a,i),t.attachShader(a,o),t.linkProgram(a),t.deleteShader(i),t.deleteShader(o),!t.getProgramParameter(a,t.LINK_STATUS)){console.error("atmosphere shader link error:",t.getProgramInfoLog(a)),this.gl=null;return}this.program=a,t.useProgram(a),this.buffer=t.createBuffer(),t.bindBuffer(t.ARRAY_BUFFER,this.buffer),t.bufferData(t.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),t.STATIC_DRAW);let s=t.getAttribLocation(a,"a_pos");t.enableVertexAttribArray(s),t.vertexAttribPointer(s,2,t.FLOAT,!1,0,0),this.u={};for(let r of Vt)this.u[r]=t.getUniformLocation(a,r)}resize(t,e){var i;this.canvas.width=t,this.canvas.height=e,(i=this.gl)==null||i.viewport(0,0,t,e)}render(t,e,i=Qe,o=0,a=0){var c,v,f,b,A;let s=this.gl;if(!s||this.lost||!this.program)return;s.useProgram(this.program);let r=this.u;s.uniform2f(r.u_res,this.canvas.width,this.canvas.height),s.uniform1f(r.u_time,t%Zt),s.uniform3f(r.u_cam,i.yaw,i.pitch,i.fov),s.uniform2f(r.u_sun,e.sunElevation,e.sunAzimuth);let n=e.clouds;s.uniform1f(r.u_cover,e.cloudCover),s.uniform3f(r.u_high,n.cirrus,n.cirrostratus,n.cirrocumulus),s.uniform3f(r.u_mid,n.altostratus,n.altocumulus,n.nimbostratus),s.uniform4f(r.u_low,n.stratus,n.stratocumulus,n.cumulus,n.cumulonimbus),s.uniform1f(r.u_rain,e.rain),s.uniform1f(r.u_snow,e.snow),s.uniform1f(r.u_wind,e.wind),s.uniform1f(r.u_thunder,e.thunder),s.uniform1f(r.u_haze,e.haze),s.uniform2f(r.u_cbFeat,e.features.anvil,e.features.velum),s.uniform1f(r.u_windOff,o),s.uniform1f(r.u_evo,a),s.uniform1f(r.u_filtAmt,e.filter.amount),s.uniform3f(r.u_filtTint,e.filter.tint[0],e.filter.tint[1],e.filter.tint[2]),s.uniform1f(r.u_filtSat,e.filter.saturation),s.uniform1f(r.u_filtLift,e.filter.lift),s.uniform1f(r.u_p3,this.p3?1:0),s.uniform1f(r.u_headroom,Math.max(1,(c=this.opts.headroom)!=null?c:1));let l=e.tone;s.uniform4f(r.u_tone,l.exposure,l.contrast,l.knee,l.bleach);let h=e.polarizer;s.uniform4f(r.u_pol,h.strength,h.angle,h.saturation,h.stopLoss);let u=e.celestial;s.uniform4f(r.u_sky,u.bortle,u.milkyWay,u.meteors,u.radiant?1:0),s.uniform2f(r.u_radiant,(f=(v=u.radiant)==null?void 0:v[0])!=null?f:0,(A=(b=u.radiant)==null?void 0:b[1])!=null?A:0),s.drawArrays(s.TRIANGLES,0,3)}dispose(t={}){var i;let e=this.gl;this.canvas.removeEventListener("webglcontextlost",this.onLost),this.canvas.removeEventListener("webglcontextrestored",this.onRestored),e&&(this.program&&e.deleteProgram(this.program),this.buffer&&e.deleteBuffer(this.buffer),t.loseContext&&((i=e.getExtension("WEBGL_lose_context"))==null||i.loseContext())),this.gl=null,this.program=null,this.buffer=null}},Kt=()=>Math.min(typeof devicePixelRatio=="number"?devicePixelRatio:1,1.5)*.55,Je=class{constructor(t,e={}){p(this,"canvas");p(this,"renderer");p(this,"animator");p(this,"opts");p(this,"target");p(this,"conditions");p(this,"cam");p(this,"raf",0);p(this,"observer",null);p(this,"startedAt",0);p(this,"last",0);p(this,"lastDraw",0);p(this,"wantRunning",!1);p(this,"motionQuery",null);p(this,"onMotionChange",()=>{this.wantRunning&&(this.reducedMotion?(this.stopLoop(),this.jump()):this.startLoop())});this.canvas=t,this.opts=e,this.conditions={time:e.time,location:e.location,weather:e.weather,filter:e.filter,tone:e.tone,polarizer:e.polarizer,celestial:e.celestial,camera:e.camera},this.target=Ve(this.conditions),this.cam=Ye(e.camera),this.renderer=new Yt(t,{colorSpace:e.colorSpace}),this.animator=new St(this.target,e.animator),this.resize(),typeof ResizeObserver!="undefined"&&(this.observer=new ResizeObserver(()=>this.resize()),this.observer.observe(t)),e.respectReducedMotion!==!1&&typeof matchMedia!="undefined"&&(this.motionQuery=matchMedia("(prefers-reduced-motion: reduce)"),this.motionQuery.addEventListener("change",this.onMotionChange)),e.autoStart!==!1&&this.start()}get reducedMotion(){var t,e;return(e=(t=this.motionQuery)==null?void 0:t.matches)!=null?e:!1}get available(){return this.renderer.available}get colorSpace(){return this.renderer.colorSpace}get state(){let t=this.animator.current;return w(d({},t),{clouds:d({},t.clouds),features:d({},t.features),filter:w(d({},t.filter),{tint:[...t.filter.tint]}),tone:d({},t.tone),polarizer:d({},t.polarizer),celestial:w(d({},t.celestial),{radiant:t.celestial.radiant?[t.celestial.radiant[0],t.celestial.radiant[1]]:null})})}get camera(){return this.cam}set(t){this.applyConditions(t),this.wantRunning&&!this.raf&&this.reducedMotion&&(this.animator.jump(this.target),this.draw(performance.now()))}jump(t={}){this.applyConditions(t),this.animator.jump(this.target),this.draw(performance.now())}applyConditions(t){this.conditions=d(d({},this.conditions),t),this.target=Ve(this.conditions),t.camera&&(this.cam=Ye(d(d({},this.cam),t.camera)))}resize(){var o;let t=(o=this.opts.resolutionScale)!=null?o:Kt(),e=this.canvas.clientWidth||this.canvas.width,i=this.canvas.clientHeight||this.canvas.height;this.renderer.resize(Math.max(1,Math.round(e*t)),Math.max(1,Math.round(i*t)))}start(){if(this.available){if(this.wantRunning=!0,this.reducedMotion){this.jump();return}this.startLoop()}}stop(){this.wantRunning=!1,this.stopLoop()}startLoop(){if(this.raf)return;let t=performance.now();this.startedAt||(this.startedAt=t),this.last=t;let e=i=>{var s;this.raf=requestAnimationFrame(e);let o=1e3/((s=this.opts.fps)!=null?s:30),a=i-this.lastDraw;a<o||(this.lastDraw=i-a%o,this.draw(i))};this.raf=requestAnimationFrame(e)}stopLoop(){this.raf&&(cancelAnimationFrame(this.raf),this.raf=0)}draw(t){this.startedAt||(this.startedAt=t,this.last=t);let e=Math.min(.2,(t-this.last)/1e3);this.last=t,this.animator.step(this.target,e),this.reducedMotion&&(this.animator.current.celestial.meteors=0),this.renderer.render((t-this.startedAt)/1e3,this.animator.current,this.cam,this.animator.wind,this.animator.evolution)}dispose(t={}){var e,i;this.stop(),(e=this.observer)==null||e.disconnect(),this.observer=null,(i=this.motionQuery)==null||i.removeEventListener("change",this.onMotionChange),this.motionQuery=null,this.renderer.dispose(t)}};function Me(t,e){let i={};for(let o of Object.keys(t))i[o]=e(t[o]);return i}var ui={en:Me(ue,t=>t.label),ja:{clear:"\u5FEB\u6674",fair:"\u6674\u308C",summer:"\u590F\u7A7A",overcast:"\u66C7\u308A",fog:"\u9727",rain:"\u96E8",thunderstorm:"\u96F7\u96E8",snow:"\u96EA",typhoon:"\u53F0\u98A8"}},di={en:Me(B,t=>t.label),ja:{none:"\u306A\u3057",sepia:"\u30BB\u30D4\u30A2",mono:"\u30E2\u30CE\u30AF\u30ED\u30FC\u30E0",faded:"\u892A\u8272",cyanotype:"\u9752\u306E\u8A18\u61B6",gold:"\u9EC4\u660F",ash:"\u7070"}},ci={en:Me(_e,t=>({label:t.label,alias:t.alias})),ja:{cirrus:{label:"\u5DFB\u96F2",alias:"\u3059\u3058\u96F2"},cirrostratus:{label:"\u5DFB\u5C64\u96F2",alias:"\u3046\u3059\u96F2"},cirrocumulus:{label:"\u5DFB\u7A4D\u96F2",alias:"\u3046\u308D\u3053\u96F2\u30FB\u3044\u308F\u3057\u96F2"},altostratus:{label:"\u9AD8\u5C64\u96F2",alias:"\u304A\u307C\u308D\u96F2"},altocumulus:{label:"\u9AD8\u7A4D\u96F2",alias:"\u3072\u3064\u3058\u96F2"},nimbostratus:{label:"\u4E71\u5C64\u96F2",alias:"\u3042\u307E\u96F2"},stratus:{label:"\u5C64\u96F2",alias:"\u304D\u308A\u96F2"},stratocumulus:{label:"\u5C64\u7A4D\u96F2",alias:"\u304F\u3082\u308A\u96F2"},cumulus:{label:"\u7A4D\u96F2",alias:"\u308F\u305F\u96F2"},cumulonimbus:{label:"\u7A4D\u4E71\u96F2",alias:"\u5165\u9053\u96F2"}}};var Qt={latitude:37.8991768,longitude:-122.4949685},m={0:{cloudCover:0,precipitation:0,windSpeed:2,visibility:45,thunder:0},1:{cloudCover:.22,precipitation:0,windSpeed:3,visibility:35,thunder:0},2:{cloudCover:.35,precipitation:0,windSpeed:4,visibility:30,thunder:0},3:{cloudCover:.92,precipitation:0,windSpeed:5,visibility:18,thunder:0},45:{cloudCover:.75,precipitation:0,windSpeed:1,visibility:.6,thunder:0},48:{cloudCover:.78,precipitation:0,windSpeed:1,visibility:.4,thunder:0},51:{cloudCover:.62,precipitation:.2,windSpeed:2,visibility:10,thunder:0,precipitationType:"rain"},53:{cloudCover:.68,precipitation:.5,windSpeed:3,visibility:8,thunder:0,precipitationType:"rain"},55:{cloudCover:.75,precipitation:1.2,windSpeed:4,visibility:6,thunder:0,precipitationType:"rain"},56:{cloudCover:.7,precipitation:.3,windSpeed:3,visibility:3,thunder:0,precipitationType:"rain"},57:{cloudCover:.76,precipitation:1,windSpeed:4,visibility:2,thunder:0,precipitationType:"rain"},61:{cloudCover:.78,precipitation:2,windSpeed:4,visibility:10,thunder:0,precipitationType:"rain"},63:{cloudCover:.85,precipitation:5,windSpeed:6,visibility:8,thunder:0,precipitationType:"rain"},65:{cloudCover:.92,precipitation:18,windSpeed:8,visibility:4,thunder:0,precipitationType:"rain"},66:{cloudCover:.85,precipitation:2,windSpeed:5,visibility:2,thunder:0,precipitationType:"rain"},67:{cloudCover:.9,precipitation:10,windSpeed:7,visibility:1,thunder:0,precipitationType:"rain"},71:{cloudCover:.78,precipitation:.8,windSpeed:4,visibility:3,thunder:0,precipitationType:"snow"},73:{cloudCover:.85,precipitation:2.5,windSpeed:5,visibility:2,thunder:0,precipitationType:"snow"},75:{cloudCover:.92,precipitation:8,windSpeed:7,visibility:1,thunder:0,precipitationType:"snow"},77:{cloudCover:.7,precipitation:.5,windSpeed:5,visibility:2,thunder:0,precipitationType:"snow"},80:{cloudCover:.55,precipitation:2.5,windSpeed:5,visibility:12,thunder:0,precipitationType:"rain",convection:.55},81:{cloudCover:.65,precipitation:6,windSpeed:6,visibility:8,thunder:0,precipitationType:"rain",convection:.7},82:{cloudCover:.75,precipitation:25,windSpeed:8,visibility:4,thunder:0,precipitationType:"rain",convection:.85},85:{cloudCover:.55,precipitation:1,windSpeed:5,visibility:4,thunder:0,precipitationType:"snow",convection:.45},86:{cloudCover:.7,precipitation:6,windSpeed:7,visibility:2,thunder:0,precipitationType:"snow",convection:.7},95:{cloudCover:.96,precipitation:15,windSpeed:10,visibility:5,thunder:1,precipitationType:"rain",convection:.75},96:{cloudCover:.97,precipitation:25,windSpeed:12,visibility:4,thunder:1,precipitationType:"rain",convection:.85},99:{cloudCover:.99,precipitation:45,windSpeed:15,visibility:3,thunder:1,precipitationType:"rain",convection:.95}},Jt={"clear-day":w(d({},m[0]),{cloudCover:.03,windSpeed:3}),"clear-night":w(d({},m[0]),{overlay:"clear-night",cloudCover:0,windSpeed:2}),"mostly-clear-day":w(d({},m[1]),{cloudCover:.15,windSpeed:3}),"mostly-clear-night":w(d({},m[1]),{overlay:"clear-night",cloudCover:.1,windSpeed:2}),"partly-cloudy-day":m[2],"partly-cloudy-night":m[2],"mostly-cloudy-day":w(d({},m[3]),{cloudCover:.78}),"mostly-cloudy-night":w(d({},m[3]),{cloudCover:.78}),overcast:m[3],fog:w(d({},m[45]),{overlay:"fog-bank"}),"drizzle-light":m[51],drizzle:m[53],"drizzle-heavy":m[55],"rain-light":m[61],rain:m[63],"rain-heavy":m[65],"freezing-rain":w(d({},m[67]),{overlay:"ice"}),"snow-light":m[71],snow:m[73],"snow-heavy":m[75],"snow-grains":m[77],"rain-showers-light":m[80],"rain-showers":m[81],"rain-showers-heavy":m[82],"snow-showers-light":m[85],"snow-showers":m[86],thunderstorm:m[95],"thunderstorm-hail":w(d({},m[96]),{overlay:"hail"}),"thunderstorm-hail-heavy":w(d({},m[99]),{overlay:"hail"})},Xt={tornado:{cloudCover:1,precipitation:60,windSpeed:75,visibility:.2,thunder:1,convection:1,precipitationType:"rain",overlay:"tornado",label:"Tornado"},waterspout:{cloudCover:.98,precipitation:45,windSpeed:55,visibility:.5,thunder:1,convection:.95,precipitationType:"rain",overlay:"tornado",label:"Waterspout"},hurricane:{cloudCover:1,precipitation:90,windSpeed:60,visibility:.2,thunder:.9,convection:1,precipitationType:"rain",overlay:"hurricane",label:"Hurricane"},"tropical-storm":{cloudCover:1,precipitation:45,windSpeed:35,visibility:.5,thunder:.7,convection:.8,precipitationType:"rain",overlay:"rain",label:"Tropical Storm"},derecho:{cloudCover:1,precipitation:40,windSpeed:50,visibility:1,thunder:1,convection:.95,precipitationType:"rain",overlay:"lightning",label:"Derecho"},squall:{cloudCover:.95,precipitation:25,windSpeed:30,visibility:2,thunder:.8,convection:.7,precipitationType:"rain",overlay:"rain",label:"Squall"},blizzard:{cloudCover:1,precipitation:20,windSpeed:28,visibility:.1,thunder:0,convection:0,precipitationType:"snow",overlay:"snow-blizzard",label:"Blizzard"},"ice-storm":{cloudCover:.95,precipitation:18,windSpeed:12,visibility:.5,thunder:0,convection:0,precipitationType:"rain",overlay:"ice",label:"Ice Storm"},sandstorm:{cloudCover:.95,precipitation:0,windSpeed:25,visibility:.05,thunder:0,convection:0,overlay:"sand",label:"Sandstorm"},"dust-storm":{cloudCover:.92,precipitation:0,windSpeed:20,visibility:.1,thunder:0,convection:0,overlay:"dust",label:"Dust Storm"},"volcanic-ash":{cloudCover:.95,precipitation:0,windSpeed:8,visibility:.3,thunder:0,convection:0,overlay:"ash",label:"Volcanic Ash"},"wildfire-smoke":{cloudCover:.9,precipitation:0,windSpeed:6,visibility:1,thunder:0,convection:0,overlay:"smoke",label:"Wildfire Smoke"},"forest-fire":{cloudCover:.88,precipitation:0,windSpeed:8,visibility:.5,thunder:0,convection:0,overlay:"fire",label:"Forest Fire"},smoke:{cloudCover:.8,precipitation:0,windSpeed:4,visibility:1.5,thunder:0,convection:0,overlay:"smoke",label:"Smoke"},ash:{cloudCover:.85,precipitation:0,windSpeed:5,visibility:.4,thunder:0,convection:0,overlay:"ash",label:"Ash"},haze:{cloudCover:.35,precipitation:0,windSpeed:3,visibility:5,thunder:0,convection:0,overlay:"haze",label:"Haze"},smog:{cloudCover:.55,precipitation:0,windSpeed:2,visibility:2,thunder:0,convection:0,overlay:"smoke",label:"Smog"},"acid-rain":{cloudCover:.8,precipitation:12,windSpeed:6,visibility:5,thunder:.2,convection:0,precipitationType:"rain",overlay:"acid-rain",label:"Acid Rain"},"flash-flood":{cloudCover:.85,precipitation:50,windSpeed:10,visibility:2,thunder:.4,convection:.5,precipitationType:"rain",overlay:"rain",label:"Flash Flood"},aurora:{cloudCover:.2,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"aurora",label:"Aurora"},eclipse:{cloudCover:.1,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"eclipse",label:"Solar Eclipse"},"eclipse-lunar":{cloudCover:.05,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"eclipse-lunar",label:"Lunar Eclipse"},"blood-moon":{cloudCover:.05,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"blood-moon",label:"Blood Moon"},rainbow:{cloudCover:.3,precipitation:0,windSpeed:4,visibility:35,thunder:0,convection:0,overlay:"rainbow",label:"Rainbow"},"meteor-shower":{cloudCover:.15,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"meteors",label:"Meteor Shower"},"meteor-impact":{cloudCover:.25,precipitation:0,windSpeed:6,visibility:30,thunder:.6,convection:0,overlay:"meteor-impact",label:"Meteor Impact"},"asteroid-impact":{cloudCover:.6,precipitation:0,windSpeed:20,visibility:10,thunder:1,convection:.5,overlay:"meteor-impact",label:"Asteroid Impact"},"close-approach":{cloudCover:.1,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"close-approach",label:"Asteroid Close Approach"},supermoon:{cloudCover:.05,precipitation:0,windSpeed:2,visibility:45,thunder:0,convection:0,overlay:"supermoon",label:"Supermoon"},earthquake:{cloudCover:.5,precipitation:0,windSpeed:4,visibility:20,thunder:0,convection:0,overlay:"earthquake",label:"Earthquake"},tsunami:{cloudCover:.85,precipitation:0,windSpeed:15,visibility:2,thunder:.2,convection:0,overlay:"tsunami",label:"Tsunami"},"volcanic-eruption":{cloudCover:1,precipitation:0,windSpeed:12,visibility:.05,thunder:.8,convection:.9,overlay:"volcano",label:"Volcanic Eruption"},landslide:{cloudCover:.65,precipitation:5,windSpeed:8,visibility:2,thunder:0,convection:0,overlay:"landslide",label:"Landslide"},mudslide:{cloudCover:.7,precipitation:15,windSpeed:10,visibility:1,thunder:0,convection:0,overlay:"mudslide",label:"Mudslide"},avalanche:{cloudCover:.8,precipitation:8,windSpeed:12,visibility:.5,thunder:0,convection:0,precipitationType:"snow",overlay:"avalanche",label:"Avalanche"},rockfall:{cloudCover:.4,precipitation:0,windSpeed:6,visibility:5,thunder:0,convection:0,overlay:"rockfall",label:"Rockfall"},"geological-event":{cloudCover:.55,precipitation:0,windSpeed:5,visibility:10,thunder:0,convection:0,overlay:"earthquake",label:"Geological Event"},apocalypse:{cloudCover:1,precipitation:80,windSpeed:40,visibility:.05,thunder:1,convection:1,precipitationType:"rain",overlay:"tornado",label:"Apocalypse"}},ea=d(d({},Jt),Xt),Ce=class{constructor(e){this.canvas=document.createElement("canvas"),this.canvas.id="fx-overlay",this.canvas.style.cssText="position:absolute;inset:0;width:100%;height:100%;pointer-events:none;z-index:1",e.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),this.effect=null,this.t=0,this.w=0,this.h=0,this.particles=[],this.lastTick=0,this.dpr=Math.min(typeof window!="undefined"&&window.devicePixelRatio||1,1.5)*.5,this.fps=20,this.resize(),window.addEventListener("resize",()=>this.resize()),this._tick()}resize(){this.w=this.canvas.clientWidth||window.innerWidth,this.h=this.canvas.clientHeight||window.innerHeight,this.canvas.width=Math.floor(this.w*this.dpr),this.canvas.height=Math.floor(this.h*this.dpr),this.ctx.setTransform(this.dpr,0,0,this.dpr,0,0)}setEffect(e){if(this.effect=e||null,this.t=0,this.particles=[],e&&["clear-day","clear-night","sand","dust","ash","smoke","haze","snow-blizzard","volcano","landslide","mudslide","avalanche","rockfall","earthquake","tsunami","acid-rain","fire","hail"].includes(e)){let o={"clear-day":35,"clear-night":60,sand:300,dust:250,ash:200,smoke:150,haze:100,"snow-blizzard":400,volcano:300,landslide:250,mudslide:300,avalanche:400,rockfall:200,earthquake:250,tsunami:0,"acid-rain":120,fire:150,hail:100}[e]||300;for(let a=0;a<o;a++)this.particles.push(this._newParticle(e))}let i=document.querySelector(".ww");i&&(i.style.transition="none",i.style.transform="")}_rand(e,i){return e+Math.random()*(i-e)}_newParticle(e){let i=this.w,o=this.h;switch(e){case"clear-day":return{x:this._rand(0,i),y:this._rand(0,o),r:this._rand(.8,2.2),v:this._rand(.2,.6),vy:this._rand(-.1,.1),op:this._rand(.15,.35),life:this._rand(120,240),type:"clear-day"};case"clear-night":return{x:this._rand(0,i),y:this._rand(0,o*.6),r:this._rand(.6,1.6),v:this._rand(.05,.15),vy:this._rand(-.03,.03),op:this._rand(.25,.7),life:this._rand(80,180),twinkle:this._rand(.5,1.2),phase:this._rand(0,Math.PI*2),type:"clear-night"};case"sand":case"dust":return{x:this._rand(-i,i),y:this._rand(0,o),r:this._rand(1,3),v:this._rand(12,25),vy:this._rand(-1,1),op:this._rand(.4,.9)};case"ash":return{x:this._rand(0,i),y:this._rand(-o,0),r:this._rand(1,4),v:this._rand(2,6),vy:this._rand(2,8),op:this._rand(.3,.8)};case"smoke":case"haze":return{x:this._rand(-i,i),y:this._rand(0,o),r:this._rand(20,80),v:this._rand(4,10),vy:this._rand(-.5,.5),op:this._rand(.05,.2),grow:this._rand(.2,.8)};case"snow-blizzard":return{x:this._rand(0,i),y:this._rand(-o,o),r:this._rand(1,3),v:this._rand(18,35),vy:this._rand(4,10),op:this._rand(.5,.95)};case"volcano":return{x:this._rand(i*.45,i*.55),y:this._rand(o*.55,o*.75),r:this._rand(2,6),v:this._rand(-2,6),vy:this._rand(-6,-1),op:this._rand(.4,.9),life:this._rand(20,80)};case"landslide":case"mudslide":return{x:this._rand(-100,i),y:this._rand(-50,o*.6),r:this._rand(3,10),v:this._rand(3,10),vy:this._rand(2,8),op:this._rand(.5,.9)};case"avalanche":return{x:this._rand(0,i),y:this._rand(-o,0),r:this._rand(2,6),v:this._rand(10,25),vy:this._rand(8,18),op:this._rand(.5,.95)};case"rockfall":return{x:this._rand(-50,i+50),y:this._rand(-o*.5,0),r:this._rand(3,12),v:this._rand(-2,4),vy:this._rand(4,14),op:this._rand(.5,.9),rot:this._rand(0,Math.PI*2),rotv:this._rand(-.2,.2)};case"earthquake":return{x:this._rand(0,i),y:this._rand(o*.6,o),r:this._rand(1,4),v:this._rand(-1,1),vy:this._rand(-1,-3),op:this._rand(.3,.7),life:this._rand(10,50)};case"acid-rain":return{x:this._rand(0,i),y:this._rand(0,o),len:this._rand(14,28),v:this._rand(9,16),op:this._rand(.35,.75)};case"hail":return{x:this._rand(0,i),y:this._rand(-o,0),r:this._rand(2,6),v:this._rand(6,16),vy:this._rand(18,32),op:this._rand(.55,.9),rot:this._rand(0,Math.PI*2),rotv:this._rand(-.3,.3)};case"fire":return{x:this._rand(0,i),y:this._rand(o*.55,o),r:this._rand(2,7),v:this._rand(-1,2),vy:this._rand(-3,-.5),op:this._rand(.4,.9),life:this._rand(20,70)};default:return{}}}_tick(e){let i=e||performance.now(),o=1e3/this.fps;if(i-this.lastTick<o){requestAnimationFrame(n=>this._tick(n));return}this.lastTick=i-(i-this.lastTick)%o,this.t++;let{ctx:a,w:s,h:r}=this;a.clearRect(0,0,s,r),this.effect==="tornado"?this._drawTornado(a,s,r):this.effect==="hurricane"?this._drawHurricane(a,s,r):this.effect==="lightning"?this._drawLightningBolts(a,s,r):this.effect==="hail"?this._drawHail(a,s,r):this.effect==="ice"?this._drawIce(a,s,r):this.effect==="aurora"?this._drawAurora(a,s,r):this.effect==="eclipse"?this._drawEclipse(a,s,r):this.effect==="eclipse-lunar"?this._drawLunarEclipse(a,s,r):this.effect==="blood-moon"?this._drawBloodMoon(a,s,r):this.effect==="supermoon"?this._drawSupermoon(a,s,r):this.effect==="close-approach"?this._drawCloseApproach(a,s,r):this.effect==="rainbow"?this._drawRainbow(a,s,r):this.effect==="meteors"?this._drawMeteors(a,s,r):this.effect==="meteor-impact"?this._drawMeteorImpact(a,s,r):this.effect==="earthquake"?this._drawEarthquake(a,s,r):this.effect==="tsunami"?this._drawTsunami(a,s,r):this.effect==="volcano"?this._drawVolcano(a,s,r):this.effect==="landslide"?this._drawLandslide(a,s,r):this.effect==="mudslide"?this._drawMudslide(a,s,r):this.effect==="avalanche"?this._drawAvalanche(a,s,r):this.effect==="rockfall"?this._drawRockfall(a,s,r):this.effect==="acid-rain"?this._drawAcidRain(a,s,r):this.effect==="fire"?this._drawFire(a,s,r):this.effect==="fog-bank"?this._drawFogBank(a,s,r):this.effect==="clear-day"?this._drawClearDay(a,s,r):this.effect==="clear-night"?this._drawClearNight(a,s,r):this.particles.length&&this._drawParticles(a,s,r),requestAnimationFrame(n=>this._tick(n))}_drawTornado(e,i,o){let a=i*.5,s=o*.95,r=this.t*.04;e.save(),e.globalCompositeOperation="source-over";let n=e.createLinearGradient(a,s,a,0);n.addColorStop(0,"rgba(20,20,25,0.9)"),n.addColorStop(.45,"rgba(60,60,70,0.5)"),n.addColorStop(1,"rgba(120,120,130,0)"),e.fillStyle=n,e.beginPath();for(let l=o;l>=0;l-=4){let h=1-l/o,u=140*(1-h)+12*h,c=Math.sin(r+l*.03)*(10*(1-h)+2);e.lineTo(a+c+u*.5,l)}for(let l=0;l<=o;l+=4){let h=l/o,u=140*h+12*(1-h),c=Math.sin(r+l*.03)*(10*h+2);e.lineTo(a+c-u*.5,l)}e.closePath(),e.fill(),e.globalCompositeOperation="screen";for(let l=0;l<40;l++){let h=r+l*.35,u=80+Math.sin(this.t*.1+l)*20,c=a+Math.cos(h)*u,v=s-20+Math.sin(h)*10;e.fillStyle=`rgba(180,170,160,${.3+Math.random()*.3})`,e.beginPath(),e.arc(c,v,1.5+Math.random()*2,0,Math.PI*2),e.fill()}e.restore()}_drawHurricane(e,i,o){let a=i*.5,s=o*.45,r=this.t*.015;e.save(),e.globalCompositeOperation="source-over";for(let l=0;l<4;l++){let h=r+l*(Math.PI/2);e.strokeStyle="rgba(60,60,70,0.35)",e.lineWidth=18,e.beginPath();for(let u=40;u<Math.max(i,o)*.8;u+=8){let c=h+u*.018,v=a+Math.cos(c)*u,f=s+Math.sin(c)*u;u===40?e.moveTo(v,f):e.lineTo(v,f)}e.stroke()}let n=e.createRadialGradient(a,s,5,a,s,45);n.addColorStop(0,"rgba(200,190,170,0.9)"),n.addColorStop(.6,"rgba(90,85,80,0.6)"),n.addColorStop(1,"rgba(40,40,45,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,45,0,Math.PI*2),e.fill(),e.restore()}_drawLightningBolts(e,i,o){if(Math.random()>.03)return;e.save(),e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,250,220,0.95)",e.lineWidth=2+Math.random()*3,e.shadowColor="#fff8c5",e.shadowBlur=20;let a=this._rand(i*.2,i*.8);e.beginPath(),e.moveTo(a,0);let s=a,r=0;for(;r<o*.6;)s+=this._rand(-30,30),r+=this._rand(15,40),e.lineTo(s,r);e.stroke(),e.restore()}_drawIce(e,i,o){e.save(),e.globalCompositeOperation="screen";for(let a=0;a<30;a++){let s=(this.t*.5+a*137)%(i+60)-30,r=a*79%(o+40)-20,n=8+a%7;e.strokeStyle=`rgba(200,230,255,${.15+a%5*.05})`,e.lineWidth=1,e.beginPath();for(let l=0;l<6;l++){let h=l*Math.PI/3+this.t*.02+a,u=n*.5,c=n;e.moveTo(s+Math.cos(h)*u,r+Math.sin(h)*u),e.lineTo(s+Math.cos(h)*c,r+Math.sin(h)*c)}e.stroke()}e.restore()}_drawHail(e,i,o){e.save(),e.globalCompositeOperation="source-over",e.shadowBlur=2,e.shadowColor="rgba(160, 190, 220, 0.35)";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,a.rot+=a.rotv,a.y>o+a.r&&(a.y=this._rand(-30,-10),a.x=this._rand(0,i),a.v=this._rand(6,16),a.vy=this._rand(18,32)),e.globalAlpha=a.op,e.fillStyle="#e8f0f8",e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.restore()}_drawAurora(e,i,o){e.save(),e.globalCompositeOperation="screen";let a=[{hue:140,baseY:.16,amp:55,speed:.015,thickness:110},{hue:165,baseY:.26,amp:70,speed:.011,thickness:130},{hue:195,baseY:.36,amp:50,speed:.02,thickness:90}];for(let s of a){let r=o*s.baseY,n=10;for(let l=0;l<=i;l+=n){let h=r+Math.sin(l*.012+this.t*s.speed)*s.amp+Math.sin(l*.004+this.t*s.speed*.6)*s.amp*.6,u=.55+.45*Math.sin(l*.05+this.t*.08),c=e.createLinearGradient(0,h-s.thickness*.5,0,h+s.thickness*.5);c.addColorStop(0,`hsla(${s.hue}, 85%, 65%, 0)`),c.addColorStop(.5,`hsla(${s.hue}, 85%, 65%, ${.22*u})`),c.addColorStop(1,`hsla(${s.hue}, 85%, 65%, 0)`),e.fillStyle=c,e.fillRect(l,h-s.thickness*.5,n+2,s.thickness)}}e.restore()}_drawEclipse(e,i,o){let a=i*.5,s=o*.25,r=Math.min(i,o)*.12;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.9,a,s,r*1.6);n.addColorStop(0,"rgba(255,240,200,0.9)"),n.addColorStop(.5,"rgba(255,220,120,0.4)"),n.addColorStop(1,"rgba(255,200,80,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*1.6,0,Math.PI*2),e.fill(),e.fillStyle="rgba(10,10,12,0.85)",e.beginPath(),e.arc(a+r*.15,s,r,0,Math.PI*2),e.fill(),e.restore()}_drawLunarEclipse(e,i,o){let a=i*.5,s=o*.28,r=Math.min(i,o)*.11;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.8,a,s,r*2.2);n.addColorStop(0,"rgba(226,232,240,0.35)"),n.addColorStop(1,"rgba(226,232,240,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*2.2,0,Math.PI*2),e.fill(),e.fillStyle="#e8edf4",e.beginPath(),e.arc(a,s,r,0,Math.PI*2),e.fill();let l=.5+.5*Math.sin(this.t*.01);e.globalAlpha=.82,e.fillStyle="#1e293b",e.beginPath(),e.arc(a+r*(.55+.25*l),s-r*.1,r*1.05,0,Math.PI*2),e.fill(),e.restore()}_drawBloodMoon(e,i,o){let a=i*.5,s=o*.28,r=Math.min(i,o)*.11;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.7,a,s,r*2.6);n.addColorStop(0,"rgba(220,38,38,0.30)"),n.addColorStop(1,"rgba(220,38,38,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*2.6,0,Math.PI*2),e.fill();let l=e.createRadialGradient(a-r*.3,s-r*.3,r*.1,a,s,r);l.addColorStop(0,"#c2410c"),l.addColorStop(.55,"#9a3412"),l.addColorStop(1,"#5c1a0a"),e.fillStyle=l,e.beginPath(),e.arc(a,s,r,0,Math.PI*2),e.fill(),e.globalAlpha=.35,e.fillStyle="#7c2d12",e.beginPath(),e.arc(a-r*.25,s-r*.15,r*.28,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(a+r*.3,s+r*.3,r*.2,0,Math.PI*2),e.fill(),e.restore()}_drawSupermoon(e,i,o){let a=i*.5,s=o*.3,r=Math.min(i,o)*.16;e.save(),e.globalCompositeOperation="source-over";let n=e.createRadialGradient(a,s,r*.9,a,s,r*2.4);n.addColorStop(0,"rgba(255,250,230,0.45)"),n.addColorStop(1,"rgba(255,250,230,0)"),e.fillStyle=n,e.beginPath(),e.arc(a,s,r*2.4,0,Math.PI*2),e.fill();let l=e.createRadialGradient(a-r*.3,s-r*.3,r*.1,a,s,r);l.addColorStop(0,"#fffdf2"),l.addColorStop(1,"#f3ecd0"),e.fillStyle=l,e.beginPath(),e.arc(a,s,r,0,Math.PI*2),e.fill(),e.globalAlpha=.18,e.fillStyle="#c9c0a0",e.beginPath(),e.arc(a-r*.28,s-r*.2,r*.22,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(a+r*.32,s+r*.15,r*.16,0,Math.PI*2),e.fill(),e.beginPath(),e.arc(a+r*.05,s-r*.4,r*.12,0,Math.PI*2),e.fill(),e.restore()}_drawCloseApproach(e,i,o){let a=i*(.15+.7*(this.t*.0025%1)),s=o*(.15+.1*Math.sin(this.t*.01));e.save(),e.globalCompositeOperation="screen";let r=e.createRadialGradient(a,s,0,a,s,5);r.addColorStop(0,"rgba(226,232,240,0.9)"),r.addColorStop(1,"rgba(226,232,240,0)"),e.fillStyle=r,e.beginPath(),e.arc(a,s,5,0,Math.PI*2),e.fill(),e.fillStyle="#e2e8f0",e.beginPath(),e.arc(a,s,1.3,0,Math.PI*2),e.fill(),e.restore()}_drawRainbow(e,i,o){let a=i*.5,s=o*.95,r=Math.min(i,o)*.75;e.save(),e.globalCompositeOperation="screen";let n=["#ff0000","#ff7f00","#ffff00","#00ff00","#0000ff","#4b0082","#9400d3"];for(let l=0;l<n.length;l++){let h=r-l*8;e.strokeStyle=n[l],e.lineWidth=7,e.globalAlpha=.55,e.beginPath(),e.arc(a,s,h,Math.PI,0),e.stroke()}e.restore()}_drawFogBank(e,i,o){e.save(),e.globalCompositeOperation="source-over";let a=5;for(let r=0;r<a;r++){let n=o*(.25+r*.16),l=Math.sin(this.t*.006+r*1.7)*40,h=Math.sin(this.t*.01+r)*12,u=e.createLinearGradient(0,n-60+h,0,n+60+h);u.addColorStop(0,"rgba(235,238,242,0)"),u.addColorStop(.5,`rgba(235,238,242,${.22-r*.02})`),u.addColorStop(1,"rgba(235,238,242,0)"),e.fillStyle=u,e.fillRect(l-100,0,i+200,o)}let s=e.createLinearGradient(0,0,0,o);s.addColorStop(0,"rgba(240,242,246,0.06)"),s.addColorStop(1,"rgba(240,242,246,0.28)"),e.fillStyle=s,e.fillRect(0,0,i,o),e.restore()}_drawParticles(e,i,o){let a=this.effect;if(e.save(),a==="sand"||a==="dust"){e.fillStyle=a==="sand"?"rgba(194,160,120,":"rgba(160,150,130,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.x>i+50&&(s.x=-50,s.y=this._rand(0,o)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.globalAlpha=a==="sand"?.25:.18,e.fillStyle=a==="sand"?"#c2a078":"#a69b8a",e.fillRect(0,0,i,o)}else if(a==="ash"){e.fillStyle="rgba(60,55,55,";for(let s of this.particles)s.x+=Math.sin(this.t*.02+s.y*.01)*.5,s.y+=s.vy,s.y>o+10&&(s.y=-10,s.x=this._rand(0,i)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.globalAlpha=.15,e.fillStyle="#6b2e1d",e.fillRect(0,0,i,o)}else if(a==="smoke"||a==="haze")for(let s of this.particles){s.x+=s.v,s.y+=s.vy,s.r+=s.grow,s.x>i+s.r&&(s.x=-s.r,s.y=this._rand(0,o),s.r=this._rand(20,80));let r=a==="smoke"?"80,70,60":"120,110,100";e.fillStyle=`rgba(${r},${s.op})`,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill()}else if(a==="snow-blizzard"){e.fillStyle="rgba(255,250,240,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.x>i+20&&(s.x=-20,s.y=this._rand(0,o)),s.y>o+20&&(s.y=-20,s.x=this._rand(0,i)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill()}e.restore()}_drawMeteors(e,i,o){e.save(),e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,255,240,0.9)",e.lineWidth=2,e.shadowColor="#fff",e.shadowBlur=6;for(let a=0;a<5;a++){if(Math.random()>.25)continue;let s=this._rand(i*.1,i*.9),r=this._rand(0,o*.4),n=this._rand(40,120),l=this._rand(Math.PI*.2,Math.PI*.8);e.beginPath(),e.moveTo(s,r),e.lineTo(s+Math.cos(l)*n,r+Math.sin(l)*n),e.stroke()}e.restore()}_drawMeteorImpact(e,i,o){e.save();let a=this.t;a<40&&(e.globalCompositeOperation="screen",e.fillStyle=`rgba(255,240,200,${Math.max(0,.9-a/40)})`,e.fillRect(0,0,i,o));let s=a*3%300;e.globalCompositeOperation="screen",e.strokeStyle="rgba(255,220,160,0.4)",e.lineWidth=3,e.beginPath(),e.arc(i*.5,o*.3,s,0,Math.PI*2),e.stroke(),e.strokeStyle="rgba(255,160,60,0.85)",e.lineWidth=4,e.shadowColor="#ff8a00",e.shadowBlur=15;let r=i*.5+a*.4,n=o*.3+a*.9;e.beginPath(),e.moveTo(r,n),e.lineTo(r-40,n-90),e.stroke(),e.restore()}_drawEarthquake(e,i,o){let a=document.querySelector(".ww");if(a){let s=(Math.random()-.5)*6,r=(Math.random()-.5)*4;a.style.transform=`translate(${s}px, ${r}px)`}e.save(),e.fillStyle="rgba(120,110,100,";for(let s of this.particles)s.x+=s.v,s.y+=s.vy,s.life--,s.life<=0&&(s.x=this._rand(0,i),s.y=this._rand(o*.7,o),s.life=this._rand(10,50)),e.globalAlpha=s.op,e.beginPath(),e.arc(s.x,s.y,s.r,0,Math.PI*2),e.fill();e.strokeStyle="rgba(30,25,20,0.6)",e.lineWidth=2,e.beginPath(),e.moveTo(i*.2,o),e.lineTo(i*.35,o*.82),e.lineTo(i*.5,o*.88),e.lineTo(i*.8,o),e.stroke(),e.restore()}_drawTsunami(e,i,o){e.save(),e.globalCompositeOperation="source-over",e.fillStyle="rgba(10,25,40,0.35)",e.fillRect(0,0,i,o);let a=o*.55+Math.sin(this.t*.03)*20,s=e.createLinearGradient(0,o-a,0,o);s.addColorStop(0,"rgba(20,60,90,0.7)"),s.addColorStop(.6,"rgba(10,40,70,0.9)"),s.addColorStop(1,"rgba(5,25,50,0.95)"),e.fillStyle=s,e.beginPath(),e.moveTo(0,o);for(let r=0;r<=i;r+=20){let n=o-a+Math.sin(r*.02+this.t*.06)*25;e.lineTo(r,n)}e.lineTo(i,o),e.closePath(),e.fill(),e.strokeStyle="rgba(220,240,255,0.6)",e.lineWidth=5,e.beginPath();for(let r=0;r<=i;r+=20){let n=o-a+Math.sin(r*.02+this.t*.06)*25;r===0?e.moveTo(r,n):e.lineTo(r,n)}e.stroke(),e.restore()}_drawVolcano(e,i,o){e.save();let a=i*.5,s=o*.62;e.fillStyle="rgba(20,15,12,0.95)",e.beginPath(),e.moveTo(0,o),e.lineTo(a,s),e.lineTo(i,o),e.closePath(),e.fill();let r=e.createRadialGradient(a,s,4,a,s-120,90);r.addColorStop(0,"rgba(60,55,50,0.95)"),r.addColorStop(.5,"rgba(90,80,70,0.7)"),r.addColorStop(1,"rgba(120,110,100,0)"),e.fillStyle=r,e.beginPath(),e.arc(a,s-60,100+Math.sin(this.t*.05)*20,0,Math.PI*2),e.fill(),e.globalCompositeOperation="screen";for(let n of this.particles)n.x+=n.v,n.y+=n.vy,n.vy+=.15,(n.y>o||n.life--<=0)&&(n.x=this._rand(i*.48,i*.52),n.y=this._rand(o*.58,o*.65),n.vy=this._rand(-6,-1),n.v=this._rand(-2,4),n.life=this._rand(20,80)),e.fillStyle=`rgba(255,${Math.floor(80+Math.random()*80)},30,${n.op})`,e.shadowColor="#ff4500",e.shadowBlur=8,e.beginPath(),e.arc(n.x,n.y,n.r,0,Math.PI*2),e.fill();e.globalCompositeOperation="source-over",e.fillStyle="rgba(80,70,65,0.18)",e.fillRect(0,0,i,o),e.restore()}_drawLandslide(e,i,o){e.save(),e.fillStyle="rgba(90,75,55,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,(a.x>i+50||a.y>o+50)&&(a.x=this._rand(-100,i),a.y=this._rand(-50,o*.5)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.25,e.fillStyle="#5c4a35",e.beginPath(),e.moveTo(0,o*.45),e.lineTo(i,o*.35),e.lineTo(i,o),e.lineTo(0,o),e.closePath(),e.fill(),e.restore()}_drawMudslide(e,i,o){e.save(),e.fillStyle="rgba(75,60,45,";for(let a of this.particles)a.x+=a.v*1.2,a.y+=a.vy*1.2,(a.x>i+50||a.y>o+50)&&(a.x=this._rand(-100,i),a.y=this._rand(-50,o*.5)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.35,e.fillStyle="#4a3b2a",e.fillRect(0,o*.5,i,o*.5),e.restore()}_drawAvalanche(e,i,o){e.save(),e.fillStyle="rgba(245,245,255,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,a.y>o+20&&(a.y=this._rand(-o,0),a.x=this._rand(0,i)),e.globalAlpha=a.op,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill();e.globalAlpha=.3,e.fillStyle="#e8eef5",e.beginPath(),e.moveTo(0,0),e.lineTo(i,0),e.lineTo(i,o*.55),e.lineTo(0,o*.65),e.closePath(),e.fill(),e.restore()}_drawRockfall(e,i,o){e.save(),e.fillStyle="rgba(90,85,80,";for(let a of this.particles)a.x+=a.v,a.y+=a.vy,a.rot+=a.rotv,a.vy+=.2,a.y>o+20&&(a.y=this._rand(-o*.5,0),a.x=this._rand(-50,i+50),a.vy=this._rand(4,14)),e.globalAlpha=a.op,e.save(),e.translate(a.x,a.y),e.rotate(a.rot),e.fillRect(-a.r,-a.r,a.r*2,a.r*2),e.restore();e.restore()}_drawAcidRain(e,i,o){e.save(),e.globalCompositeOperation="source-over",e.fillStyle="rgba(160,180,60,0.15)",e.fillRect(0,0,i,o);for(let a of this.particles)a.y+=a.v,a.y>o+20&&(a.y=-10,a.x=this._rand(0,i)),e.strokeStyle=`rgba(200,230,80,${a.op})`,e.lineWidth=2,e.lineCap="round",e.beginPath(),e.moveTo(a.x,a.y),e.lineTo(a.x-2,a.y+a.len),e.stroke();e.restore()}_drawFire(e,i,o){e.save(),e.globalCompositeOperation="screen";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.vy+=.05,a.life--,(a.life<=0||a.y<o*.3)&&(a.x=this._rand(i*.1,i*.9),a.y=this._rand(o*.7,o),a.vy=this._rand(-3,-.5),a.v=this._rand(-1,1),a.life=this._rand(20,70));let s=a.r*(a.life/70);e.fillStyle=`rgba(255,${Math.floor(100+Math.random()*100)},30,${a.op})`,e.shadowColor="#ff6b00",e.shadowBlur=10,e.beginPath(),e.arc(a.x,a.y,s,0,Math.PI*2),e.fill()}e.globalCompositeOperation="source-over",e.fillStyle="rgba(60,55,50,0.2)",e.fillRect(0,0,i,o),e.restore()}_drawClearDay(e,i,o){e.save(),e.globalCompositeOperation="source-over";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.life--,(a.x>i+20||a.y<-20||a.life<=0)&&(a.x=this._rand(-20,i),a.y=this._rand(o*.2,o),a.v=this._rand(.3,.8),a.vy=this._rand(-.12,.12),a.life=this._rand(180,360));let s=.7+.3*Math.sin(this.t*.05+a.x*.01);e.globalAlpha=a.op*s,e.fillStyle="#ffffff",e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill(),e.globalAlpha=1}e.restore()}_drawClearNight(e,i,o){e.save(),e.globalCompositeOperation="screen";for(let a of this.particles){a.x+=a.v,a.y+=a.vy,a.life--;let s=.5+.5*Math.sin(this.t*a.twinkle+a.phase);(a.life<=0||a.y<-10||a.x>i+10)&&(a.x=this._rand(0,i),a.y=this._rand(o*.1,o*.7),a.v=this._rand(.05,.15),a.vy=this._rand(-.05,.05),a.life=this._rand(150,320),a.twinkle=this._rand(.08,.18),a.phase=this._rand(0,Math.PI*2)),e.fillStyle=`rgba(255,245,220,${a.op*s})`,e.beginPath(),e.arc(a.x,a.y,a.r,0,Math.PI*2),e.fill()}if(Math.random()<.012){let a=this._rand(i*.1,i*.9),s=this._rand(0,o*.4),r=this._rand(20,60),n=this._rand(Math.PI*.25,Math.PI*.55);e.strokeStyle="rgba(255,245,220,0.8)",e.lineWidth=1.5,e.beginPath(),e.moveTo(a,s),e.lineTo(a-Math.cos(n)*r,s+Math.sin(n)*r),e.stroke()}e.restore()}},Q=class{constructor(e,i={},o={}){this.canvas=e,this.colors=i,this.location=o.location||Qt,this.timeOffsetMs=0,this.forceDay=o.forceDay||!1,this.forceNight=o.forceNight||!1,this.currentKey=null,this.currentParams=null,this.overlayEffect=null;let a=e.parentElement;a&&!a.querySelector("#fx-overlay")&&(this.overlay=new Ce(a));try{this.sky=new Je(e,{time:this._now(),location:this.location,weather:m[0],resolutionScale:.55,fps:24,colorSpace:"srgb",celestial:{bortle:6,milkyWay:0,meteors:0}})}catch(s){console.error("Atmosphere initialization failed",s),this.sky=null}}_now(){let e=new Date(Date.now()+this.timeOffsetMs);if(!this.forceDay&&!this.forceNight)return e;let i=new Date(e.getFullYear(),e.getMonth(),e.getDate(),12,0,0),o=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0);return this.forceDay?i:o}setSunState(e,i){this.sky&&(this.timeOffsetMs=0,this.sky.set({time:this._now()}))}setCondition(e){this.currentKey=e||"clear-day";let i=ea[this.currentKey]||m[0];this.currentParams=d({},i),this.currentKey.includes("night")&&this.currentParams.isNightAdjusted,this.currentParams.precipitation>0&&!this.currentParams.precipitationType&&(this.currentParams.precipitationType="rain"),this.sky&&this.sky.set({time:this._now(),weather:{cloudCover:this.currentParams.cloudCover,precipitation:this.currentParams.precipitation,precipitationType:this.currentParams.precipitationType,windSpeed:this.currentParams.windSpeed,visibility:this.currentParams.visibility,thunder:this.currentParams.thunder||0,convection:this.currentParams.convection||0}}),this.overlayEffect=this.currentParams.overlay||null,this.overlay&&this.overlay.setEffect(this.overlayEffect)}setWeatherData(e){e=e||{};let i=this.currentParams||{},o=e.cloudCover,a=e.precipitation,s=e.windSpeed,r=e.visibility,n=e.thunder,l=e.precipitationType;this.sky&&this.sky.set({time:this._now(),weather:{cloudCover:o!=null?o:i.cloudCover!=null?i.cloudCover:0,precipitation:a!=null?a:i.precipitation!=null?i.precipitation:0,windSpeed:s!=null?s:i.windSpeed!=null?i.windSpeed:2,visibility:r!=null?r:i.visibility!=null?i.visibility:45,thunder:n!=null?n:i.thunder!=null?i.thunder:0,precipitationType:l!=null?l:i.precipitationType!=null?i.precipitationType:"rain"}})}dispose(){this.sky&&(this.sky.stop&&this.sky.stop(),this.sky.dispose&&this.sky.dispose()),this.overlay&&this.overlay.canvas.remove()}};window.WeatherAtmosphere=Q;var q=37.8991768,G=-122.4949685,F="America/Los_Angeles",ta=900*1e3;var H=document.documentElement.getAttribute("data-theme")||"day",de=new URLSearchParams(location.search).get("scene");function k(t){return getComputedStyle(document.documentElement).getPropertyValue(t).trim()}function E(t,e=8e3,i){return P(this,null,function*(){let o=new AbortController,a=setTimeout(()=>o.abort(),e);try{return yield fetch(t,Object.assign({},i,{signal:o.signal}))}finally{clearTimeout(a)}})}function Xe(t){let e=parseInt(t.slice(1),16);return[e>>16&255,e>>8&255,e&255]}function aa([t,e,i]){return"#"+[t,e,i].map(o=>Math.round(Math.max(0,Math.min(255,o))).toString(16).padStart(2,"0")).join("")}function Te(t,e,i){let o=Xe(t),a=Xe(e);return aa([o[0]+(a[0]-o[0])*i,o[1]+(a[1]-o[1])*i,o[2]+(a[2]-o[2])*i])}var ia=[[0,"#7fa8cf","#ffcf9e","#fff6ea"],[.25,"#5b9bda","#bfe0f0","#eef7fa"],[.55,"#4a90d9","#8ec9ee","#eaf6fc"],[1,"#3f86d4","#8ec9ee","#e8f4fb"]],oa=[[0,"#140a1e","#3a2210","#0d0800"],[-.15,"#0a0614","#20120a","#050301"],[-.45,"#050308","#0f0803","#000000"],[-1,"#020104","#080402","#000000"]];function sa(t){let e=H==="night"?oa:ia,i=H==="night"?-Math.abs(t):Math.abs(t),o=e[0],a=e[e.length-1];for(let n=0;n<e.length-1;n++){let l=e[n],h=e[n+1];if(H==="night"?i<=l[0]&&i>=h[0]:i>=l[0]&&i<=h[0]){o=l,a=h;break}}let s=a[0]-o[0],r=s!==0?(i-o[0])/s:0;return{top:Te(o[1],a[1],Math.max(0,Math.min(1,r))),mid:Te(o[2],a[2],Math.max(0,Math.min(1,r))),bottom:Te(o[3],a[3],Math.max(0,Math.min(1,r)))}}var S=1;function U(t,e){let i=new Date(t.endsWith("Z")?t:t+"Z"),o=new Date(i.toLocaleString("en-US",{timeZone:e})),s=new Date(i.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-o.getTime();return new Date(i.getTime()+s)}function Le(t){let e=new Date,i=U(t.sunrise[S],F),o=U(t.sunset[S],F),a;if(e>=i&&e<=o){let n=(e-i)/(o-i);a={frac:n,elevation:Math.sin(Math.PI*n)}}else if(e<i){let n=U(t.sunset[S-1],F),l=Math.max(0,Math.min(1,(e-n)/(i-n)));a={frac:l,elevation:-Math.sin(Math.PI*l)}}else{let n=t.sunrise[S+1]?U(t.sunrise[S+1],F):new Date(o.getTime()+432e5),l=Math.max(0,Math.min(1,(e-o)/(n-o)));a={frac:l,elevation:-Math.sin(Math.PI*l)}}let s=sa(a.elevation),r=document.documentElement;return r.style.setProperty("--sky-top",s.top),r.style.setProperty("--sky-mid",s.mid),r.style.setProperty("--sky-bottom",s.bottom),a}function Ae(t){return`${Math.round(t)}\xB0`}function ra(t){return t==null?{label:"\u2014",color:"var(--fg3)",desc:"Air quality data is unavailable right now."}:t<=50?{label:"Good",color:"var(--good)",desc:"Air quality is good. Enjoy your usual outdoor activities."}:t<=100?{label:"Moderate",color:"var(--warn)",desc:"Air quality is acceptable, though there may be a risk for sensitive groups."}:t<=150?{label:"Unhealthy (SG)",color:"var(--warn)",desc:"Sensitive groups may experience health effects. Others are unlikely to be affected."}:t<=200?{label:"Unhealthy",color:"var(--bad)",desc:"Everyone may begin to experience health effects; sensitive groups more so."}:t<=300?{label:"Very Unhealthy",color:"var(--bad)",desc:"Health alert: everyone may experience more serious health effects."}:{label:"Hazardous",color:"var(--bad)",desc:"Health warning of emergency conditions. Everyone is at risk."}}function na(t){return["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"][Math.round(t/22.5)%16]}function la(t,e){return`<svg viewBox="0 0 100 100">
  ...
  </svg>`}function ha(t,e){let o=new Date(t).getHours(),a=o>=12?"PM":"AM";return o=o%12,o===0&&(o=12),e?`${o}${a}`:"NOW"}function ua(t,e){if(!e)return"NOW";let i=new Date(t),o=i.getHours(),a=i.getMinutes().toString().padStart(2,"0"),s=o>=12?"PM":"AM";return o=o%12,o===0&&(o=12),`${o}:${a}`}function da(t,e){return e===0?"Today":new Date(t+"T00:00:00").toLocaleDateString("en-US",{weekday:"short"})}function ca(){return P(this,null,function*(){let e=`https://api.open-meteo.com/v1/forecast?${`latitude=${q}&longitude=${G}&cell_selection=land&elevation=4`}&current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,weather_code,cloud_cover,wind_speed_10m,wind_direction_10m,precipitation&minutely_15=temperature_2m,weather_code,precipitation_probability,is_day,cloud_cover&hourly=temperature_2m,weather_code,precipitation_probability,visibility,is_day,cloud_cover&daily=weather_code,temperature_2m_max,temperature_2m_min,precipitation_probability_max,sunrise,sunset,uv_index_max&temperature_unit=fahrenheit&wind_speed_unit=mph&precipitation_unit=inch&timezone=${encodeURIComponent(F)}&forecast_days=7&past_days=1`,i=`https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${q}&longitude=${G}&current=us_aqi&timezone=${encodeURIComponent(F)}`,[o,a,s]=yield Promise.all([E(e).then(r=>r.json()),E(i).then(r=>r.json()).catch(()=>null),Sa()]);return{weather:o,aq:a,skyCoverIntervals:s}})}var X=null,Pe=null,Ee=null,fa=`https://api.weather.gov/alerts/active?status=actual&point=${q},${G}`,ma=`https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&latitude=${q}&longitude=${G}&maxradiuskm=200&minmagnitude=4.0&starttime=`,pa="https://noaa-storm-proxy.iamflying29-sketch.deno.net",va="https://services.swpc.noaa.gov/products/noaa-planetary-k-index.json",ga="https://services.swpc.noaa.gov/json/ovation_aurora_latest.json",ya="https://api.nasa.gov/neo/rest/v1/feed",wa="DEMO_KEY",ba="https://api.weather.gov/gridpoints/MTR/83,111";function ka(t){let e=/^P(?:(\d+)D)?T(?:(\d+)H)?(?:(\d+)M)?/.exec(t||"");if(!e)return 0;let i=parseInt(e[1]||"0",10),o=parseInt(e[2]||"0",10),a=parseInt(e[3]||"0",10);return((i*24+o)*60+a)*60*1e3}function _a(t){return!t||!Array.isArray(t.values)?[]:t.values.map(e=>{let[i,o]=e.validTime.split("/"),a=new Date(i),s=new Date(a.getTime()+ka(o));return{start:a,end:s,value:e.value}})}function Sa(){return P(this,null,function*(){try{let t=yield E(ba);if(!t.ok)return null;let e=yield t.json();return _a(e.properties&&e.properties.skyCover)}catch(t){return console.warn("NWS gridpoint skyCover fetch failed",t),null}})}function Fe(t,e){if(!t||!t.length)return null;for(let i of t)if(e>=i.start&&e<i.end)return i.value;return null}function Ma(t,e){if(!t||!t.length)return null;let i=[];for(let o=9;o<=18;o++){let a=U(`${e}T${String(o).padStart(2,"0")}:00:00`,F),s=Fe(t,a);s!=null&&i.push(s)}return i.length?i.reduce((o,a)=>o+a,0)/i.length:null}function Ca(t,e){if(!t||!t.time)return null;let i=new Map;for(let a=0;a<t.time.length;a++){if(t.time[a].slice(0,10)!==e)continue;let s=parseInt(t.time[a].slice(11,13),10);if(s<9||s>18)continue;let r=t.weather_code[a];i.set(r,(i.get(r)||0)+1)}if(!i.size)return null;let o=null;for(let[a,s]of i)(!o||s>o.n||s===o.n&&a>o.code)&&(o={code:a,n:s});return o.code}var Ta=[{re:/tornado warning/i,key:"tornado",label:"Tornado Warning",severity:5},{re:/tsunami warning/i,key:"tsunami",label:"Tsunami Warning",severity:5},{re:/hurricane warning|typhoon warning|hurricane force wind warning/i,key:"hurricane",label:"Hurricane Warning",severity:4},{re:/tropical storm warning/i,key:"tropical-storm",label:"Tropical Storm Warning",severity:4},{re:/flash flood warning/i,key:"flash-flood",label:"Flash Flood Warning",severity:4},{re:/severe thunderstorm warning/i,key:"thunderstorm-hail",label:"Severe Thunderstorm Warning",severity:3},{re:/tornado watch|severe thunderstorm watch/i,key:"thunderstorm",label:"Severe Weather Watch",severity:2},{re:/fire warning/i,key:"forest-fire",label:"Fire Warning",severity:4},{re:/extreme fire danger|fire weather watch|red flag warning/i,key:"wildfire-smoke",label:"Fire Weather Warning",severity:3},{re:/dust storm warning|blowing dust warning/i,key:"dust-storm",label:"Dust Storm Warning",severity:3},{re:/dust advisory|blowing dust advisory/i,key:"dust-storm",label:"Blowing Dust Advisory",severity:2},{re:/blizzard warning|winter storm warning/i,key:"blizzard",label:"Winter Storm Warning",severity:3},{re:/ice storm warning/i,key:"ice-storm",label:"Ice Storm Warning",severity:3},{re:/volcano warning/i,key:"volcanic-eruption",label:"Volcano Warning",severity:4},{re:/ashfall warning/i,key:"volcanic-ash",label:"Ashfall Warning",severity:3},{re:/ashfall advisory/i,key:"ash",label:"Ashfall Advisory",severity:2},{re:/avalanche warning/i,key:"avalanche",label:"Avalanche Warning",severity:3},{re:/avalanche watch|avalanche advisory/i,key:"avalanche",label:"Avalanche Advisory",severity:2},{re:/snow squall warning/i,key:"squall",label:"Snow Squall Warning",severity:2},{re:/earthquake warning/i,key:"earthquake",label:"Earthquake Warning",severity:4},{re:/dense smoke advisory/i,key:"smoke",label:"Dense Smoke Advisory",severity:2},{re:/air quality alert/i,key:"smog",label:"Air Quality Alert",severity:1},{re:/special marine warning/i,key:"waterspout",label:"Special Marine Warning",severity:2}];function Aa(t){return{Extreme:4,Severe:3,Moderate:2,Minor:1,Unknown:0}[t]||0}function za(){return P(this,null,function*(){try{let t=yield E(fa);if(!t.ok)return[];let e=yield t.json();return Array.isArray(e.features)?e.features:[]}catch(t){return console.warn("NWS alerts fetch failed",t),[]}})}function La(){return P(this,null,function*(){try{let t=new Date(Date.now()-864e5).toISOString(),e=yield E(ma+encodeURIComponent(t));if(!e.ok)return null;let i=yield e.json();if(!i.features||!i.features.length)return null;let o=i.features[0];return{magnitude:o.properties.mag,place:o.properties.place,time:o.properties.time}}catch(t){return console.warn("USGS earthquake fetch failed",t),null}})}function Pa(){return P(this,null,function*(){try{let t=yield E(`${pa}?v=1`);return t.ok?yield t.json():null}catch(t){return console.warn("NOAA/NHC storm fetch failed",t),null}})}function Ea(){return P(this,null,function*(){try{let[t,e]=yield Promise.all([E(va).then(a=>a.ok?a.json():null).catch(()=>null),E(ga).then(a=>a.ok?a.json():null).catch(()=>null)]),i=null;if(Array.isArray(t)&&t.length){let a=t[t.length-1];i=a&&a.Kp!=null?Number(a.Kp):null}let o=null;if(e&&Array.isArray(e.coordinates)){let a=(360+G)%360,s=null;for(let r of e.coordinates){let n=Math.abs(r[0]-a)+Math.abs(r[1]-q);(!s||n<s.dist)&&(s={val:r[2],dist:n})}o=s?s.val:null}return i==null&&o==null?null:{kp:i,ovationValue:o}}catch(t){return console.warn("Aurora data fetch failed",t),null}})}function Fa(){return P(this,null,function*(){let t="neoCloseApproachCacheV1",e=new Date().toISOString().slice(0,10),i=null;try{i=JSON.parse(localStorage.getItem(t)||"null")}catch(o){i=null}if(i&&i.date===e)return i.result;try{let o=`${ya}?start_date=${e}&end_date=${e}&api_key=${wa}`,a=yield E(o);if(!a.ok)return i?i.result:null;let s=yield a.json(),r=null,n=s.near_earth_objects||{};for(let l of Object.keys(n))for(let h of n[l]){let u=h.estimated_diameter&&h.estimated_diameter.meters?h.estimated_diameter.meters.estimated_diameter_max:0;for(let c of h.close_approach_data||[]){let v=c.miss_distance?Number(c.miss_distance.kilometers):NaN;u>=100&&v&&v<=384400&&(r={name:(h.name||"").replace(/[()]/g,""),diameter:Math.round(u),distKm:Math.round(v)})}}try{localStorage.setItem(t,JSON.stringify({date:e,result:r}))}catch(l){}return r}catch(o){return console.warn("NASA NEO fetch failed",o),i?i.result:null}})}function xa(t,e,i){let o=null;for(let a of t){let s=a.properties.event||"",r=Aa(a.properties.severity);for(let n of Ta)if(n.re.test(s)){let l=n.severity*10+r;(!o||l>o.score)&&(o=w(d({},n),{score:l}))}}return o?{key:o.key,label:o.label,source:"NWS"}:e?{key:"earthquake",label:`Earthquake M${e.magnitude}`,source:"USGS"}:null}var at=[{penumbral:["2026-03-03T08:44:00Z","2026-03-03T14:23:00Z"],umbral:["2026-03-03T09:50:00Z","2026-03-03T13:17:00Z"],total:["2026-03-03T11:04:00Z","2026-03-03T12:03:00Z"]},{penumbral:["2026-08-28T01:23:00Z","2026-08-28T07:02:00Z"],umbral:["2026-08-28T02:33:00Z","2026-08-28T05:52:00Z"],bloodAtMax:!0,maxWindow:["2026-08-28T03:43:00Z","2026-08-28T04:43:00Z"]},{penumbral:["2028-01-12T02:00:00Z","2028-01-12T06:30:00Z"],umbral:["2028-01-12T03:46:00Z","2028-01-12T04:42:00Z"]},{penumbral:["2028-12-31T14:20:00Z","2028-12-31T19:25:00Z"],umbral:["2028-12-31T15:05:00Z","2028-12-31T18:40:00Z"],total:["2028-12-31T16:17:00Z","2028-12-31T17:29:00Z"]},{penumbral:["2029-06-26T00:50:00Z","2029-06-26T05:55:00Z"],umbral:["2029-06-26T01:33:00Z","2029-06-26T05:13:00Z"],total:["2029-06-26T02:32:00Z","2029-06-26T04:14:00Z"]},{penumbral:["2029-12-20T19:30:00Z","2029-12-21T01:55:00Z"],umbral:["2029-12-20T20:45:00Z","2029-12-21T00:40:00Z"],total:["2029-12-20T21:53:00Z","2029-12-20T23:32:00Z"]}],it=[{window:["2028-01-26T17:03:00Z","2028-01-26T18:41:00Z"]},{window:["2029-01-14T15:10:00Z","2029-01-14T17:44:00Z"]},{window:["2031-11-14T21:07:00Z","2031-11-14T21:40:00Z"]}];(function(){let i=[].concat(at.map(o=>(o.penumbral||o.umbral||o.total)[1])).concat(it.map(o=>o.window[1])).map(o=>new Date(o).getTime()).reduce((o,a)=>Math.max(o,a),0);Date.now()>i-365*24*3600*1e3&&console.warn("LUNAR_ECLIPSES/SOLAR_ECLIPSES in weather.js only cover eclipses through "+new Date(i).toISOString().slice(0,10)+" -- fewer than a year of cataloged eclipses remain. Add more entries (see eclipse.gsfc.nasa.gov/lunar.html and timeanddate.com/eclipse for the next ones, cross-checked for Tiburon/Bay Area visibility).")})();function J(t,e){return t>=new Date(e[0])&&t<=new Date(e[1])}var Da=27.212220817,Ia=2.993360549207802;function Ra(t){let e=Da/2,i=(xe(t)-Ia)%e;return i<0&&(i+=e),Math.min(i,e-i)}function Oa(t){let i=De(t)-T/2;if(i>T/2&&(i-=T),i<-T/2&&(i+=T),Math.abs(i)>1)return null;let o=Ra(t);return o>1.3?null:o<=.9?"total":"partial"}function Na(t,e){if(e<=0){for(let o of at){if(o.total&&J(t,o.total))return{key:"blood-moon",label:"Blood Moon (Total Lunar Eclipse)",source:"NASA"};if(o.bloodAtMax&&o.maxWindow&&J(t,o.maxWindow))return{key:"blood-moon",label:"Blood Moon (Lunar Eclipse)",source:"NASA"};if(o.umbral&&J(t,o.umbral))return{key:"eclipse-lunar",label:"Partial Lunar Eclipse",source:"NASA"};if(o.penumbral&&J(t,o.penumbral))return{key:"eclipse-lunar",label:"Lunar Eclipse",source:"NASA"}}let i=Oa(t);if(i==="total")return{key:"blood-moon",label:"Blood Moon (Lunar Eclipse)",source:"computed"};if(i==="partial")return{key:"eclipse-lunar",label:"Lunar Eclipse",source:"computed"}}if(e>-.1){for(let i of it)if(J(t,i.window))return{key:"eclipse",label:"Solar Eclipse",source:"NASA"}}return null}function Wa(t,e){return!t||t.kp==null||t.ovationValue==null||e>-.15?null:t.kp>=7&&t.ovationValue>=10?{key:"aurora",label:"Aurora Borealis"}:null}var Ba=[{name:"Quadrantid",raHours:15.33,decDeg:49.7,peakMonth:1,peakDay:3,windowDays:1},{name:"Lyrid",raHours:18.13,decDeg:33.3,peakMonth:4,peakDay:22,windowDays:1},{name:"Perseid",raHours:3.28,decDeg:58.1,peakMonth:8,peakDay:12,windowDays:1},{name:"Orionid",raHours:6.42,decDeg:15.8,peakMonth:10,peakDay:21,windowDays:2},{name:"Leonid",raHours:10.27,decDeg:21.8,peakMonth:11,peakDay:17,windowDays:1},{name:"Geminid",raHours:7.55,decDeg:32.4,peakMonth:12,peakDay:13,windowDays:1},{name:"Ursid",raHours:14.63,decDeg:75.3,peakMonth:12,peakDay:22,windowDays:1}];function Ua(t,e){return((((280.46061837+360.98564736629*(t.getTime()/864e5+24405875e-1-2451545))%360+360)%360+e)%360+360)%360}function Ha(t,e,i,o,a){let r=Ua(i,a)-t*15;r=((r+180)%360+360)%360-180;let n=r*Math.PI/180,l=e*Math.PI/180,h=o*Math.PI/180,u=Math.sin(l)*Math.sin(h)+Math.cos(l)*Math.cos(h)*Math.cos(n);return Math.asin(Math.max(-1,Math.min(1,u)))*180/Math.PI}var T=29.530588861,qa=24515501e-1;function xe(t){return t.getTime()/864e5+24405875e-1}function De(t){let e=(xe(t)-qa)%T;return e<0&&(e+=T),e}function Ga(t){return(1-Math.cos(2*Math.PI*De(t)/T))/2}function $a(t,e,i,o){let a=t.getUTCFullYear();for(let s of[a-1,a,a+1]){let r=Date.UTC(s,e-1,i,12,0,0);if(Math.abs(t.getTime()-r)<=o*864e5)return!0}return!1}function ja(t,e){if(e>-.15||Ga(t)>.65)return null;for(let i of Ba)if($a(t,i.peakMonth,i.peakDay,i.windowDays)&&Ha(i.raHours,i.decDeg,t,q,G)>=15)return{key:"meteor-shower",label:`${i.name} Meteor Shower`};return null}var Za=[{name:"Wolf Moon",peak:"2026-01-03T10:03:00Z"},{name:"Beaver Moon",peak:"2026-11-24T14:53:00Z"},{name:"Cold Moon",peak:"2026-12-24T01:28:00Z"},{name:"Supermoon",peak:"2027-01-22T12:17:00Z"},{name:"Supermoon",peak:"2028-01-12T04:02:00Z"},{name:"Supermoon",peak:"2028-02-10T15:03:00Z"},{name:"Supermoon",peak:"2028-03-11T01:05:00Z"},{name:"Supermoon",peak:"2029-02-28T17:10:00Z"},{name:"Supermoon",peak:"2029-03-30T02:26:00Z"},{name:"Supermoon",peak:"2029-04-28T10:36:00Z"}],Va=20,ze=27.554549878,Ya=2457707974e-3;function Ka(t){let e=(xe(t)-Ya)%ze;return e<0&&(e+=ze),Math.min(e,ze-e)}function Qa(t){let i=De(t)-T/2;return i>T/2&&(i-=T),i<-T/2&&(i+=T),Math.abs(i)>1?!1:Ka(t)<=2.5}function Ja(t,e){if(e>-.05)return null;for(let i of Za)if(Math.abs(t.getTime()-new Date(i.peak).getTime())<=Va*3600*1e3)return{key:"supermoon",label:`Supermoon (${i.name})`};return Qa(t)?{key:"supermoon",label:"Supermoon"}:null}function Xa(t,e){return!t||e>-.05?null:{key:"close-approach",label:`Close Approach: ${t.name}`}}function ei(t,e){if(!t||!t.is_day||e<=.02||e>=.7)return null;let i=Number(t.precipitation)||0,o=t.cloud_cover!=null?Number(t.cloud_cover):null;return i>0&&i<4&&o!=null&&o<85?{key:"rainbow",label:"Rainbow"}:null}function ti(t,e){let{weather:i,aq:o,alerts:a,quake:s,noaaStorms:r,skyCoverIntervals:n,aurora:l,neo:h}=t,u=i.current,c=i.hourly,v=i.minutely_15,f=i.daily;X=f;let b=Le(f);e&&e.setSunState(b.frac,b.elevation);let A=!!u.is_day,$=Fe(n,new Date),x=$!=null?$:u.cloud_cover,z=wmoInfo(u.weather_code,A,x),L=de||z.key;de&&(z={key:L,label:labelForKey(L)});let R=de?null:xa(a||[],s,r);if(R)z={key:R.key,label:R.label},L=z.key;else if(!de){let g=new Date,y=Na(g,b.elevation)||Wa(l,b.elevation)||ja(g,b.elevation)||Ja(g,b.elevation)||Xa(h,b.elevation)||ei(u,b.elevation);y&&(z={key:y.key,label:y.label},L=z.key)}let O={theme:H,"--sun-core":k("--sun-core"),"--moon-core":k("--moon-core"),"--cloud":k("--cloud"),"--cloud2":k("--cloud2"),"--rain":k("--rain"),"--snow":k("--snow"),"--fog":k("--fog"),"--bolt":k("--bolt"),"--fg":k("--fg")};document.getElementById("nowIcon").innerHTML=iconSvgFor(L,O),document.getElementById("nowTemp").textContent=Ae(u.temperature_2m),document.getElementById("nowCond").textContent=z.label,document.getElementById("nowSub").textContent=`Feels like ${Ae(u.apparent_temperature)}`,document.getElementById("hilo").textContent=`H:${Math.round(f.temperature_2m_max[S])}\xB0  L:${Math.round(f.temperature_2m_min[S])}\xB0`,Pe=L,Ee=x,e&&e.setCondition(L),e&&x!=null&&e.setWeatherData({cloudCover:x/100});let Ie=v&&v.time&&v.time.length>0,M=Ie?v:c,ot=i.current.time.slice(0,16),j=M.time.findIndex(g=>g>=ot);j<0&&(j=0);let Re=document.getElementById("hourly");Re.innerHTML="";for(let g=0;g<12;g++){let y=j+g;if(y>=M.time.length)break;let fe=M.is_day?!!M.is_day[y]:!0,te=M.cloud_cover?M.cloud_cover[y]:null,ae=Fe(n,U(M.time[y],F)),V=wmoInfo(M.weather_code[y],fe,ae!=null?ae:te),W=M.precipitation_probability?M.precipitation_probability[y]:null,Y=document.createElement("div");Y.className="ww-hour",Y.innerHTML=`
      <div class="hh">${Ie?ua(M.time[y],g):ha(M.time[y],g)}</div>
      ${iconSvgFor(V.key,O)}
      <div class="ht">${Math.round(M.temperature_2m[y])}\xB0</div>
      <div class="hp">${W!=null&&W>=15?W+"%":""}</div>
    `,Re.appendChild(Y)}let Oe=document.getElementById("daily");Oe.innerHTML="";let Ne=Math.min(...f.temperature_2m_min.slice(S,S+5)),st=Math.max(...f.temperature_2m_max.slice(S,S+5)),We=Math.max(1,st-Ne);for(let g=0;g<5;g++){let y=S+g,fe=Ma(n,f.time[y]),te=Ca(c,f.time[y]),ae=wmoInfo(te!=null?te:f.weather_code[y],!0,fe),V=f.temperature_2m_min[y],W=f.temperature_2m_max[y],Y=(V-Ne)/We*100,dt=(W-V)/We*100,He=f.precipitation_probability_max[y],me=document.createElement("div");me.className="ww-day-row",me.innerHTML=`
      <div class="dn">${da(f.time[y],g)}</div>
      ${iconSvgFor(ae.key,O)}
      <div class="ww-bar"><span style="left:${Y}%;width:${dt}%"></span></div>
      <div class="dp">${He>=15?He+"%":""}</div>
      <div class="dlo">${Math.round(V)}\xB0</div>
      <div class="dhi">${Math.round(W)}\xB0</div>
    `,Oe.appendChild(me)}let Z=o&&o.current?o.current.us_aqi:null,ce=ra(Z);document.getElementById("aqiVal").textContent=Z!=null?Math.round(Z):"\u2014",document.getElementById("aqiVal").style.color=ce.color,document.getElementById("aqiCat").textContent=ce.label,document.getElementById("aqiDesc").textContent=ce.desc;let rt=Z!=null?Math.min(100,Z/300*100):0;document.getElementById("aqiMarker").style.left=`${rt}%`;let nt=new Date(f.sunrise[S]),lt=new Date(f.sunset[S]),Be=g=>g.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"}),ht=c.visibility&&c.visibility[j]!=null?(c.visibility[j]/1609.34).toFixed(1):"\u2014",N=k("--fg"),ut=[{icon:WI.uv(N),label:"UV Index",value:Math.round(f.uv_index_max[S]),sub:ai(f.uv_index_max[S])},{icon:WI.sunrise(N),label:"Sunrise",value:Be(nt),sub:`Sunset ${Be(lt)}`},{icon:"",label:"Wind",value:`${Math.round(u.wind_speed_10m)} mph`,sub:na(u.wind_direction_10m),compass:u.wind_direction_10m},{icon:WI.drop(N),label:"Humidity",value:`${Math.round(u.relative_humidity_2m)}%`,sub:""},{icon:WI.eye(N),label:"Visibility",value:`${ht} mi`,sub:""},{icon:WI.thermo(N),label:"Feels Like",value:Ae(u.apparent_temperature),sub:""}],Ue=document.getElementById("grid");Ue.innerHTML="";for(let g of ut){let y=document.createElement("div");y.className="ww-card",g.compass!==void 0?y.innerHTML=`<div class="cl">${g.label}</div><div class="ww-compass">${la(g.compass,N)}</div><div class="cv" style="font-size:16px">${g.value}</div><div class="cs">${g.sub}</div>`:y.innerHTML=`<div class="cl">${g.icon}${g.label}</div><div class="cv">${g.value}</div><div class="cs">${g.sub}</div>`,Ue.appendChild(y)}}function ai(t){return t<3?"Low":t<6?"Moderate":t<8?"High":t<11?"Very High":"Extreme"}var ee=null;window.fxEngine=null;function et(){return P(this,null,function*(){try{let[t,e,i,o,a,s]=yield Promise.all([ca(),za(),La(),Pa(),Ea(),Fa()]);ti(w(d({},t),{alerts:e,quake:i,noaaStorms:o,aurora:a,neo:s}),ee)}catch(t){console.error("Weather fetch failed",t)}})}function tt(){et(),setInterval(et,ta),setInterval(()=>{if(X){let t=Le(X);ee&&ee.setSunState(t.frac,t.elevation)}},60*1e3),setTimeout(()=>{try{let t=document.getElementById("fx"),e=new Q(t,{sunCore:k("--sun-core"),sunGlow:k("--sun-glow"),moonCore:k("--moon-core"),moonGlow:k("--moon-glow"),cloud:k("--cloud"),cloud2:k("--cloud2"),rain:k("--rain"),snow:k("--snow"),fog:k("--fog"),bolt:k("--bolt")},{forceDay:H==="day",forceNight:H==="night"});if(ee=e,window.fxEngine=e,X){let i=Le(X);e.setSunState(i.frac,i.elevation)}Pe&&(e.setCondition(Pe),Ee!=null&&e.setWeatherData({cloudCover:Ee/100}))}catch(t){console.error("Atmosphere engine failed to start; continuing without it",t),ee=null,window.fxEngine=null}},0)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",tt):tt();})();
