const METEO_PATH="./meteo_",KEY_TO_ICON={"clear-day":"clear-day","clear-night":"clear-night","mostly-clear-day":"partly-cloudy-day","mostly-clear-night":"partly-cloudy-night","partly-cloudy-day":"partly-cloudy-day","partly-cloudy-night":"partly-cloudy-night","mostly-cloudy-day":"mostly-cloudy-day","mostly-cloudy-night":"mostly-cloudy-night",overcast:"overcast",fog:"fog",drizzle:"drizzle",rain:"rain","rain-heavy":"rain","freezing-rain":"sleet",snow:"snow","snow-heavy":"snow","snow-grains":"snowflake","drizzle-light":"drizzle","drizzle-heavy":"drizzle","rain-light":"rain","snow-light":"snow","rain-showers-light":"rain","rain-showers-heavy":"rain","snow-showers-light":"snow","rain-showers":"rain","snow-showers":"snow",thunderstorm:"thunderstorms","thunderstorm-hail":"hail","thunderstorm-hail-heavy":"hail"};function extremeSvg(c){return`<svg class="weather-icon" viewBox="0 0 100 100" style="filter:drop-shadow(0 3px 4px rgba(0,0,0,0.12))">${c}</svg>`}const MOSTLY_CLEAR_ICONS={"mostly-clear-day":`<svg class="weather-icon" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `),supermoon:extremeSvg(`
    <rect width="100" height="100" fill="#0b1120" rx="4"/>
    <g fill="#ffffff" opacity="0.5"><circle cx="12" cy="16" r="1"/><circle cx="88" cy="18" r="1"/><circle cx="8" cy="80" r="1"/><circle cx="92" cy="70" r="1"/></g>
    <defs><radialGradient id="smg" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#fffdf2" stop-opacity="0.5"/><stop offset="100%" stop-color="#fffdf2" stop-opacity="0"/></radialGradient></defs>
    <circle cx="50" cy="52" r="42" fill="url(#smg)"/>
    <circle cx="50" cy="52" r="30" fill="#fffdf2"/>
    <circle cx="41" cy="44" r="5" fill="#c9c0a0" opacity="0.4"/>
    <circle cx="60" cy="58" r="4" fill="#c9c0a0" opacity="0.35"/>
    <circle cx="55" cy="38" r="2.5" fill="#c9c0a0" opacity="0.3"/>
  `),"close-approach":extremeSvg(`
    <rect width="100" height="100" fill="#0f172a" rx="4"/>
    <g fill="#ffffff" opacity="0.5"><circle cx="20" cy="70" r="1"/><circle cx="45" cy="80" r="1"/><circle cx="75" cy="65" r="1"/></g>
    <defs><radialGradient id="cag" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#e2e8f0"/><stop offset="100%" stop-color="#e2e8f0" stop-opacity="0"/></radialGradient></defs>
    <circle cx="30" cy="25" r="3" fill="url(#cag)"/>
    <circle cx="30" cy="25" r="1.3" fill="#e2e8f0"/>
    <circle cx="60" cy="60" r="28" fill="#1d4ed8" opacity="0.55"/>
    <path d="M45 48 Q60 40 75 50 Q78 65 62 74 Q48 78 42 64 Q40 55 45 48 Z" fill="#3b82f6" opacity="0.35"/>
  `),rainbow:extremeSvg(`
